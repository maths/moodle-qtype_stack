...
/**
   ...
   */(yaml);_exports.setup=()=>{let json=document.querySelector("#id_yamlinput").innerHTML,obj=JSON.parse(json),yamltext=yaml.dump(obj,{noRefs:!0});document.querySelector("#id_yamlinput").innerHTML=yamltext}}));
