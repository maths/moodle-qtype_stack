...
/**
   ...
   */(yaml);_exports.setup=()=>{let json=document.querySelector("#id_yamlinput").innerHTML,obj=JSON.parse(json),yamltext=yaml.dump(obj,{noRefs:!0}),obj2=yaml.load(yamltext),json2=JSON.stringify(obj2);document.querySelector("#id_yamlinput").innerHTML=yamltext+"<hr><pre>"+json2+"</pre>"}}));
