...
7. Inputs _not_ giving support for a syntax hint include:
   ...
   * GeoGebra
   * Matrix and varmatrix inputs expect the syntax hint to be a correctly formatted matrix, in Maxaim syntax.  You cannot currently put `castext` functions within matrix entries.
   * Singlechar
