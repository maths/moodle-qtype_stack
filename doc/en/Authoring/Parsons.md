...
2. `height`: string containing a positive float + a valid CSS unit (e.g.`"480px"`, `"100%"`, ...). Default is `"480px"`. This fixes the height of the window containing the drag-and-drop lists.
