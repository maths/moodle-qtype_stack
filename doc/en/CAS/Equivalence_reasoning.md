...
Wider support is intended for future versions. A simple [getting started with equivalence reasoning guide](../Topics/Equivalence_reasoning.md) can be found elsewhere.
