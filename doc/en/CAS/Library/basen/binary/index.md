...
Returns the maximum bitwidth of all the base 2, 8 or 16 [`stackbasen`](../index.md#stackbasen) objects
...
| ----------- | ------------|
| integer | `-1` if no [`stackbasen`](../index.md#stackbasen) numbers of the relevant bases were found |
...
Checks if the expression contains a [`stackbasen`](../index.md#stackbasen) value and that all
...
| Return type | description |
| ----------- | ------------|
| bool | `false` if no [`stackbasen`](../index.md#stackbasen) numbers were found or if even one of them is not in the expected bases. |
...
## sbasen_trim_padding(expression)<a id='sbasen_trim_padding'></a>

Drops extra `0` digits from [`stackbasen`](../index.md#stackbasen) objects that may have been padded
