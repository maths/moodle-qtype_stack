...
* Hints.  
 * *done* Make sure the syntax is updated to [hint:...] in line with the new format.
...
* *done* Provide an extra syntax checking option to enable stars to be inserted between single characters, e.g. xy -> x*y.
