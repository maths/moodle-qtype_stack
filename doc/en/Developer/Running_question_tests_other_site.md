...
+
 // Run the tests.
 list($allpassed, $failingtests, $notests, $failingupgrade) = $bulktester->run_all_tests_for_context($context);
 
 // Display the final summary.
 $bulktester->print_overall_result($allpassed, $failingtests, $notests, $failingupgrade);
+
