...
Of course, if the question author has created [question tests](../Maintaining/Testing.md) in the first place, and deployed random variants to check in advance, this problem would never have occured!
