...
You can add in drag and drop functionality using the `[[parsons ..]]` [question block](Question_block.md).  This can be used in two ways in STACK.  How to author example questions in major areas:
