...
Dado que nosotros hemos usado `{@p@}` aquí, el usuario no verá una \(p\) en la pantalla en donde la pregunta está instanciada, sino que verá el _valor mostrado_ de `p`.
