...
$newarg['narrative']  = 'Over the reals, this argument is true.  So this should be fine.';
...
$newarg['narrative']  = 'This argument is by Bill McCullum: matching up the coefficients.  This argument is false, but in this special case leads to the correct solution.';
...
foreach ($samplearguments as $argument) {
    ...
    $cs2 = new stack_cas_casstring("S1:disp_stack_eval_arg(" . $cskey. ", true, true)");
    $cs2->get_valid('t');
    $cs3 = new stack_cas_casstring("S2:check_stack_eval_arg(" . $cskey . ")");
    $cs3->get_valid('t');
    ...
    echo html_writer::tag('h2', $cskey . ": ". $argument['title']).
