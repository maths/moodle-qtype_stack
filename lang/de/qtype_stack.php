...
/**
 * Strings for component 'qtype_stack', language 'de', version '4.0'.
 *
 * @package     qtype_stack
 * @category    string
...
$string['ATAlgEquiv_SA_not_list'] = 'Ihre Antwort sollte eine Liste sein, ist es aber nicht. Beachten Sie die Syntax: In einer Liste wird die Auflistung der Elemente (jeweils durch Kommata getrennt) mit eckigen Klammern eingeschlossen.';
...
$string['ATNumerical_SA_not_list'] = 'Ihre Antwort sollte eine Liste sein, ist es aber nicht. Beachten Sie die Syntax: In einer Liste wird die Auflistung der Elemente (jeweils durch Kommata getrennt) mit eckigen Klammern eingeschlossen.';
...
<tr>
<td>\\(k\\), konstant           </td> <td> \\(0\\) </td> </tr> <tr> <td>
\\(x^n\\), jede Konstante \\(n\\) </td> <td> \\(nx^{n-1}\\)</td> </tr> <tr> <td>
...
$string['calc_quotient_rule_fact'] = 'Die Quotientenregel der Differenzialrechnung besagt, dass für zwei beliebige differenzierbare Funktionen \\(f(x)\\) und \\(g(x)\\),
 \\[\\frac{d}{dx}\\links(\\frac{f(x)}{g(x)}\\rechts)=\\frac{g(x)\\cdot\\frac{df(x)}{dx}\\ \\ - \\ \\ f(x)\\cdot \\frac{dg(x)}{dx}}{g(x)^2} \\] gilt.';
...
$string['editquestioninthequestionbank'] = 'Diese Frage bearbeiten';
...
$string['healthchecksamplecas'] = 'Die Ableitung von {@ x^4/(1+x^4) @} ist \\[ \\frac{d}{dx} \\frac{x^4}{1+x^4} = {@ diff(x^4/(1+x^4),x) @}. \\] Überprüfen Sie, ob Unicode unterstützt wird: \\(\\forall\\) sollte als {@unicode(8704)@} angezeigt werden.';
...
$string['healthunabletolistavail'] = 'Der Plattformtyp ist derzeit nicht auf "linux" eingestellt und kann daher keine verfügbaren Versionen von Maxima auflisten.';
...
$string['optionsnotrequired'] = 'Für diesen Eingabetyp sind keine Optionen erforderlich.';
...
$string['stackHintOld'] = 'Der CASText enthält Hinweis-Tags in einem veralteten Stil. Sie sollten nun in der Form <pre>[[facts:tag]]</pre> sein.';
...
$string['tidyquestion'] = 'Tool zum Nachbessern der Frage';
