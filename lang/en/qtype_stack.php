...
$string['inputmonospace_help'] = 'Select the types of input to default to monospace font. These defaults can be overridden for an input with extra option settings \'monospace\' and \'monospace:false\'.';
