...
$string['stackCas_unencpsulated_varmatrix'] = 'In a matrix of variable size <b>use spaces to separate items</b>, not a comma.';
$string['stackCas_varmatrix_eg']            = 'E.g. {$a->good} rather than {$a->bad}.';
...
$string['ATInt_const']               = 'You need to add a constant of integration, otherwise this appears to be correct.';
$string['ATInt_EqFormalDiff']        = 'The formal derivative of your answer does equal the expression that you were asked to integrate.  However, your answer differs from the correct answer in a significant way, that is to say not just, e.g., a constant of integration.';
$string['ATInt_logabs']              = 'Your teacher may expect you to use the result \(\int\frac{1}{x} dx = \log(|x|)+c\), rather than \(\int\frac{1}{x} dx = \log(x)+c\).';
$string['ATInt_weirdconst']          = 'The formal derivative of your answer does equal the expression that you were asked to integrate.  However, you have a strange constant of integration.';
$string['ATInt_logabs_inconsistent'] = 'There appear to be strange inconsistencies between your use of \(\log(...)\) and \(\log(|...|)\).';
...
<pre>!!p<br>x: -5..5<br>y: -3..10<br>y=x^2-1<br>!!p</pre>
<p>Use <code>x: a..b</code> and <code>y: c..d</code> to set the visible range. Add exactly one equation of the form <code>y=...</code>.</p>';
$string['asciistringplotempty'] = 'Plot block needs one equation.';
...
$string['asciistringplotmultiple'] = 'Plot block can only contain one equation.';
...
$string['asciistringplotsymbolforbidden'] = 'Symbol not allowed:';
...
$string['stack_library_category'] = 'Question category:';
...
$string['stack_library_instructions_two'] = 'Note, by design <code>[[feedback:????]]</code> tags in the question text are not replaced, and are retained to indicate the position of PRT feedback.';
$string['stack_library_instructions_three'] = 'Click \'Import\' to import the question into the current question category. Alternatively, click \'Import folder\' to import all questions in the current folder.';
$string['stack_library_instructions_four'] = 'Use the dropdown list to change category.';
$string['stack_library_instructions_five'] = 'Quizzes can be added to the current course by importing their .json file.';
...
$string['stack_library_multiple'] = 'This is a question set containing:';
$string['stack_library_multiple_category'] = 'There is question category information in this file as shown. Questions will be imported into categories listed in the file rather than your selected category.';
$string['stack_library_set'] = 'Question set';
...
$string['api_forbidden_doctype'] = 'The provided XML contains a forbidden DOCTYPE declaration';
$string['api_invalid_bool'] = 'invalid bool value';
$string['api_invalid_question_count'] = 'The provided XML file does not contain exactly one question element';
$string['api_invalid_question_count_category'] = 'The provided XML file does not contain exactly one question element and has category information';
$string['api_invalid_xml'] = 'The provided file does not contain valid XML';
$string['api_invalid_yaml_or_xml'] = 'The provided file does not contain valid YAML or XML.';
$string['api_no_deployed_variants'] = 'The question XML does not contain deployed variants';
$string['api_non_positive_totalvalue'] = 'There is an error authoring your question. The $totalvalue, the marks available for the question, must be positive in question {$a->questionname}';
$string['api_not_stack_question'] = 'The provided question is not of type STACK';
...
$string['api_source_too_large'] = 'The provided XML or YAML exceeds the maximum allowed size';
$string['api_submit'] = 'Submit Answers';
$string['api_too_many_nodes'] = 'The provided XML or YAML exceeds the maximum allowed node count';
