...
$string['checkanswertype_help'] = 'If true, answers which are of a different "type" (e.g. expression, equation, matrix, list, set) are rejected as invalid.';
...
$string['forbidfloat_help'] = 'If set to true, then any answer of the student which has a floating point number will be rejected as invalid.';
...
$string['insertstars_help'] = 'If set to true then the system will automatically insert *s into a student\'s answer when it is validated.';
...
$string['questiontext_help'] = 'The question text is CASText.  This is the "question" which the student actually sees.  You must put input elements in this field, and only in this field.';
...
$string['quiet'] = 'Quiet';
$string['quiet_help'] = 'When set to true any feedback automatically generated by the answer tests is surpressed, and not displayed to the student.  The feedback fields in the branches are unaffected by this option.';
$string['requiredfield'] = 'This field is required!';
$string['requirelowestterms'] = 'Require lowest terms';
$string['requirelowestterms_help'] = 'When this option is set to true, any coefficients or other rational numbers in an expression, must be written in lowest terms.  Otherwise the answer is rejected as invalid.';
...
$string['strictsyntax_help'] = 'If set to false, the system will automatically insert *s into a student\'s answer, and it will not throw an error.';
...
$string['teachersanswer_link'] = 'question/type/stack/doc/doc.php/Authoring/Inputs.md#Teacher_Ans';
...
$string['settingcasresultscache_desc'] = 'This setting determines whether calls the to CAS are cached. This setting should be turned on unless you are doing development that involves changing the Maxima code. The current state of the cache is shown on the healthcheck page.';
