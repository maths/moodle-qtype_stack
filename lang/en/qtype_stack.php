...
$string['auswahltype'] = 'Auswahl type';
$string['auswahltype_help'] = 'Selection from checkbox, radio buttons and drop down list.';
$string['auswahltype_link'] = '..';
$string['auswahltypecheckbox'] = 'Checkbox';
$string['auswahltypedropdown'] = 'Drop down list';
$string['auswahltyperadiobuttons'] = 'Radio buttons';
...
$string['matrixsize_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/CAS/Matrix.md#matrixparens';
...
$string['inputtypeauswahl'] = 'Auswahl';
