...
$string['insertstars_help'] = 'If set to true then the system will automatically insert *s into any patterns identified by Strict Syntax.  Otherwise, it thows an error.';
