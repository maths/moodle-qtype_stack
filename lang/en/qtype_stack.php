...
$string['defaultprtcorrectfeedback'] = '<i class="fa fa-check"></i> Correct answer, well done.';
$string['defaultprtincorrectfeedback'] = '<i class="fa fa-times"></i> Incorrect answer.';
$string['defaultprtpartiallycorrectfeedback'] = '<i class="fa fa-adjust"></i> Your answer is partially correct.';
