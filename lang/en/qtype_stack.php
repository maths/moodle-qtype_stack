...
$string['settingexectimeout'] = 'Maxima execution timeout';
$string['settingexectimeout_desc'] = 'How long the Maxima process should be allowed to execute before it is terminated as \'runaway\'; The Linux "timeout" command is required for this to work. 0 means allow execution forever.';
...
$string['settingsmaximasettings_desc'] = 'The settings below control the connection from STACK to Maxima and how Maxima is executed. If the correct platform, Lisp and Maxima version are selected, the defaults for the other settings should generally and in most cases give the best results. Only specify a value for a setting if you know the default will not work. Forcing those settings can interfere with processes such as automatic image optimisation.';
...
$string['settingplatformtypeunix'] = 'Linux, Unix or Mac OS X';
$string['settingplatformtypeunixoptimised'] = 'Linux, Unix or Mac OS X (optimised)';
$string['settingplatformtypewin']  = 'Windows';
$string['settingplatformtypewinoptimised']  = 'Windows (optimised)';
...
$string['settingplatformmaximapreoptcommand'] = 'Maxima Pre-Optimisation Command';
$string['settingplatformmaximapreoptcommand_desc'] = 'Command to use when auto-optimising Maxima';
...
$string['settingplatformbypasslaunchscript'] = 'Bypass Launch Script';
$string['settingplatformbypasslaunchscript_desc'] = 'For platforms such as Windows, STACK executes the maxima command via a batch file or shell script. This settings causes the comand to be called directly.';
$string['settingcriticalsettingsupdated'] = 'Critical Settings Timestamp';
$string['settingcriticalsettingsupdated_desc'] = 'Timestamp of the platformtype, lisp, maximacommand, plotcommand, libraries and other critical settings.';
$string['settingmaximaconnectionmessages'] = 'Errors and Warnings';
$string['errormaximainstallnotfound'] = 'Could not locate the directory into which Maxima is installed. Tried the following: {$a}.';
$string['errormaximainstallspaces'] = 'Your Maxima program is within a directory containing spaces in it\'s name (e.g. "\\Program Files\\". This can cause systems like Maxima to break in unexpected ways and is not recommended.';
$string['errorgnuplotnotonpath'] = 'Could not locate gnuplot on the system path. Path is: {$a}.';
$string['errorgnuplotnotfound'] = 'Could not locate gnuplot. Tried the following: {$a}.';
$string['errormaximanotfound'] = 'Could not locate the maxima command. Looked here: {$a}.';
$string['errormaximanotonpath'] = 'Could not locate the maxima command on the system path. Path is: {$a}.';
$string['errormaximaversiondefault'] = 'Maxima version cannot be set to default on this platform. Please choose an explicit version via the administration settings page.';
$string['errormaximaversionuntested'] = 'Versions of Maxima prior to 5.39.0 are not well tested on this platform. Version you have chosen: {$a}';
$string['errormaximalocalunresolvederrors'] = 'Could not generate mamximalocal file as there were unresolved errors';
$string['errorlaunchscriptunresolvederrors'] = 'Could not generate launcher file as there were unresolved errors';
$string['erroroptautounresolvederrors'] = 'Could not generate optimised image as there were unresolved errors';
$string['erroroptimagemissing'] = 'There is currently no optimised or auto-optimised image - use the healthcheck page or follow the documentation to generate one.';
$string['erroroptimagenotexecutable'] = 'The optimised or auto-optimsed image "{$a}" is present but not executable.';
$string['erroroptimageoutofdate'] = 'You have changed your configuration and your optimised image "{$a}" may now be out of date - use the healthcheck page or follow the documentation to generate a new one.';
...
$string['healthcheckmaximabaterr'] = 'STACK attempted to generate launch script "{$a}". This appears to have failed.';
...
$string['healthautomaxopt_failed'] = 'Create Optimised Maxima Image FAILED :<br>{$a->errmsg}';
...
$string['healthautomaxopt_gclwinmanual'] = 'Microsoft Windows GCL Maxima must be installed and manually optimized separately from STACK';
$string['healthautomaxopt_notsupported'] = 'This platform does not support optimisation.';
$string['healthcheckcreateimage'] = 'Create Maxima image';
$string['healthcheckwarningcommandoverride'] = 'You have overridden the default Maxima command(s) - this prevents lisp, timeout and version settings from taking effect.';
$string['healthcheckwarningtimeout'] = 'Maxima execution timeout should be longer than CAS connection timeout.';
$string['healthcheckplatformconfigwarnings'] = 'There were platform configuration warnings';
$string['healthcheckplatformconfigerrors'] = 'There were platform configuration errors';
