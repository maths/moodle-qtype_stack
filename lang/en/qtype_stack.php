...
<tr><td>
$e^x$</td> <td>  $e^x+c$</td> <td> </td> </tr> <tr> <td>
$\cos(x)$ </td> <td>  $\sin(x)+c$   </td> <td> </td> </tr> <tr> <td>
$\sin(x)$ </td> <td>  $-\cos(x)+c$  </td> <td> </td> </tr> <tr> <td>
$\tan(x)$ </td> <td>  $\ln(\sec(x))+c$ </td> <td>
 $-\frac{\pi}{2} < x < \frac{\pi}{2}$</td> </tr> <tr> <td>
$\sec x$ </td> <td>  $\ln (\sec(x)+\tan(x))+c$ </td> <td>    $
-{\pi\over 2}< x < {\pi\over 2}$</td> </tr> <tr> <td>
cosec$\, x$ </td> <td>  $\ln ($cosec$(x)-\cot(x))+c$ </td> <td>
$0 < x < \pi$</td> </tr> <tr> <td>
cot$\,x$ </td> <td>  $\ln(\sin(x))+c$ </td> <td>  $0< x< \pi$ </td> </tr> <tr> <td>
$\cosh(x)$ </td> <td>  $\sinh(x)+c$</td> <td>
</td> </tr> <tr> <td>
$\sinh(x)$ </td> <td>  $\cosh(x) + c$ </td> <td> </td> </tr> <tr> <td>
$\tanh(x)$ </td> <td>  $\ln(\cosh(x))+c$</td> <td> </td> </tr> <tr> <td>
coth$(x)$ </td> <td>  $\ln(\sinh(x))+c $</td> <td>   $x>0$</td> </tr> <tr> <td>
${1\over x^2+a^2}$ </td> <td>  ${1\over a}\tan^{-1}{x\over a}+c$</td> <td> $a>0$</td> </tr> <tr> <td> [2pt]
${1\over x^2-a^2}$ </td> <td>  ${1\over 2a}\ln{x-a\over x+a}+c$
</td> <td>  $|x|>a>0$</td> </tr> <tr> <td> [2pt]
${1\over a^2-x^2}$ </td> <td>  ${1\over 2a}\ln{a+x\over a-x}+c$ </td> <td>   $|x|<a$</td> </tr> <tr> <td> [3pt]
${1\over \sqrt{x^2+a^2}}$ </td> <td>  $\sinh^{-1}\left(\frac{x}{a}\right) + c$ </td> <td> $a>0$ </td> </tr> <tr> <td>
${1\over \sqrt{x^2-a^2}}$ </td> <td>  $\cosh^{-1}\left(\frac{x}{a}\right) + c$ </td> <td>  $x\geq a > 0$ </td> </tr> <tr> <td>
${1\over \sqrt{x^2+k}}$ </td> <td>  $\ln (x+\sqrt{x^2+k})+c$</td> <td> </td> </tr> <tr> <td>
${1\over \sqrt{a^2-x^2}}$ </td> <td>  $\sin^{-1}\left(\frac{x}{a}\right)+c$</td> <td>  $-a\leq
x\leq a$  </td> </tr>
</table></canter>';
