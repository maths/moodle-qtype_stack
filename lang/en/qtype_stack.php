...
$string['questiontext_help'] = 'The question text is CASText.  This is the "question" which the student actually sees.  You must put input elements in this field, and only in this field.  For example, using `[[input:ans1]]`.';
