...
$string['pluginname_help'] = 'STACK es un sistema de evaluaciÃ³n en matemÃ¡ticas.';
$string['pluginnameadding'] = 'Agregando una pregunta STACK';
$string['pluginnameediting'] = 'Editando una pregunta STACK';
$string['pluginnamesummary'] = 'STACK provee preguntas matemÃ¡ticas para cuestionarios en moodle. Utiliza un sistema de Ã¡lgebra computacional para establecer las propiedades matemÃ¡ticas en las respuestas de estudiantes.';

// General strings.
$string['errors'] = 'Errores';
$string['debuginfo'] = 'InformaciÃ³n de depurado';
...
$string['answernote_err'] = 'Nota de respuesta no deben contener el carÃ¡cter |. Este carÃ¡cter es insertado por STACK y luego usado para dividir automaticamente notas de respuesta.';
$string['answernote_help'] = 'Es una etiqueta clave para los informes. EstÃ¡ diseÃ±ada para registrar ruta Ãºnica a travÃ©s del Ã¡rbol y el resultado de cada prueba de respuesta. Esto se genera automÃ¡ticamente, pero se puede cambiar si tiene sentido.';
...
$string['answernoterequired'] = 'Nota de respuesta no debe estar vacÃ­o.';
$string['assumepositive'] = 'Asumir positivo';
$string['assumepositive_help'] = 'Esta opciÃ³n habilita la variable assume_pos de Maxima.';
...
$string['boxsize'] = 'TamaÃ±o de la caja';
...
$string['checkanswertype_help'] = 'Si es verdadero, las respuestas de diferente tipo (p.e. expresiÃ³n, ecuaciÃ³n, matriz, lista, conjunto) son evaludadas como invalidas.';
$string['checkanswertype_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Inputs.md#Check_Type';
$string['complexno'] = 'VisualizaciÃ³n de sqrt(-1)';
$string['complexno_help'] = 'Controla el significado y visualizaciÃ³n del simbolo i y sqrt(-1)';
...
$string['branchfeedback'] = 'RetroalimentaciÃ³n de la rama del nodo';
$string['branchfeedback_help'] = 'Es un CASText que puede depender de variables de pregunta, elementos de entrada Ã³ variables de retroalimentaciÃ³n. Se evalÃºa y se muestra al estudiante si pasan por esta rama.';
...
### Modo y CalificaciÃ³n
Como es ajustada la calificaciÃ³n. = significa una calificaciÃ³n especifica, +/- significa sumar o restar calificaciÃ³n de la calificaciÃ³n total.
 
### PenalizaciÃ³n
Es la penalizaciÃ³n acumulativa en el modo adaptivo o interactivo.

### Siguiente
Salta a cualquier otro nodo, o se detene.

### Nota de respuesta
Es una etiqueta para propÃ³sitos de reporte. Esta diseÃ±ada para guardar la ruta Ãºnica a travÃ©s del Ã¡rbol y el resultado de cada prueba de respuesta. Es automaticamente generado, pero se puede cambiar si es necesario.
';
$string['feedbackvariables'] = 'Variables de retroalimentaciÃ³n';
$string['feedbackvariables_help'] = 'Las variables de retroalimentaciÃ³n permiten manipular cualquiera de las entradas, junto con las variables de pregunta, antes de atravesar el Ã¡rbol. Las variables definidas aquÃ­ pueden ser utilizadas en cualquier otro lugar del Ã¡rbol.';
$string['feedbackvariables_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/KeyVals.md#Feedback_variables';
$string['fieldshouldnotcontainplaceholder'] = '{$a->field} no deberÃ­a contener [[{$a->type}:...]] marcador.';
$string['forbidfloat'] = 'Prohibir flotantes';
$string['forbidfloat_help'] = 'Si es verdadero, entonces cualquier respuesta del estudiante que contenga nÃºmeros de punto flotante serÃ¡ invalida.';
...
$string['forbidwords_help'] = 'Es una lista separada por comas de cadenas de texto que serÃ¡n prohibidas como respuesta de estudiantes.';
$string['forbidwords_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/CASText.md#Forbidden_Words';
$string['generalfeedback'] = 'RetroalimentaciÃ³n general';
$string['generalfeedback_help'] = 'RetroalimentaciÃ³n general es un CASText. TambiÃ©n conocida como "soluciÃ³n desarrollada", estÃ¡ se muestra al estudiante despuÃ©s de haber intentado resolver la pregunta. La retroalimentaciÃ³n general se muestra a todos los estudiantes, a diferencia de la retroalimentaciÃ³n que depende de la respuesta que el alumno ingreso. Esta retroalimentaciÃ³n general tambiÃ©n puede depender de las variables de la pregunta.';
$string['generalfeedback_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/CASText.md#general_feedback';
$string['showvalidation'] = 'Mostrar validaciÃ³n';
$string['showvalidation_help'] = 'Al establecer esta opciÃ³n se muestra cualquier retroalimentaciÃ³n para la entrada, incluyendo repetir las expresiones en la notaciÃ³n tradicional de dos dimensiones.';
$string['showvalidation_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Inputs.md#Show_validation';
$string['htmlfragment'] = 'Parece que tienes elementos HTML en la expresiÃ³n.';
$string['illegalcaschars'] = 'Los carÃ¡cteres @ y \$ no estÃ¡n permitidos en la entrada CAS.';
$string['inputheading'] = 'Entrada: {$a}';
$string['inputtype'] = 'Tipo de entrada';
$string['inputtype_help'] = 'Determina el tipo del elemento de entrada, formas como Algebraica, Verdadero/Falso, Ã�rea de texto.';
...
$string['inputtypesinglechar'] = 'Un solo carÃ¡cter';
$string['inputtypetextarea'] = 'Ã�rea de texto';
$string['inputtypematrix'] = 'Matriz';
$string['insertstars'] = 'Insertar asteriscos';
$string['insertstars_help'] = 'Si es verdadero entonces el sistema insertarÃ¡ automaticamente asteriscos dentro de cualquier patrÃ³n dentro de Sintaxis extricta. En otro caso, se mostrÃ¡ un error';
$string['insertstars_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Inputs.md#Insert_Stars';
$string['multiplicationsign'] = 'Signo de multiplicaciÃ³n';
$string['multiplicationsign_help'] = 'Controla como se mostrarÃ¡ el signo de multiplicaciÃ³n.';
...
$string['nextcannotbeself'] = 'Un nodo no puede ligarse a sÃ­ mismo con el siguiente nodo.';
$string['nodehelp'] = 'Nodo del Ã¡lbol de respuesta';
$string['nodehelp_help'] = '### Prueba
Es usada para comparar de expresiones y establecer si satifacen algÃºn criterio matemÃ¡tico.

### SAns
Es el primer argumento para la funciÃ³n que compara la respuesta. Es un prueba asimÃ©trica que debe considerarse como "la respuesta del alumno" aunque puede ser cualquier expresiÃ³n CAS vÃ¡lida, y tambiÃ©n puede depener de las variables de la pregunta o variables de la retroalimentaciÃ³n.

### TAns
Es el segundo argumento de la funciÃ³n que compara la respuesta. Es un prueba asimÃ©trica que debe considerarse como "la respuesta del alumno" aunque puede ser cualquier expresiÃ³n CAS vÃ¡lida, y tambiÃ©n puede depener de las variables de la pregunta o variables de la retroalimentaciÃ³n.

### Opciones
Este campo permite habilitar que la funciÃ³n que compara la respuesta acepte opciones, p.e. variables o preciones numericas.

### Silencio
Cuando es habilitado, cualquier retroalimentaciÃ³n automaticamente generada por la funciÃ³n que compara la respuesta, es suprimida, y no es mostrada al estudiante. Los campos de retroalimentiaciÃ³n en las ramas del Ã¡rbol no son afectados por esta opciÃ³n.
';
...
$string['nodexfalsefeedback'] = 'RetroalimentaciÃ³n rama falsa';
$string['nodextruefeedback'] = 'RetroalimentaciÃ³n rama verdadera';
$string['nodexwhenfalse'] = 'Si la prueba es falsa';
$string['nodexwhentrue'] = 'Si la prueba es verdadera';
$string['nonempty'] = 'No debe estar vacÃ­o.';
$string['penalty'] = 'PenalizaciÃ³n';
$string['penalty_help'] = 'El sistema de penalizaciÃ³n descuenta este valor del resultado de cada PRT para cada intento diferente y valido que no fuÃ© completamente correcto.';
$string['penalty_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Feedback.md';
$string['penaltyerror'] = 'La penalizaciÃ³n es un valor nÃºmerico entre 0 y 1.';
$string['penaltyerror2'] = 'La penalizaciÃ³n debe estar en blanco, o ser un valor nÃºmerico entre 0 y 1.';
$string['prtcorrectfeedback'] = 'RetroalimentaciÃ³n standard cuando es correcto';
$string['prtheading'] = 'Ã�rbol de respuestas potenciales: {$a}';
$string['prtincorrectfeedback'] = 'RetroalimentaciÃ³n standard cuando es incorrecto';
$string['prtpartiallycorrectfeedback'] = 'RetroalimentaciÃ³n standard cuando es parcialmente correcto';
$string['prtwillbecomeactivewhen'] = 'Este Ã¡rbol de respuestas potenciales se activarÃ¡ cuando el estudiante haya contestado: {$a}';
$string['questionnote'] = 'Notas de la pregunta';
$string['questionnote_help'] = 'Notas de la pregunta es un CASText. Su propÃ³sito es distiguir entre las versiones aleatorias de una pregunta. Dos versiones de una pregunta serÃ¡n iguales si y solo si las notas de la pregunta son iguales.  Para un anÃ¡lisis posterior es muy importante crear una buena nota de pregunta.';
$string['questionnote_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Question_note.md';
$string['questionnotempty'] = 'Notas de la pregunta no puede estar vacÃ­o cuando rand() aparece en las variables de la pregunta. Notas de la pregunta es usada para distiguir entre dos diferentes versiones aleatorias de una pregunta.';
...
$string['questiontext_help'] = 'El texto de la pregunta es un CASText. Esta es la "pregunta" que el estudiante realmente ve. Debes poner los elementos de entrada, y las cadenas de validaciÃ³n en este campo y sÃ³lo en este campo. Por ejemplo, usar `[[input:ans1]] [[validation:ans1]]`.';
$string['questiontext_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/CASText.md#question_text';
$string['questiontextmustcontain'] = 'EL texto de la pregunta deberÃ­a contener el sÃ­mbolo \'{$a}\'.';
$string['questiontextnonempty'] = 'El texto de la pregunta no debe estar vacÃ­o.';
$string['questiontextonlycontain'] = 'El texto de la pregunta solo debe contener el sÃ­mbolo \'{$a}\' una vez.';
$string['questiontextfeedbackonlycontain'] = 'El texo de la pregunta en combinaciÃ³n con la retroalimentaciÃ³n especifica sÃ³lo debe contener la palabra \'{$a}\' una vÃ©z.';
...
$string['questionvariables_help'] = 'Este campo permite definir y manipular variables CAS, p.e. crear versiones aleatorias. Las variables estÃ¡n disponibles en todas las partes de la pregunta.';
$string['questionvariables_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/KeyVals.md';
$string['quiet'] = 'Silencio';
$string['quiet_help'] = 'Cuando es habilitado, cualquier retroalimentaciÃ³n automaticamente generada por la funciÃ³n que compara la respuesta, es suprimida, y no es mostrada al estudiante. Los campos de retroalimentiaciÃ³n en las ramas del Ã¡rbol no son afectados por esta opciÃ³n.';
$string['requiredfield'] = 'Este campo es requerido!';
$string['requirelowestterms'] = 'Requerir mÃ­nima expresiÃ³n';
$string['requirelowestterms_help'] = 'Cuando esta opciÃ³n es Si, cual quier coeficiente o nÃºmeros racionales dentro de una expresiÃ³n, deberÃ¡n ser escritos en su mÃ­nima expresiÃ³n. De otra manera la respuesta serÃ¡ rechazada como invÃ¡lida.';
$string['requirelowestterms_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Inputs.md#Require_lowest_terms';
$string['sans'] = 'SAns';
$string['sans_help'] = 'Es el primer argumento para la funciÃ³n que compara la respuesta. Es un prueba asimÃ©trica que debe considerarse como "la respuesta del alumno" aunque puede ser cualquier expresiÃ³n CAS vÃ¡lida, y tambiÃ©n puede depener de las variables de la pregunta o variables de la retroalimentaciÃ³n.';
$string['sans_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Answer_tests.md';
$string['sansinvalid'] = 'SAns es invalida: {$a}';
$string['sansrequired'] = 'SAns no debe estar vacÃ­a.';
$string['stop'] = '[Detener]';
$string['score'] = 'CalificaciÃ³n';
$string['scoreerror'] = 'La calificaciÃ³n debe ser un nÃºmero entre 0 y 1.';
$string['scoremode'] = 'Modo';
$string['specificfeedback'] = 'RetroalimentaciÃ³n especifica';
$string['specificfeedback_help'] = 'Por default, la retroalimentaciÃ³n de cada Ã¡lbol de posibles respuestas se muestra en este bloque. Esto pude moverse al texto de la pregunta, pero en este caso Moodle tendrÃ¡ menos control sobre lo mostrado por diferentes comportamientos. Nota que este bloque no es un CASText.';
$string['specificfeedbacktags'] = 'La retroalimentiaciÃ³n especÃ­fica no debe contener las palabra(s) \'{$a}\'.';
$string['sqrtsign'] = 'Radical para la raÃ­z cuadrada';
...
$string['strictsyntax_help'] = 'Â¿La entrada debe ser usando la sintaxis estricta de Maxima? Si no, esto incrementa la gama de patrones que indican la falta de astericos, incluyendo el uso de funciones y notaciÃ³n cientÃ­fica en la entrada.';
$string['strictsyntax_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Inputs.md#Strict_Syntax';
$string['strlengtherror'] = 'Esta cadena no debe exceder 255 carÃ¡cteres de tamaÃ±o.';
$string['syntaxhint'] = 'Sugerir sintaxis';
$string['syntaxhint_help'] = 'Cuando el estudiante deje en blanco el campo de respuesta aparecerÃ¡ el contenido sugerido en esta caja.';
$string['syntaxhint_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Inputs.md#Syntax_Hint';
$string['tans'] = 'TAns';
$string['tans_help'] = 'Es el segundo argumento de la funciÃ³n que compara la respuesta. Es un prueba asimÃ©trica que debe considerarse como "la respuesta del alumno" aunque puede ser cualquier expresiÃ³n CAS vÃ¡lida, y tambiÃ©n puede depener de las variables de la pregunta o variables de la retroalimentaciÃ³n.';
$string['tans_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Answer_tests.md';
$string['tansinvalid'] = 'TAns es invalida: {$a}';
$string['tansrequired'] = 'TAns no debe esta vacÃ­a.';
$string['teachersanswer'] = 'Respuesta modelo';
$string['teachersanswer_help'] = 'El profesor debe especificar un modelo de respuesta para cada entrada. Este modelo debe ser una expresiÃ³n de Maxima, y puede ser construida usando las variables de la pregunta.';
...
$string['testoptions_help'] = 'Este campo permite habilitar que la funciÃ³n que compara la respuesta acepte opciones, p.e. variables o preciones numericas.';
...
$string['singlechargotmorethanone'] = 'Solo puedes introducir un carÃ¡cter aquÃ­.';

// Admin settings.
$string['settingajaxvalidation'] = 'ValidaciÃ³n instantÃ¡nea';
...
$string['settingcasmaximaversion'] = 'VersiÃ³n de Maxima';
...
$string['ddl_empty'] = 'No hay opciones en el menÃº desplegable. Por favor ingresa un grupo de valores enlazados con a,b,c,d';
...
$string['deletetestcaseareyousure'] = 'Â¿Esta seguro que desea borrar este caso de prueba {$a->no} para la pregunta {$a->question}?';
...
$string['expectedpenalty'] = 'PenalizaciÃ³n esperada';
$string['expectedscore'] = 'CalificaciÃ³n esperada';
...
$string['inputstatusnamescore'] = 'CalificaciÃ³n';
$string['notestcasesyet'] = 'No se han agregado casos de prueba aÃºn.';
$string['penalty'] = 'PenalizaciÃ³n';
$string['prtname'] = 'Nombre del PRT';
$string['questiondoesnotuserandomisation'] = 'Esta pregunta no usa aleatorizaciÃ³n.';
$string['questionnotdeployedyet'] = 'AÃºn no han sido implementadas variantes para esta pregunta.';
...
$string['deploymanynotes'] = 'Nota: STACK se darÃ¡ por vencido si hay 3 intentos fallidos para generar una nueva nota de pregunta, o cuando una prueba a la pregunta falle.';
...
$string['deploymanysuccess'] = 'El nÃºmero de nuevas variantes fue creado con Ã©xito, probadas e implementadas: {$a->no}.';
...
$string['stackCas_spaces']                  = 'Se encontraron espacios en la expresiÃ³n {$a->expr}.';
$string['stackCas_percent']                 = 'Se encontrÃ³ &#037 en la expresiÃ³n {$a->expr}.';
$string['stackCas_missingLeftBracket']      = 'Olvidaste un parÃ©ntesis izquierdo <span class="stacksyntaxexample">{$a->bracket}</span> en la expresiÃ³n: {$a->cmd}.';
$string['stackCas_missingRightBracket']     = 'Olvidaste un parÃ©ntesis derecho  <span class="stacksyntaxexample">{$a->bracket}</span> en la expresiÃ³n: {$a->cmd}.';
$string['stackCas_apostrophe']              = 'Los apostrÃ³fos no son permitidos en las respuestas.';
$string['stackCas_newline']                 = 'Retornos de carro no son permitidos en las respuestas.';
$string['stackCas_forbiddenChar']           = 'Comandos CAS no deben contener los siguientes carÃ¡ctes: {$a->char}.';
$string['stackCas_finalChar']               = '\'{$a->char}\' es un carÃ¡cter invalido en {$a->cmd}';
$string['stackCas_MissingStars']            = 'Parece que olvidaste el carÃ¡cter *. TalvÃ©z pretendiste escribir {$a->cmd}.';
$string['stackCas_unknownFunction']         = 'FunciÃ³n desconocida: {$a->forbid}.';
$string['stackCas_unsupportedKeyword']      = 'Palabra no soportada: {$a->forbid}.';
$string['stackCas_forbiddenWord']           = 'La expresiÃ³n {$a->forbid} esta prohibida.';
$string['stackCas_bracketsdontmatch']       = 'Existen parÃ©ntesis mal anidados en la expresiÃ³n: {$a->cmd}.';

// Used in cassession.class.php.
$string['stackCas_CASError']                = 'El CAS ha regresado el siguiente error:';
$string['stackCas_allFailed']               = 'FallÃ³ el CAS al regresar ninguna expresiÃ³n evaluada. Por favor comprueba la conexiÃ³n con el CAS.';
$string['stackCas_failedReturn']            = 'FallÃ³ el CAS al regresar ningÃºn dato.';
...
$string['stackCas_failedValidation']        = 'FallÃ³ la validaciÃ³n del CASText. ';
$string['stackCas_invalidCommand']          = 'Comandos CAS no validos. ';
$string['stackCas_CASErrorCaused']          = 'causÃ³ el siguiente error:';

$string['Maxima_DivisionZero']  = 'DivisiÃ³n por cero.';
$string['Lowest_Terms']   = 'Tu respuesta contiene fracciones que no estÃ¡n escritas en su mÃ­nima expresiÃ³n. Por favor, cancela facores e intenta de nuevo.';
$string['Illegal_floats'] = 'Tu respuesta contiene nÃºmeros con punto decimal, eso no esta permitido en esta pregunta. Necesitas escribir el nÃºmero en fraciones. Por ejemplo, debes escribir 1/3 no 0.3333.';
$string['qm_error'] = 'Tu respuesta contiene signos de interrogaciÃ³n, esto no esta permitido como respuestas. Debes reemplazarlos por valores especificos.';
...
$string['TEST_FAILED']              = 'La prueba a la respuesta no se ejecutÃ³ correctamente:Por favor avisa a tu profesor. {$a->errors}';
$string['AT_MissingOptions']        = 'Se omitiÃ³ alguna opciÃ³n cuando se ejecutÃ³ la prueba. ';
$string['AT_InvalidOptions']        = 'El campo opciÃ³n es invÃ¡lido. {$a->errors}';

$string['ATAlgEquiv_SA_not_expression'] = 'La respuesta deberÃ­a ser una expresiÃ³n, no una ecuaciÃ³n, desigualdad, lista, conjunto o matriz.';
$string['ATAlgEquiv_SA_not_matrix']     = 'La respuesta deberÃ­a ser una matriz, pero no es asÃ­.';
$string['ATAlgEquiv_SA_not_list']       = 'La respuesta deberÃ­a ser una lista, pero no es asÃ­. La sintaxis para intruducir una lista es: [a,b,c].';
$string['ATAlgEquiv_SA_not_set']        = 'La respuesta deberÃ­a ser un conjunto, pero no es asÃ­. La sintaxis para intrudicir un conjunto es: {a,b,c}.';
$string['ATAlgEquiv_SA_not_equation']   = 'La respuesta deberÃ­a ser una ecuaciÃ³n, pero no es asÃ­.';
$string['ATAlgEquiv_TA_not_equation']   = 'La respuesta es una ecuaciÃ³n, pero la expresiÃ³n con la que fuÃ© comparada no lo es. TalvÃ©z escribiste algo como "y=2*x+1" cuando solo es necesario escribir "2*x+1"';
$string['ATAlgEquiv_SA_not_inequality'] = 'La respuesta deberÃ­a ser una desigualdad, pero no es asÃ­.';
$string['Subst']                        = 'La respuesta serÃ¡ correcta si utilizas la siguiente sustituciÃ³n de variables. {$a->m0} ';


$string['ATInequality_nonstrict']       = 'La desigualdad deberÃ­a ser estricta, pero no es asÃ­! ';
$string['ATInequality_strict']          = 'La desigualdad no deberÃ­a ser estricta! ';
$string['ATInequality_backwards']       = 'La desigualdad parece estar al revÃ©s. ';

$string['ATLowestTerms_wrong']          = 'Necesitas cancelar fraciones en tu respuesta. ';
$string['ATLowestTerms_entries']        = 'Los siguientes tÃ©rminos no estÃ¡n en su mÃ­nima expresiÃ³n en tu respuesta.  {$a->m0} Por favor intenta de nuevo.  ';


$string['ATList_wronglen']          = 'La lista deberÃ­a tener {$a->m0} elementos, pero actualmente tiene {$a->m1}. ';
$string['ATList_wrongentries']      = 'Las siguientes entradas en rojo son incorrectas. {$a->m0} ';

$string['ATMatrix_wrongsz']         = 'La matrix deberÃ­a ser {$a->m0} por {$a->m1}, pero actualmente es {$a->m2} por {$a->m3}. ';
$string['ATMatrix_wrongentries']    = 'Las siguientes entradas en rojo son incorrectas. {$a->m0} ';

$string['ATSet_wrongsz']            = 'El conjunto deberÃ­a tener {$a->m0} elementos diferentes, pero actualmente tiene {$a->m1}. ';
$string['ATSet_wrongentries']       = 'Las siguientes entradas son incorrectas, aunque parece que estÃ¡n en forma simplificada de lo que actualmente entrÃ³. {$a->m0} ';

$string['irred_Q_factored']         = 'El tÃ©rmino {$a->m0} deberÃ­a estar desarrollado, pero no es asÃ­. ';
$string['irred_Q_commonint']        = 'Tienes que extraer factor comÃºn. ';  // Needs a space at the end.
$string['irred_Q_optional_fac']     = 'PodrÃ­as trabajar un poco mas, {$a->m0} puede factorizarse mas.  Desde luego, no es necesario. ';

$string['FacForm_UnPick_morework']  = 'PodrÃ­a hacer mas trabajo en el tÃ©rmino {$a->m0}. ';
$string['FacForm_UnPick_intfac']    = 'Es necesario extraer factor comÃºn. ';
...
$string['ATPartFrac_error_list']        = 'La prueba a la respuesta fallÃ³. Por favor contacta al administrador del sistema';
$string['ATPartFrac_true']              = '';
$string['ATPartFrac_single_fraction']   ='La respuesta parece ser una fracciÃ³n comÃºn, cuando deberÃ­a ser una fracciÃ³n parcial. ';
$string['ATPartFrac_diff_variables']    ='Las variables en la respuesta son diferentes a las de la pregunta, por favor revisa. ';
$string['ATPartFrac_denom_ret']         ='Si la respuesta se escribe como fracciÃ³n comÃºn, entonces el denominador serÃ­a {$a->m0}. De hecho, deberÃ­a ser {$a->m1}. ';
$string['ATPartFrac_ret_expression']    ='La respuesta como fracciÃ³n comÃºn es {$a->m0} ';

$string['ATSingleFrac_error_list']     = 'La prueba a la respuesta fallÃ³.  Por favor contacta al administrador del sistema';
$string['ATSingleFrac_true']           = '';
$string['ATSingleFrac_part']           = 'La respuesta debe ser una fracciÃ³n comÃºn de la forma \( {a}\over{b} \). ';
...
$string['ATSingleFrac_div']            = 'La respuesta contiene fracciones dentro de fracciones.  Necesitas simplificar y escribir la respuesta como una fracciÃ³n comÃºn.';
...
$string['ATInt_error_list']         = 'La prueba a la respuesta fallÃ³.  Por favor contacta al administrador del sistema';
$string['ATInt_const_int']          = 'Necesistas agregar una constante de integraciÃ³n. Debe ser una constante arbitraria, no un nÃºmero.';
$string['ATInt_const']              = 'You need to add a constant of integration, otherwise this appears to be correct.  Well done.';
$string['ATInt_EqFormalDiff']       = 'La derivada formal de la respuesta es igual a la expresiÃ³n que se te pidiÃ³ integrar. Sin embargo, tu respuesta difiere significativamente de la respuesta correcta, The formal derivative of your answer does equal the expression that you were asked to integrate.  However, your answer differs from the correct answer in a significant way, that is to say not just, eg, a constant of integration.  Please ask your teacher about this.';
...
$string['ATNumSigFigs_error_list']  = 'La prueba a la respuesta fallÃ³.  Por favor, contacta al administrador del sistema';
$string['ATNumSigFigs_NotDecimal']  = 'La respuesta deberÃ­a ser un nÃºmero decimal, pero no es asÃ­! ';
$string['ATNumSigFigs_Inaccurate']  = 'La precisiÃ³n de la respuesta no es correcta. O no has redondeado adecuadamente, o has redondeado un resultado parcial donde se propago el error.';
$string['ATNumSigFigs_WrongDigits'] = 'La respuesta contiene un nÃºmero incorrecto de dÃ­gitos significativos. ';

$string['ATSysEquiv_SA_not_list']               = 'La respuesta deberÃ­a ser una lista, pero no es asÃ­!';
$string['ATSysEquiv_SB_not_list']               = 'La respuesta del profesor no es una lista.  Por favor, contacta al profesor.';
$string['ATSysEquiv_SA_not_eq_list']            = 'La respuesta deberÃ­a ser una lista de ecuaciones, pero no es asÃ­!';
...
$string['ATSysEquiv_SB_not_poly_eq_list']       = 'La respuesta del profesor debe ser una lista de ecuaciones polinÃ³micas, pero no es asÃ­. Por favor, contacta al profesor.';
...
$string['ATRegEx_missing_option']               = 'Falta una expresiÃ³n regular en el campo opciones \(CAS\).';
...
$string['stackDoc_docs']                = 'DocumentaciÃ³n de STACK';
$string['stackDoc_docs_desc']           = '<a href="{$a->link}">DocumentaciÃ³n para  STACK</a>: Wiki estÃ¡tico y local.';
$string['stackDoc_home']                = 'Inicio de la DocumentaciÃ³n';
...
<table>
<tr><td>
 MayÃºsculas, \(\quad\) </td><td>  MinÃºsculas, \(\quad\) </td><td>  Nombre </td> </tr>   <tr> <td>
 ...
 \(E\)  </td><td>  \(\epsilon\)  </td><td>  Ã©psilon </td> </tr>   <tr> <td>
 ...
 \(\Upsilon\)  </td><td>  \(\upsilon\)  </td><td>  Ã­psilon </td> </tr>   <tr> <td>
...
$string['alg_indices_fact'] = 'Las siguientes leyes rigen la manipulaciÃ³n de exponentes:
\[a^ma^n = a^{m+n}\] 
\[\frac{a^m}{a^n} = a^{m-n}\] 
\[(a^m)^n = a^{mn}\]
\[a^0 = 1\] 
...
\[\log_b(1) = 0\]
\[\log_b(b) = 1\]
La fÃ³rmula para cambiar de base es:
\[\log_a(x) = \frac{\log_b(x)}{\log_b(a)}\]
Logaritmos de base $e$, denotado por $\log_e$ o tambiÃ©n $\ln$ se llaman logaritmos naturales.  La letra $e$ representa una constante exponencial que es aproximadamente 2.718.';

$string['alg_quadratic_formula_name'] = 'FÃ³rmula CuadrÃ¡tica';
$string['alg_quadratic_formula_fact'] = 'Si tenemos una ecuaciÃ³n cuadrÃ¡tica en la forma:
\[ax^2 + bx + c = 0,\]
entonces las soluciones para esta ecuaciÃ³n estan dadas por la fÃ³rmula cuadrÃ¡tica:
...
<ul>
<li>
a <em>factor lineal</em> $ax+b$ en el denominador se produce una fracciÃ³n parcial de la forma \[{\frac{A}{ax+b}}.\]
</li>
<li>
a <em>factores lineales repetidos</em> $(ax+b)^2$ en el denominador
produce una fracciÃ³n parcial de la forma \[{A\over ax+b}+{B\over (ax+b)^2}.\]
</li>
<li>
a <em>factor cuadrÃ¡tico</em> $ax^2+bx+c$
en el denominador produce una fracciÃ³n parcial de
la forma \[{Ax+B\over ax^2+bx+c}\]
</li>
<li>
<em>Fracciones impropias}</em> requiere un tÃ©rmino
...
\]
\[
1 \hbox{ radiÃ¡n} = {180\over \pi} \hbox{ grados}
\approx 57.3^\circ
\]';

$string['trig_standard_values_name'] = 'Valores de Funciones TrigonomÃ©tricas';
...
$string['trig_standard_identities_name'] = 'Identidades TrigonomÃ©tricas';
...
$string['hyp_functions_name'] = 'Funciones HiperbÃ³licas';
$string['hyp_functions_fact'] = 'Las funciones hiperbÃ³licas tienen propiedades similares a las funciones trigonomÃ©tricas pero pueden ser representadas en forma exponencial como sigue:
...
$string['hyp_identities_name'] = 'Identidades HiperbÃ³licas';
$string['hyp_identities_fact'] = 'La similitud de comportamiento entre las funciones hiperbÃ³licas y la trigonomÃ©tricas se hace evidente al observar algunas identidades hiperbÃ³licas bÃ¡sicas:
...
$string['hyp_inverse_functions_name'] = 'Funciones HiperbÃ³licas Inversas';
...
$string['calc_diff_standard_derivatives_name'] = 'Derivadas BÃ¡sicas';
$string['calc_diff_standard_derivatives_fact'] = 'La siguiente tabla muestra algunas derivadas de funciones bÃ¡sicas.  Es Ãºtil aprender estas derivadas bÃ¡sicas porque son usadas frecuentemente en cÃ¡lculo.
<center>
<table>
...
$string['calc_diff_linearity_rule_name'] = 'Regla de Linealidad para la DiferenciaciÃ³n';
...
$string['calc_product_rule_fact'] = 'La siguiente regla permite derivar funciones que se multiplican entre sÃ­. Supongamos que se desea derivar \(f(x)g(x)\) respecto de \(x\).
\[ \frac{\mathrm{d}}{\mathrm{d}{x}} \big(f(x)g(x)\big) = f(x) \cdot \frac{\mathrm{d} g(x)}{\mathrm{d}{x}}  + g(x)\cdot \frac{\mathrm{d} f(x)}{\mathrm{d}{x}},\] o, usando una notaciÃ³n alterna, \[ (f(x)g(x))\' = f\'(x)g(x)+f(x)g\'(x). \]';
...
Supongamos que tenemos la funciÃ³n \(f(g(x))\), entonces definimos \(u=g(x)\), la derivada respecto de \(x\) esta dada por:
\[\frac{df(g(x))}{dx} = \frac{dg(x)}{dx}\cdot\frac{df(u)}{du}.\]
TambiÃ©n podemos escribirla como:
\[\frac{df(x)}{dx} = f\'(g(x))\cdot g\'(x).\]
';

$string['calc_rules_name'] = 'Reglas para CÃ¡lculo';
...
$string['calc_int_standard_integrals_name'] = 'Integrales BÃ¡sicas';
...
$string['calc_int_methods_substitution_name'] = 'IntegraciÃ³n por sustituciÃ³n';
...
$string['calc_int_methods_parts_name'] = 'IntegraciÃ³n por Partes';
