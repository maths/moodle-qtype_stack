...
$string['chat_desc'] = '<a href="{$a->link}">DAS-chatskroptet</a> låter dig testa kopplingen till DAS och testa Maxima-syntax.';
$string['exceptionmessage'] = '{$a}';
$string['feedback'] = 'Feedback';
...
$string['settingcastimeout'] = 'DAS svarade inte inom utsatt tid';
