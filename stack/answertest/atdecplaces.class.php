...
class stack_anstest_atdecplaces extends stack_anstest {
    ...
    public function do_test() {
        ...
        //TODO - strip this out.  Used for tracking to see exactly what answer is supplied.
        ...
        // (1) Check that the first expression is a floating point number,
        ...
        // (2) Check that the two numbers evaluate to the same value.
        $cascommands = array();
