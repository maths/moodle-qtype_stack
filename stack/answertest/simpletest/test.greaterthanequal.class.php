...
/**
 * Unit tests for STACK_AnsTest_GreaterThanEqual .
 *
...
class STACK_AnsTest_GreaterThanEqual_test extends UnitTestCase {
    ...
    public function test_is_false_for_expressions_with_different_type() {
        $at = new STACK_AnsTest_GreaterThanEqual('(x+1)^2', '[a,b,c]');
        $this->assertFalse($at->doAnsTest());
        $this->assertEqual(0, $at->getATMark());
    }
}
