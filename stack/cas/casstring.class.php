...
class stack_cas_casstring {
    ...
    // Lists of strings
    private static $globalforbid     = array( '%TH' , 'ADAPTH_DEPTH' , 'ALIAS' , 'ALIASES' , 'ALPHABETIC' , 'APPENDFILE' , 'APROPOS' , 'ASSUME_EXTERNAL_BYTE_ORDER' , 'BACKTRACE' , 'BATCH' , 'BATCHLOAD' , 'BOX' , 'BOXCHAR' , 'BREAK' , 'BUG_REPORT' , 'BUILD_INFO' , 'CATCH' , 'CLOSE' , 'CLOSEFILE' , 'COMPFILE' , 'COMPILE' , 'COMPILE_FILE' , 'CURRENT_LET_RULE_PACKAGE' , 'DATA_FILE_NAME' , 'DEACTIVATE' , 'DEBUGMODE' , 'DEFINE' , 'DEFINE_VARIABLE' , 'DEMO' , 'DEPENDENCIES' , 'DESCRIBE' , 'DIMACS_EXPORT' , 'DIMACS_IMPORT' , 'ERRCATCH' , 'ERROR' , 'ERROR_SIZE' , 'ERROR_SYMS' , 'ERRORMSG' , 'EVAL_STRING' , 'EXAMPLE' , 'FEATURE' , 'FEATUREP' , 'FEATURES' , 'FILE_NAME' , 'FILE_OUTPUT_APPEND' , 'FILE_SEARCH' , 'FILE_SEARCH_DEMO' , 'FILE_SEARCH_LISP' , 'FILE_SEARCH_MAXIMA' , 'FILE_TYPE' , 'FILENAME_MERGE' , 'FLENGTH' , 'FORTINDENT' , 'FORTRAN' , 'FORTSPACES' , 'FPOSITION' , 'FRESHLINE' , 'FUNCTIONS' , 'FUNDEF' , 'FUNMAKE' , 'GNUPLOT_FILE_NAME' , 'GNUPLOT_OUT_FILE' , 'GNUPLOT_PREAMBLE' , 'GNUPLOT_PS_TERM_COMMAND' , 'GNUPLOT_TERM' , 'INCHAR' , 'INFEVAL' , 'INFOLISTS' , 'KILL' , 'KILLCONTEXT' , 'LABELS' , 'LDISP' , 'LDISPLAY' , 'LINECHAR' , 'LINEL' , 'LINENUM' , 'LINSOLVEWARN' , 'LMXCHAR' , 'LOAD' , 'LOADFILE' , 'LOADPRINT' , 'MACROEXPAND' , 'MACROEXPAND1' , 'MACROEXPANSION' , 'MACROS' , 'MANUAL_DEMO' , 'MAXIMA_TEMPDIR' , 'MAXIMA_USERDIR' , 'MULTIPLOT_MODE' , 'MYOPTIONS' , 'NEWLINE' , 'NOLABELS' , 'OPENA' , 'OPENA_BINARY' , 'OPENR' , 'OPENR_BINARY' , 'OPENW' , 'OPENW_BINARY' , 'OUTCHAR' , 'PACKAGEFILE' , 'PARSE_STRING' , 'PICKAPART' , 'PIECE' , 'PLAYBACK' , 'PLOTDF' , 'PRINT_GRAPH' , 'PRINTF' , 'PRINTFILE' , 'PROMPT' , 'PSFILE' , 'QUIT' , 'READ' , 'READ_ARRAY' , 'READ_BINARY_ARRAY' , 'READ_BINARY_LIST' , 'READ_BINARY_MATRIX' , 'READ_HASHED_ARRAY' , 'READ_LIST' , 'READ_MATRIX' , 'READ_NESTED_LIST' , 'READ_XPM' , 'READLINE' , 'READONLY' , 'REFCHECK' , 'REMBOX' , 'REMFUNCTION' , 'RESET' , 'RMXCHAR' , 'ROOM' , 'RUN_TESTSUITE' , 'RUN_VIEWER' , 'SAVE' , 'SAVEDEF' , 'SET_PLOT_OPTION' , 'SETCHECK' , 'SETCHECKBREAK' , 'SETVAL' , 'SHOWTIME' , 'SPARSE6_EXPORT' , 'SPARSE6_IMPORT' , 'SPLICE' , 'SPRINT' , 'STATUS' , 'STRINGOUT' , 'SUPCONTEXT' , 'SYSTEM' , 'TCL_OUTPUT' , 'TERMINAL' , 'TESTSUITE_FILES' , 'THROW' , 'TIME' , 'TIMER' , 'TIMER_DEVALUE' , 'TIMER_INFO' , 'TO_LISP' , 'TRACE' , 'TRACE_OPTIONS' , 'TRANSCOMPILE' , 'TRANSLATE' , 'TRANSLATE_FILE' , 'TRANSRUN' , 'TTYOFF' , 'UNTIMER' , 'UNTRACE' , 'USER_PREAMBLE' , 'VALUES' , 'WITH_STDOUT' , 'WRITE_BINARY_DATA' , 'WRITE_DATA' , 'WRITEFILE' );
    ...
    private static $studentallow     = array( '%C' , '%E' , '%GAMMA' , '%I' , '%K1' , '%K2' , '%PHI' , '%PI' , 'ABS' , 'ABSINT' , 'ACOS' , 'ACOSH' , 'ACOT' , 'ACOTH' , 'ACSC' , 'ACSCH' , 'ADDMATRICES' , 'ADJOIN' , 'AND' , 'ASCII' , 'ASEC' , 'ASECH' , 'ASIN' , 'ASINH' , 'ATAN' , 'ATAN2' , 'ATANH' , 'AUGCOEFMATRIX' , 'BELLN' , 'BESSEL_I' , 'BESSEL_J' , 'BESSEL_K' , 'BESSEL_Y' , 'BESSELEXPAND' , 'BETA' , 'BEZOUT' , 'BFFAC' , 'BFHZETA' , 'BFLOAT' , 'BFLOATP' , 'BINOMIAL' , 'BLOCKMATRIXP' , 'BURN' , 'CABS' , 'CARDINALITY' , 'CARG' , 'CARTAN' , 'CARTESIAN_PRODUCT' , 'CEILING' , 'CEQUAL' , 'CEQUALIGNORE' , 'CF' , 'CFDISREP' , 'CFEXPAND' , 'CFLENGTH' , 'CGREATERP' , 'CGREATERPIGNORE' , 'CHARAT' , 'CHARFUN' , 'CHARFUN2' , 'CHARLIST' , 'CHARP' , 'CHARPOLY' , 'CINT' , 'CLESSP' , 'CLESSPIGNORE' , 'COEFF' , 'COEFMATRIX' , 'COL' , 'COLUMNOP' , 'COLUMNSPACE' , 'COLUMNSWAP' , 'COMBINE' , 'COMPARE' , 'CONCAT' , 'CONJUGATE' , 'CONS' , 'CONSTITUENT' , 'COPY' , 'COS' , 'COSH' , 'COT' , 'COTH' , 'COVECT' , 'CSC' , 'CSCH' , 'CSPLINE' , 'CTRANSPOSE' , 'DBLINT' , 'DEFINT' , 'DEL' , 'DELETE' , 'DELTA' , 'DENOM' , 'DESOLVE' , 'DETERMINANT' , 'DETOUT' , 'DGAUSS_A' , 'DGAUSS_B' , 'DIAG_MATRIX' , 'DIAGMATRIX' , 'DIFF' , 'DIGITCHARP' , 'DISJOIN' , 'DISJOINTP' , 'DISOLATE' , 'DIVIDE' , 'DIVISORS' , 'DIVSUM' , 'DKUMMER_M' , 'DKUMMER_U' , 'DOTPRODUCT' , 'ECHELON' , 'EIGENVALUES' , 'EIGENVECTORS' , 'EIGHTH' , 'EIVALS' , 'EIVECTS' , 'ELEMENTP' , 'ELIMINATE' , 'ELLIPTIC_E' , 'ELLIPTIC_EC' , 'ELLIPTIC_EU' , 'ELLIPTIC_F' , 'ELLIPTIC_KC' , 'ELLIPTIC_PI' , 'EMATRIX' , 'EMPTYP' , 'ENDCONS' , 'EPSILON_LP' , 'EQUAL' , 'EQUALP' , 'EQUIV_CLASSES' , 'ERF' , 'EULER' , 'EV' , 'EVAL' , 'EVENP' , 'EVERY' , 'EXP' , 'EXPAND' , 'EXPANDWRT' , 'EXPANDWRT_DENOM' , 'EXPANDWRT_FACTORED' , 'EXPRESS' , 'EXTREMAL_SUBSET' , 'EZGCD' , 'FACSUM' , 'FACSUM_COMBINE' , 'FACTCOMB' , 'FACTLIM' , 'FACTOR' , 'FACTORFACSUM' , 'FACTORIAL' , 'FACTOROUT' , 'FACTORSUM' , 'FALSE' , 'FASTTIMES' , 'FFT' , 'FIB' , 'FIBTOPHI' , 'FIFTH' , 'FIND_ROOT' , 'FIND_ROOT_ABS' , 'FIND_ROOT_ERROR' , 'FIND_ROOT_REL' , 'FIRST' , 'FLATTEN' , 'FLOAT' , 'FLOAT2BF' , 'FLOOR' , 'FOURCOS' , 'FOUREXPAND' , 'FOURIER' , 'FOURINT' , 'FOURINTCOS' , 'FOURINTSIN' , 'FOURSIMP' , 'FOURSIN' , 'FOURTH' , 'FREEOF' , 'FULL_LISTIFY' , 'FULLMAP' , 'FULLMAPL' , 'FULLRATSIMP' , 'FULLRATSUBST' , 'FULLSETIFY' , 'FUNCSOLVE' , 'FUNP' , 'GAMMA' , 'GAMMA_INCOMPLETE' , 'GAMMA_INCOMPLETE_GENERALIZED' , 'GAMMA_INCOMPLETE_REGULARIZED' , 'GAUSS_A' , 'GAUSS_B' , 'GCD' , 'GCDEX' , 'GCFACTOR' , 'GENMATRIX' , 'GET_LU_FACTORS' , 'GFACTOR' , 'GFACTORSUM' , 'GRAMSCHMIDT' , 'HANKEL' , 'HESSIAN' , 'HGFRED' , 'HILBERT_MATRIX' , 'HIPOW' , 'HORNER' , 'HYPERGEOMETRIC' , 'HYPERGEOMETRIC_REPRESENTATION' , 'IDENT' , 'IDENTFOR' , 'IDENTITY' , 'IFACTORS' , 'IMAGPART' , 'IND' , 'INF' , 'INFINITY' , 'INNERPRODUCT' , 'INRT' , 'INTEGER_PARTITIONS' , 'INTEGRATE' , 'INTERSECT' , 'INTERSECTION' , 'INTOSUM' , 'INV_MOD' , 'INVERSE_JACOBI_CD' , 'INVERSE_JACOBI_CN' , 'INVERSE_JACOBI_CS' , 'INVERSE_JACOBI_DC' , 'INVERSE_JACOBI_DN' , 'INVERSE_JACOBI_DS' , 'INVERSE_JACOBI_NC' , 'INVERSE_JACOBI_ND' , 'INVERSE_JACOBI_NS' , 'INVERSE_JACOBI_SC' , 'INVERSE_JACOBI_SD' , 'INVERSE_JACOBI_SN' , 'INVERT' , 'ISQRT' , 'JACOBI' , 'JACOBI_CD' , 'JACOBI_CN' , 'JACOBI_CS' , 'JACOBI_DC' , 'JACOBI_DN' , 'JACOBI_DS' , 'JACOBI_NC' , 'JACOBI_ND' , 'JACOBI_NS' , 'JACOBI_SC' , 'JACOBI_SD' , 'JACOBI_SN' , 'JACOBIAN' , 'JOIN' , 'KRON_DELTA' , 'KRONECKER_PRODUCT' , 'KUMMER_M' , 'KUMMER_U' , 'LAGRANGE' , 'LAMBDA' , 'LAMBERT_W' , 'LAPLACE' , 'LAST' , 'LCM' , 'LDEFINT' , 'LENGTH' , 'LHS' , 'LIMIT' , 'LINEARINTERPOL' , 'LINSOLVE' , 'LINSOLVE_PARAMS' , 'LISTIFY' , 'LMAX' , 'LMIN' , 'LOCATE_MATRIX_ENTRY' , 'LOG' , 'LOG10' , 'LOG_GAMMA' , 'LOGABS' , 'LOGARC' , 'LOGCONTRACT' , 'LOGEXPAND' , 'LOGNEGINT' , 'LOGNUMER' , 'LOGSIMP' , 'LOPOW' , 'LOWERCASEP' , 'LRATSUBST' , 'LREDUCE' , 'LSUM' , 'LU_BACKSUB' , 'LU_FACTOR' , 'MAKE_TRANSFORM' , 'MAKEFACT' , 'MAKEGAMMA' , 'MAKELIST' , 'MAKESET' , 'MAP' , 'MAPATOM' , 'MAPLIST' , 'MAT_COND' , 'MAT_FULLUNBLOCKER' , 'MAT_NORM' , 'MAT_TRACE' , 'MAT_UNBLOCKER' , 'MATRIX' , 'MATRIX_ELEMENT_ADD' , 'MATRIX_ELEMENT_MULT' , 'MATRIX_ELEMENT_TRANSPOSE' , 'MATRIX_SIZE' , 'MATRIXMAP' , 'MATRIXP' , 'MATTRACE' , 'MAX' , 'MEMBER' , 'MIN' , 'MINF' , 'MINFACTORIAL' , 'MOD' , 'MOEBIUS' , 'MULTINOMIAL_COEFF' , 'MULTTHRU' , 'NCEXPT' , 'NCHARPOLY' , 'NEWDET' , 'NINTH' , 'NOEVAL' , 'NONNEGINTEGERP' , 'NOT' , 'NOTEQUAL' , 'NROOTS' , 'NTERMS' , 'NTHROOT' , 'NULLITY' , 'NULLSPACE' , 'NUM' , 'NUM_DISTINCT_PARTITIONS' , 'NUM_PARTITIONS' , 'NUMBERP' , 'NUMER' , 'NUMERVAL' , 'NUMFACTOR' , 'NUSUM' , 'NZETA' , 'NZETAI' , 'NZETAR' , 'ODDP' , 'OP' , 'OPERATORP' , 'OR' , 'ORDERGREAT' , 'ORDERGREATP' , 'ORDERLESS' , 'ORDERLESSP' , 'ORTHOGONAL_COMPLEMENT' , 'OUTERMAP' , 'PADE' , 'PARABOLIC_CYLINDER_D' , 'PART' , 'PART2CONT' , 'PARTFRAC' , 'PARTITION' , 'PARTITION_SET' , 'PERMANENT' , 'PERMUTATIONS' , 'PLOG' , 'POISDIFF' , 'POISEXPT' , 'POISINT' , 'POISLIM' , 'POISMAP' , 'POISPLUS' , 'POISSIMP' , 'POISSON' , 'POISSUBST' , 'POISTIMES' , 'POISTRIM' , 'POLARFORM' , 'POLARTORECT' , 'POLYMOD' , 'POLYNOME2ELE' , 'POLYNOMIALP' , 'POLYTOCOMPANION' , 'POSFUN' , 'POTENTIAL' , 'POWER_MOD' , 'POWERDISP' , 'POWERS' , 'POWERSERIES' , 'POWERSET' , 'PRIMEP' , 'PRINTPOIS' , 'QUAD_QAG' , 'QUAD_QAGI' , 'QUAD_QAGS' , 'QUAD_QAWC' , 'QUAD_QAWF' , 'QUAD_QAWO' , 'QUAD_QAWS' , 'QUNIT' , 'QUOTIENT' , 'RADCAN' , 'RADEXPAND' , 'RADSUBSTFLAG' , 'RANK' , 'RASSOCIATIVE' , 'RAT' , 'RATALGDENOM' , 'RATCOEF' , 'RATDENOM' , 'RATDENOMDIVIDE' , 'RATDIFF' , 'RATDISREP' , 'RATEPSILON' , 'RATEXPAND' , 'RATFAC' , 'RATIONALIZE' , 'RATMX' , 'RATNUMER' , 'RATNUMP' , 'RATP' , 'RATSIMP' , 'RATSIMPEXPONS' , 'RATSUBST' , 'RATVARS' , 'RATWEIGHT' , 'RATWEIGHTS' , 'REALONLY' , 'REALPART' , 'REALROOTS' , 'RECTFORM' , 'RECTTOPOLAR' , 'REMAINDER' , 'REMFUN' , 'RESIDUE' , 'REST' , 'RESULTANT' , 'REVERSE' , 'RHS' , 'RISCH' , 'RNCOMBINE' , 'ROMBERG' , 'ROMBERGABS' , 'ROMBERGIT' , 'ROMBERGMIN' , 'ROMBERGTOL' , 'ROOTSCONMODE' , 'ROOTSCONTRACT' , 'ROOTSEPSILON' , 'ROUND' , 'ROW' , 'ROWOP' , 'ROWSWAP' , 'RREDUCE' , 'SCALARMATRIXP' , 'SCALARP' , 'SCALED_BESSEL_I' , 'SCALED_BESSEL_I0' , 'SCALED_BESSEL_I1' , 'SCALEFACTORS' , 'SCANMAP' , 'SCHUR2COMP' , 'SCONCAT' , 'SCOPY' , 'SCSIMP' , 'SDOWNCASE' , 'SEC' , 'SECH' , 'SECOND' , 'SEQUAL' , 'SEQUALIGNORE' , 'SET_PARTITIONS' , 'SETDIFFERENCE' , 'SETEQUALP' , 'SETIFY' , 'SETP' , 'SEVENTH' , 'SEXPLODE' , 'SIGN' , 'SIGNUM' , 'SIMPSUM' , 'SIN' , 'SINH' , 'SINNPIFLAG' , 'SINSERT' , 'SINVERTCASE' , 'SIXTH' , 'SLENGTH' , 'SMAKE' , 'SMISMATCH' , 'SOLVE' , 'SOLVEDECOMPOSES' , 'SOLVEEXPLICIT' , 'SOLVEFACTORS' , 'SOLVENULLWARN' , 'SOLVERADCAN' , 'SOLVETRIGWARN' , 'SOME' , 'SORT' , 'SPACE' , 'SPARSE' , 'SPECINT' , 'SPOSITION' , 'SQFR' , 'SQRT' , 'SQRTDISPFLAG' , 'SREMOVE' , 'SREMOVEFIRST' , 'SREVERSE' , 'SSEARCH' , 'SSORT' , 'SSUBST' , 'SSUBSTFIRST' , 'STRIM' , 'STRIML' , 'STRIMR' , 'STRINGP' , 'STRUVE_H' , 'STRUVE_L' , 'SUBLIS' , 'SUBLIS_APPLY_LAMBDA' , 'SUBLIST' , 'SUBLIST_INDICES' , 'SUBMATRIX' , 'SUBSET' , 'SUBSETP' , 'SUBST' , 'SUBSTINPART' , 'SUBSTPART' , 'SUBSTRING' , 'SUBVARP' , 'SUM' , 'SUMCONTRACT' , 'SUMEXPAND' , 'SUPCASE' , 'SYMBOLP' , 'SYMMDIFFERENCE' , 'TAN' , 'TANH' , 'TAYLOR' , 'TAYLOR_LOGEXPAND' , 'TAYLOR_ORDER_COEFFICIENTS' , 'TAYLOR_SIMPLIFIER' , 'TAYLOR_TRUNCATE_POLYNOMIALS' , 'TAYLORDEPTH' , 'TAYLORINFO' , 'TAYLORP' , 'TAYTORAT' , 'TELLSIMP' , 'TELLSIMPAFTER' , 'TENTH' , 'THIRD' , 'TLIMIT' , 'TLIMSWITCH' , 'TODD_COXETER' , 'TOEPLITZ' , 'TRANSPOSE' , 'TREE_REDUCE' , 'TRIANGULARIZE' , 'TRIGEXPAND' , 'TRIGEXPANDPLUS' , 'TRIGEXPANDTIMES' , 'TRIGINVERSES' , 'TRIGRAT' , 'TRIGREDUCE' , 'TRIGSIGN' , 'TRIGSIMP' , 'TRUE' , 'TRUNC' , 'UND' , 'UNION' , 'UNIQUE' , 'UNSUM' , 'UNTELLRAT' , 'UPPERCASEP' , 'VANDERMONDE_MATRIX' , 'VECT_CROSS' , 'VECTORPOTENTIAL' , 'VECTORSIMP' , 'XREDUCE' , 'XTHRU' , 'ZEROBERN' , 'ZEROEQUIV' , 'ZEROFOR' , 'ZEROMATRIX' , 'ZEROMATRIXP' , 'ZETA' , 'ZETA%PI' , 'PI' , 'E' , 'I' , 'FLOAT' , 'ROUND' , 'TRUNCATE' , 'DECIMALPLACES' , 'ANYFLOAT' , 'ANYFLOATEX' , 'EXPAND' , 'EXPANDP' , 'SIMPLIFY' , 'DIVTHRU' , 'FACTOR' , 'FACTORP' , 'DIFF' , 'INT' , 'RAND' , 'PLOT' , 'PLOT_IMPLICIT' , 'STACK_VALIDATE_TYPELESS' , 'STACK_VALIDATE' , 'ALPHA' , 'NU' , 'BETA' , 'XI' , 'GAMMA' , 'OMICRON' , 'DELTA' , 'PI' , 'EPSILON' , 'RHO' , 'ZETA' , 'SIGMA' , 'ETA' , 'TAU' , 'THETA' , 'UPSILON' , 'IOTA' , 'PHI' , 'KAPPA' , 'CHI' , 'LAMBDA' , 'PSI' , 'MU' , 'OMEGA' );
    ...
    private function validate() {
        ...
        if ($inline !== true) { //check_bookends does not return false
            $this->valid = false;
            if ($inline == 'left') {
                $this->add_error(stack_string('stackCas_missingLeftBracket', array('bracket'=>'(', 'cmd' => stack_maxima_format_casstring($cmd))));
            } else {
                $this->add_error(stack_string('stackCas_missingRightBracket', array('bracket'=>')', 'cmd' => stack_maxima_format_casstring($cmd))));
            }
        }
        $inline = stack_utils::check_bookends($cmd, '{', '}');
        if ($inline !== true) { //check_bookends does not return false
    ...
    private function check_stars() {
        ...
        foreach ($patterns as $pat) {
            if (preg_match($pat, $cmd)) {
                ...
                if ($this->syntax == true) {
                    //flag up the error
                    $missingstring = stack_maxima_format_casstring(preg_replace($pat, "\${1}<font color=\"red\">*</font>\${2}", $cmd));
                }
            }
        }
            ...
            if (in_array($key, self::$globalforbid)) {
                ...
                if ($this->security == 't') {
                    if (in_array($key, self::$teachernotallow)) {
                        ...
                        $this->valid = false;
                        $this->add_error(stack_string('stackCas_unsupportedKeyword', array('forbid'=>stack_maxima_format_casstring($key))));
                    }
                } else {
                    //if not teacher allow only set commands.
                    if (!in_array($key, self::$studentallow)) {
                        $this->valid = false;
                        $this->add_error(stack_string('stackCas_unknownFunction', array('forbid'=>stack_maxima_format_casstring($key))));
                    }
