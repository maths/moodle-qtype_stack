...
stack_cas_castext2_iframe::register_counter('///ADAPT_COUNT///');
 ...
 * match.
 */
class stack_cas_castext2_adaptautoneu extends stack_cas_castext2_block {
    ...
    public function compile($format, $options): ?MP_Node {
        ...
        $body->items[] = new MP_List([
            ...
            new MP_String(json_encode(['hidden' => true,
                'title' => 'Logic container for a revealing portion ///ADAPT_COUNT///.'])),
            new MP_List([
