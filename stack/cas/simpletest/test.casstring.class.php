...
{	#~	Code							
    ...
    */
    public function testGet_valid($s,$st,$te) 
    {
		...
		$this->assertEquals($te,$at2->Get_valid(),$s);
    ...
    */
	...
	$this->assertEquals($s,$at1->Get_rawCASString());    //Note the difference between the two!
	$this->assertEquals($val,$at1->Get_CASString(),$s);
    }
