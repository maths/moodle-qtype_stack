...
fs.readFile('bottom-up-grammar-Root.json', 'utf8', function(err, data) {
	...
	fs.writeFile('numbered-grammar-Root.json', JSON.stringify(rules, null, 2), (err) => {});
	...
	fs.writeFile('lalr-Root.json', JSON.stringify({'table': table, 'goto': gotot, 'dict': targets}), (err) => {});
