...
class MP_Parser {
    ...
    private function peg_parseUnaryOp() {
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s0 === $this->peg_FAILED) {
          $s0 = $this->peg_currPos;
          if ($this->input_substr($this->peg_currPos, 7) === $this->peg_c175) {
            $s1 = $this->peg_c175;
            $this->peg_currPos += 7;
          } else {
            $s1 = $this->peg_FAILED;
          ...
          if ($s0 === $this->peg_FAILED) {
            $s0 = $this->peg_currPos;
            if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c177) {
              $s1 = $this->peg_c177;
              $this->peg_currPos += 3;
            } else {
              $s1 = $this->peg_FAILED;
    ...
    private function peg_parse_() {
      ...
      $s0 = $this->peg_currPos;
      $s1 = array();
      if (peg_regex_test($this->peg_c190, $this->input_substr($this->peg_currPos, 1))) {
        $s2 = $this->input_substr($this->peg_currPos, 1);
        $this->peg_currPos++;
      } else {
        $s2 = $this->peg_FAILED;
  ...
  public function parse($input) {
    ...
    $this->peg_c175 = "nounnot";
    $this->peg_c176 = array( "type" => "literal", "value" => "nounnot", "description" => "\"nounnot\"" );
    $this->peg_c177 = "not";
    $this->peg_c178 = array( "type" => "literal", "value" => "not", "description" => "\"not\"" );
    $this->peg_c179 = "|";
