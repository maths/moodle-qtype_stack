...
class MP_Parser {
                            ...
                            if ($s0 === $this->peg_FAILED) {
                              ...
                              if ($s0 === $this->peg_FAILED) {
                                ...
                                if ($s0 === $this->peg_FAILED) {
                                  ...
                                  if ($s0 === $this->peg_FAILED) {
                                    if ($this->input_substr($this->peg_currPos, 4) === $this->peg_c143) {
                                      $s0 = $this->peg_c143;
                                      $this->peg_currPos += 4;
                                    } else {
                                      $s0 = $this->peg_FAILED;
                                    ...
                                    if ($s0 === $this->peg_FAILED) {
                                      ...
                                      if ($s0 === $this->peg_FAILED) {
                                        if ($this->input_substr($this->peg_currPos, 7) === $this->peg_c147) {
                                          $s0 = $this->peg_c147;
                                          $this->peg_currPos += 7;
                                        } else {
                                          $s0 = $this->peg_FAILED;
                                                            ...
                                                            if ($s0 === $this->peg_FAILED) {
                                                              ...
                                                              if ($s0 === $this->peg_FAILED) {
                                                                ...
                                                                if ($s0 === $this->peg_FAILED) {
                                                                  ...
                                                                  if ($s0 === $this->peg_FAILED) {
                                                                    if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c171) {
                                                                      $s0 = $this->peg_c171;
                                                                      $this->peg_currPos += 6;
                                                                    } else {
                                                                      $s0 = $this->peg_FAILED;
    ...
    private function peg_parseUnaryOp() {
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s0 === $this->peg_FAILED) {
          $s0 = $this->peg_currPos;
          if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c175) {
            $s1 = $this->peg_c175;
            $this->peg_currPos += 3;
          } else {
            $s1 = $this->peg_FAILED;
    ...
    private function peg_parse_() {
      ...
      $s0 = $this->peg_currPos;
      $s1 = array();
      if (peg_regex_test($this->peg_c188, $this->input_substr($this->peg_currPos, 1))) {
        $s2 = $this->input_substr($this->peg_currPos, 1);
        $this->peg_currPos++;
      } else {
        $s2 = $this->peg_FAILED;
        if ($this->peg_silentFails === 0) {
            $this->peg_fail($this->peg_c189);
        }
      }
      while ($s2 !== $this->peg_FAILED) {
        $s1[] = $s2;
    ...
    private function peg_parseULetter() {
      ...
      $this->peg_silentFails++;
      if (peg_regex_test($this->peg_c191, $this->input_substr($this->peg_currPos, 1))) {
        $s0 = $this->input_substr($this->peg_currPos, 1);
        $this->peg_currPos++;
      } else {
        $s0 = $this->peg_FAILED;
      ...
      if ($s0 === $this->peg_FAILED) {
        if (peg_regex_test($this->peg_c193, $this->input_substr($this->peg_currPos, 1))) {
          $s0 = $this->input_substr($this->peg_currPos, 1);
          $this->peg_currPos++;
        } else {
          $s0 = $this->peg_FAILED;
  ...
  public function parse($input) {
    ...
    $this->peg_c143 = "nand";
    $this->peg_c144 = array( "type" => "literal", "value" => "nand", "description" => "\"nand\"" );
    $this->peg_c145 = "nor";
    $this->peg_c146 = array( "type" => "literal", "value" => "nor", "description" => "\"nor\"" );
    $this->peg_c147 = "implies";
    $this->peg_c148 = array( "type" => "literal", "value" => "implies", "description" => "\"implies\"" );
    $this->peg_c149 = "eq";
    $this->peg_c150 = array( "type" => "literal", "value" => "eq", "description" => "\"eq\"" );
    $this->peg_c151 = "xor";
    ...
    $this->peg_c171 = "@@IS@@";
    $this->peg_c172 = array( "type" => "literal", "value" => "@@IS@@", "description" => "\"@@IS@@\"" );
    $this->peg_c173 = "@@Is@@";
    $this->peg_c174 = array( "type" => "literal", "value" => "@@Is@@", "description" => "\"@@Is@@\"" );
    $this->peg_c175 = "not";
    $this->peg_c176 = array( "type" => "literal", "value" => "not", "description" => "\"not\"" );
    $this->peg_c177 = "|";
