...
class MP_Parser {
  ...
  public function parse($input) {
    ...
    $this->peg_c206 = "/^[²³¹\\x{2070}-\\x{209A}-\\x{209C}\\x{2C7C}\\x{1D62}-\\x{1D6A}]/";
    $this->peg_c207 = array( "type" => "class", "value" => "[²³¹\x{2070}-\x{209A}-\x{209C}\x{2C7C}\x{1D62}-\x{1D6A}]", "description" => "[²³¹\x{2070}-\x{209A}-\x{209C}\x{2C7C}\x{1D62}-\x{1D6A}]" );
