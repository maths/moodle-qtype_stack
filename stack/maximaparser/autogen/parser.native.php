...
class MP_Parser {
    ...
    private function peg_f9($c) { return $c; }
    private function peg_f10() { return "\\"; }
    private function peg_f11() { return '"'; }
    private function peg_f12() { return ''; }
    private function peg_f13($content) {
      $str = "";
      $annotations = array();
    ...
    private function peg_f14($a) { return "*".$a; }
    private function peg_f15($identifiers) {
      $params = array();
    ...
    private function peg_f20($exp, $flags) {
      $r = new MP_Statement($exp,$flags);
      $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
      return $r;
      }
    private function peg_f21($cond0, $branch0, $elifs, $branchn) {
     $conds = array($cond0);
    ...
    private function peg_f22($cond0, $branch0, $elifs) {
     $conds = array($cond0);
     $branches = array($branch0);
     foreach ($elifs as $el) {
      $conds[] = $el[3];
    ...
    private function peg_f23($cond0, $branch0, $branch1) {
     $conds = array($cond0);
    ...
    private function peg_f24($cond0, $branch0) {
     $conds = array($cond0);
     $branches = array($branch0);
     $r = new MP_If($conds,$branches);
     $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
    ...
    private function peg_f25($conf, $body) {
     $r = new MP_Loop($body, $conf);
     $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
     return $r;
     }
    private function peg_f26($mode, $modeparam) {
     $r = new MP_LoopBit($mode, $modeparam);
     $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
     return $r;
     }
    private function peg_f27($op, $trg, $op2) {
    ...
    private function peg_f28($op, $trg) {
      $r = new MP_PrefixOp($op, $trg);
      $r->position = array('start'=>$this->peg_reportedPos, 'end'=>$this->peg_currPos);
      return opBind($r);
      }
    private function peg_f29($trg, $op) {
      $r = new MP_PostfixOp($op, $trg);
      $r->position = array('start'=>$this->peg_reportedPos, 'end'=>$this->peg_currPos);
      return opBind($r);
      }
    private function peg_f30($lhs, $op, $rhs) {
      $r = new MP_Operation($op,$lhs,$rhs);
      $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
      return opBind($r);
      }
    private function peg_f31($lhs, $rhs) {
      $r = new MP_Operation('.',$lhs,$rhs);
      $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
      return opBind($r);
      }
    private function peg_f32($exp, $tail) {
      $items = array($exp);
      foreach ($tail as $el)
       $items[] = $el[3];
    ...
    private function peg_f34($fnc, $args, $indices) {
    ...
    private function peg_f35($fnc, $args) {
    ...
    private function peg_f37($trg, $indices) {
      $v = array();
      foreach ($indices as $ind)
       $v[] = $ind[1];
    ...
    private function peg_f40($exp, $tail) {
      $items = array($exp);
      foreach ($tail as $el)
       $items[] = $el[3];
      $r = new MP_Set($items);
    ...
    private function peg_parseBoolean() {
      ...
      if ($s1 === $this->peg_FAILED) {
        if ($this->input_substr($this->peg_currPos, 5) === $this->peg_c17) {
          $s1 = $this->peg_c17;
          $this->peg_currPos += 5;
        } else {
          $s1 = $this->peg_FAILED;
    ...
    private function peg_parseCommentChars() {
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s1 !== $this->peg_FAILED) {
          if (peg_char_class_test($this->peg_c35, $this->input_substr($this->peg_currPos, 1))) {
            $s2 = $this->input_substr($this->peg_currPos, 1);
            $this->peg_currPos++;
          } else {
            $s2 = $this->peg_FAILED;
    ...
    private function peg_parseAnnotation() {
      ...
      $s0 = $this->peg_currPos;
      if ($this->input_substr($this->peg_currPos, 7) === $this->peg_c37) {
        $s1 = $this->peg_c37;
        $this->peg_currPos += 7;
      } else {
        $s1 = $this->peg_FAILED;
      ...
      if ($s0 === $this->peg_FAILED) {
        $s0 = $this->peg_currPos;
        if ($this->input_substr($this->peg_currPos, 9) === $this->peg_c39) {
          $s1 = $this->peg_c39;
          $this->peg_currPos += 9;
        } else {
          $s1 = $this->peg_FAILED;
        ...
        if ($s1 !== $this->peg_FAILED) {
          ...
          if ($s2 !== $this->peg_FAILED) {
            ...
            if ($s3 !== $this->peg_FAILED) {
              ...
              if ($s4 !== $this->peg_FAILED) {
                if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c41) {
                  $s5 = $this->peg_c41;
                  $this->peg_currPos += 2;
                } else {
                  $s5 = $this->peg_FAILED;
    ...
    private function peg_parseIdentifierStart() {
      ...
      if (peg_char_class_test($this->peg_c48, $this->input_substr($this->peg_currPos, 1))) {
      ...
      if ($s1 !== $this->peg_FAILED) {
        ...
        if ($s2 !== $this->peg_FAILED) {
          ...
          if ($s3 !== $this->peg_FAILED) {
            ...
            if ($s4 !== $this->peg_FAILED) {
              if ($this->input_substr($this->peg_currPos, 4) === $this->peg_c60) {
                $s5 = $this->peg_c60;
                $this->peg_currPos += 4;
              } else {
                $s5 = $this->peg_FAILED;
              ...
              if ($s5 !== $this->peg_FAILED) {
                ...
                if ($s6 !== $this->peg_FAILED) {
                  ...
                  if ($s7 !== $this->peg_FAILED) {
                    ...
                    if ($s10 !== $this->peg_FAILED) {
                      if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c62) {
                        $s11 = $this->peg_c62;
                        $this->peg_currPos += 6;
                      } else {
                        $s11 = $this->peg_FAILED;
    ...
    private function peg_parseLoopBit() {
      ...
      if ($s1 === $this->peg_FAILED) {
        ...
        if ($s1 === $this->peg_FAILED) {
          ...
          if ($s1 === $this->peg_FAILED) {
            ...
            if ($s1 === $this->peg_FAILED) {
              if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c76) {
                $s1 = $this->peg_c76;
                $this->peg_currPos += 2;
              } else {
                $s1 = $this->peg_FAILED;
              ...
              if ($s1 === $this->peg_FAILED) {
                ...
                if ($s1 === $this->peg_FAILED) {
                  if ($this->input_substr($this->peg_currPos, 5) === $this->peg_c80) {
                    $s1 = $this->peg_c80;
                    $this->peg_currPos += 5;
                  } else {
                    $s1 = $this->peg_FAILED;
                  ...
                  if ($s1 === $this->peg_FAILED) {
                    if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c82) {
                      $s1 = $this->peg_c82;
                      $this->peg_currPos += 6;
                    } else {
                      $s1 = $this->peg_FAILED;
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s1 !== $this->peg_FAILED) {
          if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c84) {
            $s2 = $this->peg_c84;
            $this->peg_currPos++;
          } else {
            $s2 = $this->peg_FAILED;
          ...
          if ($s2 !== $this->peg_FAILED) {
            ...
            if ($s3 !== $this->peg_FAILED) {
              ...
              if ($s4 !== $this->peg_FAILED) {
                ...
                if ($s5 !== $this->peg_FAILED) {
                  if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c86) {
                    $s6 = $this->peg_c86;
                    $this->peg_currPos++;
                  } else {
                    $s6 = $this->peg_FAILED;
    ...
    private function peg_parsePrefixOp() {
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s0 === $this->peg_FAILED) {
          if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c92) {
            $s0 = $this->peg_c92;
            $this->peg_currPos += 2;
          } else {
            $s0 = $this->peg_FAILED;
          ...
          if ($s0 === $this->peg_FAILED) {
            ...
            if ($s0 === $this->peg_FAILED) {
              if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c96) {
                $s0 = $this->peg_c96;
                $this->peg_currPos += 3;
              } else {
                $s0 = $this->peg_FAILED;
              ...
              if ($s0 === $this->peg_FAILED) {
                if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c98) {
                  $s0 = $this->peg_c98;
                  $this->peg_currPos += 3;
                } else {
                  $s0 = $this->peg_FAILED;
    ...
    private function peg_parseInfixOp() {
      ...
      if ($s0 === $this->peg_FAILED) {
        if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c110) {
          $s0 = $this->peg_c110;
          $this->peg_currPos += 2;
        } else {
          $s0 = $this->peg_FAILED;
              ...
              if ($s0 === $this->peg_FAILED) {
                ...
                if ($s0 === $this->peg_FAILED) {
                  ...
                  if ($s0 === $this->peg_FAILED) {
                    ...
                    if ($s0 === $this->peg_FAILED) {
                      if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c118) {
                        $s0 = $this->peg_c118;
                        $this->peg_currPos += 3;
                      } else {
                        $s0 = $this->peg_FAILED;
                      ...
                      if ($s0 === $this->peg_FAILED) {
                        ...
                        if ($s0 === $this->peg_FAILED) {
                          if ($this->input_substr($this->peg_currPos, 7) === $this->peg_c122) {
                            $s0 = $this->peg_c122;
                            $this->peg_currPos += 7;
                          } else {
                            $s0 = $this->peg_FAILED;
                          ...
                          if ($s0 === $this->peg_FAILED) {
                            if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c124) {
                              $s0 = $this->peg_c124;
                              $this->peg_currPos += 6;
                            } else {
                              $s0 = $this->peg_FAILED;
                            ...
                            if ($s0 === $this->peg_FAILED) {
                              if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c126) {
                                $s0 = $this->peg_c126;
                                $this->peg_currPos += 3;
                              } else {
                                $s0 = $this->peg_FAILED;
                              ...
                              if ($s0 === $this->peg_FAILED) {
                                if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c128) {
                                  $s0 = $this->peg_c128;
                                  $this->peg_currPos += 2;
                                } else {
                                  $s0 = $this->peg_FAILED;
                                ...
                                if ($s0 === $this->peg_FAILED) {
                                  if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c130) {
                                    $s0 = $this->peg_c130;
                                    $this->peg_currPos += 2;
                                  } else {
                                    $s0 = $this->peg_FAILED;
                                  ...
                                  if ($s0 === $this->peg_FAILED) {
                                    ...
                                    if ($s0 === $this->peg_FAILED) {
                                      ...
                                      if ($s0 === $this->peg_FAILED) {
                                        if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c134) {
                                          $s0 = $this->peg_c134;
                                          $this->peg_currPos++;
                                        } else {
                                          $s0 = $this->peg_FAILED;
    ...
    private function peg_parse_() {
      ...
      $s0 = $this->peg_currPos;
      $s1 = array();
      if (peg_char_class_test($this->peg_c153, $this->input_substr($this->peg_currPos, 1))) {
        $s2 = $this->input_substr($this->peg_currPos, 1);
        $this->peg_currPos++;
      } else {
        $s2 = $this->peg_FAILED;
    ...
    private function peg_parseULetter() {
      ...
      $this->peg_silentFails++;
      if (peg_char_class_test($this->peg_c156, $this->input_substr($this->peg_currPos, 1))) {
        $s0 = $this->input_substr($this->peg_currPos, 1);
        $this->peg_currPos++;
      } else {
        $s0 = $this->peg_FAILED;
      ...
      if ($s0 === $this->peg_FAILED) {
        if (peg_char_class_test($this->peg_c158, $this->input_substr($this->peg_currPos, 1))) {
          $s0 = $this->input_substr($this->peg_currPos, 1);
          $this->peg_currPos++;
        } else {
          $s0 = $this->peg_FAILED;
        ...
        if ($s0 === $this->peg_FAILED) {
          if (peg_char_class_test($this->peg_c160, $this->input_substr($this->peg_currPos, 1))) {
            $s0 = $this->input_substr($this->peg_currPos, 1);
            $this->peg_currPos++;
          } else {
            $s0 = $this->peg_FAILED;
  ...
  public function parse($input) {
    ...
    $this->peg_c2 = array("type" => "other", "description" => "integer" );
    $this->peg_c3 = array(array(48,57));
    $this->peg_c4 = array( "type" => "class", "value" => "[0-9]", "description" => "[0-9]" );
    $this->peg_c5 = array("type" => "other", "description" => "float" );
    $this->peg_c6 = ".";
    $this->peg_c7 = array( "type" => "literal", "value" => ".", "description" => "\".\"" );
    $this->peg_c8 = "e";
    $this->peg_c9 = array( "type" => "literal", "value" => "e", "description" => "\"e\"" );
    $this->peg_c10 = "E";
    $this->peg_c11 = array( "type" => "literal", "value" => "E", "description" => "\"E\"" );
    $this->peg_c12 = array(array(43,43), array(45,45));
    $this->peg_c13 = array( "type" => "class", "value" => "[+-]", "description" => "[+-]" );
    $this->peg_c14 = array("type" => "other", "description" => "boolean" );
    $this->peg_c15 = "true";
    $this->peg_c16 = array( "type" => "literal", "value" => "true", "description" => "\"true\"" );
    $this->peg_c17 = "false";
    $this->peg_c18 = array( "type" => "literal", "value" => "false", "description" => "\"false\"" );
    $this->peg_c19 = array("type" => "other", "description" => "string" );
    $this->peg_c20 = "\"";
    $this->peg_c21 = array( "type" => "literal", "value" => "\"", "description" => "\"\\\"\"" );
    $this->peg_c22 = "\\";
    $this->peg_c23 = array( "type" => "literal", "value" => "\\", "description" => "\"\\\\\"" );
    $this->peg_c24 = array("type" => "any", "description" => "any character" );
    $this->peg_c25 = "\\\\";
    ...
    $this->peg_c35 = array(array(47,47));
    $this->peg_c36 = array( "type" => "class", "value" => "[/]", "description" => "[/]" );
    $this->peg_c37 = "@ignore";
    $this->peg_c38 = array( "type" => "literal", "value" => "@ignore", "description" => "\"@ignore\"" );
    $this->peg_c39 = "@function";
    $this->peg_c40 = array( "type" => "literal", "value" => "@function", "description" => "\"@function\"" );
    $this->peg_c41 = "=>";
    $this->peg_c42 = array( "type" => "literal", "value" => "=>", "description" => "\"=>\"" );
    $this->peg_c43 = "@assume";
    $this->peg_c44 = array( "type" => "literal", "value" => "@assume", "description" => "\"@assume\"" );
    $this->peg_c45 = "=";
    $this->peg_c46 = array( "type" => "literal", "value" => "=", "description" => "\"=\"" );
    $this->peg_c47 = array("type" => "other", "description" => "identifier" );
    $this->peg_c48 = array(array(97,122), array(65,90));
    $this->peg_c49 = array( "type" => "class", "value" => "[a-zA-Z]", "description" => "[a-zA-Z]" );
    $this->peg_c50 = "_";
    $this->peg_c51 = array( "type" => "literal", "value" => "_", "description" => "\"_\"" );
    $this->peg_c52 = "%";
    ...
    $this->peg_c58 = "if";
    $this->peg_c59 = array( "type" => "literal", "value" => "if", "description" => "\"if\"" );
    $this->peg_c60 = "then";
    $this->peg_c61 = array( "type" => "literal", "value" => "then", "description" => "\"then\"" );
    $this->peg_c62 = "elseif";
    $this->peg_c63 = array( "type" => "literal", "value" => "elseif", "description" => "\"elseif\"" );
    $this->peg_c64 = "else";
    $this->peg_c65 = array( "type" => "literal", "value" => "else", "description" => "\"else\"" );
    $this->peg_c66 = "do";
    $this->peg_c67 = array( "type" => "literal", "value" => "do", "description" => "\"do\"" );
    $this->peg_c68 = "for";
    $this->peg_c69 = array( "type" => "literal", "value" => "for", "description" => "\"for\"" );
    $this->peg_c70 = "from";
    $this->peg_c71 = array( "type" => "literal", "value" => "from", "description" => "\"from\"" );
    $this->peg_c72 = "step";
    $this->peg_c73 = array( "type" => "literal", "value" => "step", "description" => "\"step\"" );
    $this->peg_c74 = "next";
    $this->peg_c75 = array( "type" => "literal", "value" => "next", "description" => "\"next\"" );
    $this->peg_c76 = "in";
    $this->peg_c77 = array( "type" => "literal", "value" => "in", "description" => "\"in\"" );
    $this->peg_c78 = "thru";
    $this->peg_c79 = array( "type" => "literal", "value" => "thru", "description" => "\"thru\"" );
    $this->peg_c80 = "while";
    $this->peg_c81 = array( "type" => "literal", "value" => "while", "description" => "\"while\"" );
    $this->peg_c82 = "unless";
    $this->peg_c83 = array( "type" => "literal", "value" => "unless", "description" => "\"unless\"" );
    $this->peg_c84 = "(";
    ...
    $this->peg_c96 = "not";
    $this->peg_c97 = array( "type" => "literal", "value" => "not", "description" => "\"not\"" );
    $this->peg_c98 = "?? ";
    ...
    $this->peg_c118 = "and";
    $this->peg_c119 = array( "type" => "literal", "value" => "and", "description" => "\"and\"" );
    $this->peg_c120 = "or";
    $this->peg_c121 = array( "type" => "literal", "value" => "or", "description" => "\"or\"" );
    $this->peg_c122 = "nounand";
    $this->peg_c123 = array( "type" => "literal", "value" => "nounand", "description" => "\"nounand\"" );
    $this->peg_c124 = "nounor";
    $this->peg_c125 = array( "type" => "literal", "value" => "nounor", "description" => "\"nounor\"" );
    $this->peg_c126 = "::=";
    $this->peg_c127 = array( "type" => "literal", "value" => "::=", "description" => "\"::=\"" );
    $this->peg_c128 = ":=";
