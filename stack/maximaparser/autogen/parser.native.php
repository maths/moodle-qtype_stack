...
class MP_Parser {
    ...
    private function peg_f4($da, $db) {
      $r = new MP_Float(floatval(join("",$da).$db), join("",$da).$db);
      $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
      return $r;
      }
    private function peg_f5($a, $b, $c) {
        return $a . $b . join('',$c);
      }
    ...
    private function peg_f13($a) { return "*".$a; }
    private function peg_f14($identifiers) {
      $params = array();
    ...
    private function peg_f15($func, $result) {
      $params = array($func,$result);
      $r = new MP_Annotation('function', $params);
      $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
      return $r;
      }
    private function peg_f16($char, $morechars) {
      $r = new MP_Identifier($char.join("",$morechars));
      $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
      return $r;
      }
    private function peg_f17($id, $val) {
    ...
    private function peg_f18($exp, $flags) {
      $r = new MP_Statement($exp,$flags);
      $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
      return $r;
      }
    private function peg_f19($cond0, $branch0, $elifs, $branchn) {
     $conds = array($cond0);
    ...
    private function peg_f20($cond0, $branch0, $elifs) {
     $conds = array($cond0);
     $branches = array($branch0);
     foreach ($elifs as $el) {
      $conds[] = $el[3];
    ...
    private function peg_f21($cond0, $branch0, $branch1) {
     $conds = array($cond0);
    ...
    private function peg_f22($cond0, $branch0) {
     $conds = array($cond0);
     $branches = array($branch0);
     $r = new MP_If($conds,$branches);
     $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
    ...
    private function peg_f23($conf, $body) {
     $r = new MP_Loop($body, $conf);
     $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
     return $r;
     }
    private function peg_f24($mode, $modeparam) {
     $r = new MP_LoopBit($mode, $modeparam);
     $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
     return $r;
     }
    private function peg_f25($op, $trg, $op2) {
    ...
    private function peg_f26($op, $trg) {
      $r = new MP_PrefixOp($op, $trg);
      $r->position = array('start'=>$this->peg_reportedPos, 'end'=>$this->peg_currPos);
      return opBind($r);
      }
    private function peg_f27($trg, $op) {
      $r = new MP_PostfixOp($op, $trg);
      $r->position = array('start'=>$this->peg_reportedPos, 'end'=>$this->peg_currPos);
      return opBind($r);
      }
    private function peg_f28($lhs, $op, $rhs) {
      $r = new MP_Operation($op,$lhs,$rhs);
      $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
      return opBind($r);
      }
    private function peg_f29($lhs, $rhs) {
      $r = new MP_Operation('.',$lhs,$rhs);
      $r->position = array('start'=>$this->peg_reportedPos,'end'=>$this->peg_currPos);
      return opBind($r);
      }
    private function peg_f30($exp, $tail) {
      $items = array($exp);
      foreach ($tail as $el)
       $items[] = $el[3];
    ...
    private function peg_f32($fnc, $args, $indices) {
    ...
    private function peg_f33($fnc, $args) {
    ...
    private function peg_f35($trg, $indices) {
      $v = array();
      foreach ($indices as $ind)
       $v[] = $ind[1];
    ...
    private function peg_parseIdentifierStart() {
      ...
      if (peg_char_class_test($this->peg_c44, $this->input_substr($this->peg_currPos, 1))) {
      ...
      if ($s1 !== $this->peg_FAILED) {
        ...
        if ($s2 !== $this->peg_FAILED) {
          ...
          if ($s3 !== $this->peg_FAILED) {
            ...
            if ($s4 !== $this->peg_FAILED) {
              if ($this->input_substr($this->peg_currPos, 4) === $this->peg_c58) {
                $s5 = $this->peg_c58;
                $this->peg_currPos += 4;
              } else {
                $s5 = $this->peg_FAILED;
              ...
              if ($s5 !== $this->peg_FAILED) {
                ...
                if ($s6 !== $this->peg_FAILED) {
                  ...
                  if ($s7 !== $this->peg_FAILED) {
                    ...
                    if ($s10 !== $this->peg_FAILED) {
                      if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c60) {
                        $s11 = $this->peg_c60;
                        $this->peg_currPos += 6;
                      } else {
                        $s11 = $this->peg_FAILED;
                    ...
                    if ($s8 !== $this->peg_FAILED) {
                      ...
                      if ($s9 !== $this->peg_FAILED) {
                        if ($this->input_substr($this->peg_currPos, 4) === $this->peg_c62) {
                          $s10 = $this->peg_c62;
                          $this->peg_currPos += 4;
                        } else {
                          $s10 = $this->peg_FAILED;
    ...
    private function peg_parseLoopBit() {
          ...
          if ($s1 === $this->peg_FAILED) {
            ...
            if ($s1 === $this->peg_FAILED) {
              ...
              if ($s1 === $this->peg_FAILED) {
                ...
                if ($s1 === $this->peg_FAILED) {
                  if ($this->input_substr($this->peg_currPos, 5) === $this->peg_c78) {
                    $s1 = $this->peg_c78;
                    $this->peg_currPos += 5;
                  } else {
                    $s1 = $this->peg_FAILED;
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s1 !== $this->peg_FAILED) {
          if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c82) {
            $s2 = $this->peg_c82;
            $this->peg_currPos++;
          } else {
            $s2 = $this->peg_FAILED;
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s0 === $this->peg_FAILED) {
          ...
          if ($s0 === $this->peg_FAILED) {
            ...
            if ($s0 === $this->peg_FAILED) {
              if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c94) {
                $s0 = $this->peg_c94;
                $this->peg_currPos += 3;
              } else {
                $s0 = $this->peg_FAILED;
              ...
              if ($s0 === $this->peg_FAILED) {
                ...
                if ($s0 === $this->peg_FAILED) {
                  if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c98) {
                    $s0 = $this->peg_c98;
                    $this->peg_currPos += 2;
                  } else {
                    $s0 = $this->peg_FAILED;
                  ...
                  if ($s0 === $this->peg_FAILED) {
                    if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c100) {
                      $s0 = $this->peg_c100;
                      $this->peg_currPos++;
                    } else {
                      $s0 = $this->peg_FAILED;
    ...
    private function peg_parsePostfixOp() {
      ...
      if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c102) {
        $s0 = $this->peg_c102;
        $this->peg_currPos += 2;
      } else {
        $s0 = $this->peg_FAILED;
              ...
              if ($s0 === $this->peg_FAILED) {
                ...
                if ($s0 === $this->peg_FAILED) {
                  ...
                  if ($s0 === $this->peg_FAILED) {
                    ...
                    if ($s0 === $this->peg_FAILED) {
                      if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c116) {
                        $s0 = $this->peg_c116;
                        $this->peg_currPos += 3;
                      } else {
                        $s0 = $this->peg_FAILED;
                      ...
                      if ($s0 === $this->peg_FAILED) {
                        ...
                        if ($s0 === $this->peg_FAILED) {
                          if ($this->input_substr($this->peg_currPos, 7) === $this->peg_c120) {
                            $s0 = $this->peg_c120;
                            $this->peg_currPos += 7;
                          } else {
                            $s0 = $this->peg_FAILED;
                          ...
                          if ($s0 === $this->peg_FAILED) {
                            if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c122) {
                              $s0 = $this->peg_c122;
                              $this->peg_currPos += 6;
                            } else {
                              $s0 = $this->peg_FAILED;
                                ...
                                if ($s0 === $this->peg_FAILED) {
                                  ...
                                  if ($s0 === $this->peg_FAILED) {
                                    ...
                                    if ($s0 === $this->peg_FAILED) {
                                      ...
                                      if ($s0 === $this->peg_FAILED) {
                                        if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c132) {
                                          $s0 = $this->peg_c132;
                                          $this->peg_currPos++;
                                        } else {
                                          $s0 = $this->peg_FAILED;
                                        ...
                                        if ($s0 === $this->peg_FAILED) {
                                          ...
                                          if ($s0 === $this->peg_FAILED) {
                                            if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c136) {
                                              $s0 = $this->peg_c136;
                                              $this->peg_currPos++;
                                            } else {
                                              $s0 = $this->peg_FAILED;
    ...
    private function peg_parse_() {
      ...
      $s0 = $this->peg_currPos;
      $s1 = array();
      if (peg_char_class_test($this->peg_c151, $this->input_substr($this->peg_currPos, 1))) {
        $s2 = $this->input_substr($this->peg_currPos, 1);
        $this->peg_currPos++;
      } else {
        $s2 = $this->peg_FAILED;
    ...
    private function peg_parseULetter() {
      ...
      $this->peg_silentFails++;
      if (peg_char_class_test($this->peg_c154, $this->input_substr($this->peg_currPos, 1))) {
        $s0 = $this->input_substr($this->peg_currPos, 1);
        $this->peg_currPos++;
      } else {
        $s0 = $this->peg_FAILED;
  ...
  public function parse($input) {
    ...
    $this->peg_c43 = array("type" => "other", "description" => "identifier" );
    $this->peg_c44 = array(array(97,122), array(65,90));
    $this->peg_c45 = array( "type" => "class", "value" => "[a-zA-Z]", "description" => "[a-zA-Z]" );
    $this->peg_c46 = "_";
    $this->peg_c47 = array( "type" => "literal", "value" => "_", "description" => "\"_\"" );
    $this->peg_c48 = "%";
    ...
    $this->peg_c56 = "if";
    $this->peg_c57 = array( "type" => "literal", "value" => "if", "description" => "\"if\"" );
    $this->peg_c58 = "then";
    $this->peg_c59 = array( "type" => "literal", "value" => "then", "description" => "\"then\"" );
    $this->peg_c60 = "elseif";
    $this->peg_c61 = array( "type" => "literal", "value" => "elseif", "description" => "\"elseif\"" );
    $this->peg_c62 = "else";
    $this->peg_c63 = array( "type" => "literal", "value" => "else", "description" => "\"else\"" );
    $this->peg_c64 = "do";
    $this->peg_c65 = array( "type" => "literal", "value" => "do", "description" => "\"do\"" );
    $this->peg_c66 = "for";
    $this->peg_c67 = array( "type" => "literal", "value" => "for", "description" => "\"for\"" );
    $this->peg_c68 = "from";
    $this->peg_c69 = array( "type" => "literal", "value" => "from", "description" => "\"from\"" );
    $this->peg_c70 = "step";
    $this->peg_c71 = array( "type" => "literal", "value" => "step", "description" => "\"step\"" );
    $this->peg_c72 = "next";
    $this->peg_c73 = array( "type" => "literal", "value" => "next", "description" => "\"next\"" );
    $this->peg_c74 = "in";
    $this->peg_c75 = array( "type" => "literal", "value" => "in", "description" => "\"in\"" );
    $this->peg_c76 = "thru";
    $this->peg_c77 = array( "type" => "literal", "value" => "thru", "description" => "\"thru\"" );
    $this->peg_c78 = "while";
    $this->peg_c79 = array( "type" => "literal", "value" => "while", "description" => "\"while\"" );
    $this->peg_c80 = "unless";
    $this->peg_c81 = array( "type" => "literal", "value" => "unless", "description" => "\"unless\"" );
    $this->peg_c82 = "(";
    ...
    $this->peg_c94 = "not";
    $this->peg_c95 = array( "type" => "literal", "value" => "not", "description" => "\"not\"" );
    $this->peg_c96 = "?? ";
    ...
    $this->peg_c116 = "and";
    $this->peg_c117 = array( "type" => "literal", "value" => "and", "description" => "\"and\"" );
    $this->peg_c118 = "or";
    $this->peg_c119 = array( "type" => "literal", "value" => "or", "description" => "\"or\"" );
    $this->peg_c120 = "nounand";
    $this->peg_c121 = array( "type" => "literal", "value" => "nounand", "description" => "\"nounand\"" );
    $this->peg_c122 = "nounor";
    $this->peg_c123 = array( "type" => "literal", "value" => "nounor", "description" => "\"nounor\"" );
    $this->peg_c124 = "::=";
