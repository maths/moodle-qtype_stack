...
class MP_Parser {
              ...
              if ($s0 === $this->peg_FAILED) {
                ...
                if ($s0 === $this->peg_FAILED) {
                  ...
                  if ($s0 === $this->peg_FAILED) {
                    ...
                    if ($s0 === $this->peg_FAILED) {
                      if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c127) {
                        $s0 = $this->peg_c127;
                        $this->peg_currPos += 3;
                      } else {
                        $s0 = $this->peg_FAILED;
                      ...
                      if ($s0 === $this->peg_FAILED) {
                        ...
                        if ($s0 === $this->peg_FAILED) {
                          if ($this->input_substr($this->peg_currPos, 7) === $this->peg_c131) {
                            $s0 = $this->peg_c131;
                            $this->peg_currPos += 7;
                          } else {
                            $s0 = $this->peg_FAILED;
                          ...
                          if ($s0 === $this->peg_FAILED) {
                            if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c133) {
                              $s0 = $this->peg_c133;
                              $this->peg_currPos += 6;
                            } else {
                              $s0 = $this->peg_FAILED;
                                          ...
                                          if ($s0 === $this->peg_FAILED) {
                                            ...
                                            if ($s0 === $this->peg_FAILED) {
                                              ...
                                              if ($s0 === $this->peg_FAILED) {
                                                ...
                                                if ($s0 === $this->peg_FAILED) {
                                                  if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c151) {
                                                    $s0 = $this->peg_c151;
                                                    $this->peg_currPos += 6;
                                                  } else {
                                                    $s0 = $this->peg_FAILED;
    ...
    private function peg_parseULetter() {
      ...
      $this->peg_silentFails++;
      if (peg_char_class_test($this->peg_c171, $this->input_substr($this->peg_currPos, 1))) {
        $s0 = $this->input_substr($this->peg_currPos, 1);
        $this->peg_currPos++;
      } else {
        $s0 = $this->peg_FAILED;
      ...
      if ($s0 === $this->peg_FAILED) {
        if (peg_char_class_test($this->peg_c173, $this->input_substr($this->peg_currPos, 1))) {
          $s0 = $this->input_substr($this->peg_currPos, 1);
          $this->peg_currPos++;
        } else {
          $s0 = $this->peg_FAILED;
  ...
  public function parse($input) {
    ...
    $this->peg_c127 = "and";
    $this->peg_c128 = array( "type" => "literal", "value" => "and", "description" => "\"and\"" );
    $this->peg_c129 = "or";
    $this->peg_c130 = array( "type" => "literal", "value" => "or", "description" => "\"or\"" );
    $this->peg_c131 = "nounand";
    $this->peg_c132 = array( "type" => "literal", "value" => "nounand", "description" => "\"nounand\"" );
    $this->peg_c133 = "nounor";
    $this->peg_c134 = array( "type" => "literal", "value" => "nounor", "description" => "\"nounor\"" );
    $this->peg_c135 = "::=";
    ...
    $this->peg_c151 = "@@IS@@";
    $this->peg_c152 = array( "type" => "literal", "value" => "@@IS@@", "description" => "\"@@IS@@\"" );
    $this->peg_c153 = "@@Is@@";
    $this->peg_c154 = array( "type" => "literal", "value" => "@@Is@@", "description" => "\"@@Is@@\"" );
    $this->peg_c155 = "not";
    $this->peg_c156 = array( "type" => "literal", "value" => "not", "description" => "\"not\"" );
    $this->peg_c157 = "|";
