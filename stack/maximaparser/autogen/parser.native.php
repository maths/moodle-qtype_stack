...
class MP_Parser {
    ...
    private function peg_f36($op, $trg, $op2) {
    ...
    private function peg_f37($op, $trg) {
      $r = new MP_PrefixOp($op, $trg);
      $r->position = array('start'=>$this->peg_reportedPos, 'end'=>$this->peg_currPos);
      return opBind($r);
      }
    private function peg_f38($trg) {
      $r = new MP_PrefixOp("not ", $trg);
      $r->position = array('start'=>$this->peg_reportedPos, 'end'=>$this->peg_currPos);
      return opBind($r);
      }
    private function peg_f39($trg, $op) {
    ...
    private function peg_f41($lhs, $rhs) {
    ...
    private function peg_f44($fnc, $args, $indices) {
    ...
    private function peg_f45($fnc, $args) {
    ...
    private function peg_f47($trg, $indices) {
      $v = array();
      foreach ($indices as $ind)
       $v[] = $ind[1];
    ...
    private function peg_f48($exp, $tail) {
      $items = array($exp);
      foreach ($tail as $el)
       $items[] = $el[3];
      $r = new MP_List($items);
            ...
            if ($s0 === $this->peg_FAILED) {
              ...
              if ($s0 === $this->peg_FAILED) {
                ...
                if ($s0 === $this->peg_FAILED) {
                  ...
                  if ($s0 === $this->peg_FAILED) {
                    if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c113) {
                      $s0 = $this->peg_c113;
                      $this->peg_currPos += 3;
                    } else {
                      $s0 = $this->peg_FAILED;
                    ...
                    if ($s0 === $this->peg_FAILED) {
                      if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c115) {
                        $s0 = $this->peg_c115;
                        $this->peg_currPos += 2;
                      } else {
                        $s0 = $this->peg_FAILED;
                      ...
                      if ($s0 === $this->peg_FAILED) {
                        if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c117) {
                          $s0 = $this->peg_c117;
                          $this->peg_currPos++;
                        } else {
                          $s0 = $this->peg_FAILED;
    ...
    private function peg_parseInfixBase() {

      $key    = $this->peg_currPos * 40 + 26;
          $cached = isset($this->peg_cache[$key]) ? $this->peg_cache[$key] : null;
                ...
                if ($s0 === $this->peg_FAILED) {
                  ...
                  if ($s0 === $this->peg_FAILED) {
                    ...
                    if ($s0 === $this->peg_FAILED) {
                      ...
                      if ($s0 === $this->peg_FAILED) {
                        if ($this->input_substr($this->peg_currPos, 7) === $this->peg_c133) {
                          $s0 = $this->peg_c133;
                          $this->peg_currPos += 7;
                        } else {
                          $s0 = $this->peg_FAILED;
                        ...
                        if ($s0 === $this->peg_FAILED) {
                          if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c135) {
                            $s0 = $this->peg_c135;
                            $this->peg_currPos += 6;
                          } else {
                            $s0 = $this->peg_FAILED;
                          ...
                          if ($s0 === $this->peg_FAILED) {
                            if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c137) {
                              $s0 = $this->peg_c137;
                              $this->peg_currPos++;
                            } else {
                              $s0 = $this->peg_FAILED;
                                          ...
                                          if ($s0 === $this->peg_FAILED) {
                                            ...
                                            if ($s0 === $this->peg_FAILED) {
                                              ...
                                              if ($s0 === $this->peg_FAILED) {
                                                ...
                                                if ($s0 === $this->peg_FAILED) {
                                                  if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c155) {
                                                    $s0 = $this->peg_c155;
                                                    $this->peg_currPos += 6;
                                                  } else {
                                                    $s0 = $this->peg_FAILED;
    ...
    private function peg_parseList() {
      ...
      $s0 = $this->peg_currPos;
      if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c163) {
        $s1 = $this->peg_c163;
        $this->peg_currPos++;
      } else {
        $s1 = $this->peg_FAILED;
    ...
    private function peg_parseULetter() {
      ...
      $this->peg_silentFails++;
      if (peg_char_class_test($this->peg_c175, $this->input_substr($this->peg_currPos, 1))) {
        $s0 = $this->input_substr($this->peg_currPos, 1);
        $this->peg_currPos++;
      } else {
        $s0 = $this->peg_FAILED;
      ...
      if ($s0 === $this->peg_FAILED) {
        if (peg_char_class_test($this->peg_c177, $this->input_substr($this->peg_currPos, 1))) {
          $s0 = $this->input_substr($this->peg_currPos, 1);
          $this->peg_currPos++;
        } else {
          $s0 = $this->peg_FAILED;
        ...
        if ($s0 === $this->peg_FAILED) {
          if (peg_char_class_test($this->peg_c179, $this->input_substr($this->peg_currPos, 1))) {
            $s0 = $this->input_substr($this->peg_currPos, 1);
            $this->peg_currPos++;
          } else {
            $s0 = $this->peg_FAILED;
  ...
  public function parse($input) {
    ...
    $this->peg_c129 = "and";
    $this->peg_c130 = array( "type" => "literal", "value" => "and", "description" => "\"and\"" );
    $this->peg_c131 = "or";
    $this->peg_c132 = array( "type" => "literal", "value" => "or", "description" => "\"or\"" );
    $this->peg_c133 = "nounand";
    $this->peg_c134 = array( "type" => "literal", "value" => "nounand", "description" => "\"nounand\"" );
    $this->peg_c135 = "nounor";
    $this->peg_c136 = array( "type" => "literal", "value" => "nounor", "description" => "\"nounor\"" );
    $this->peg_c137 = "#";
    ...
    $this->peg_c155 = "@@IS@@";
    $this->peg_c156 = array( "type" => "literal", "value" => "@@IS@@", "description" => "\"@@IS@@\"" );
    $this->peg_c157 = "@@Is@@";
    $this->peg_c158 = array( "type" => "literal", "value" => "@@Is@@", "description" => "\"@@Is@@\"" );
    $this->peg_c159 = "not";
    $this->peg_c160 = array( "type" => "literal", "value" => "not", "description" => "\"not\"" );
    $this->peg_c161 = "|";
