...
class MP_Parser {
    ...
    private function peg_parseInteger() {
      ...
      $s0 = $this->peg_currPos;
      $s1 = array();
      if (peg_char_class_test($this->peg_c7, $this->input_substr($this->peg_currPos, 1))) {
    ...
    private function peg_parseFloatExp() {
      ...
      if ($s1 !== $this->peg_FAILED) {
        if (peg_char_class_test($this->peg_c16, $this->input_substr($this->peg_currPos, 1))) {
          $s2 = $this->input_substr($this->peg_currPos, 1);
          $this->peg_currPos++;
        } else {
          $s2 = $this->peg_FAILED;
    ...
    private function peg_parseBoolean() {
      ...
      $this->peg_silentFails++;
      $s0 = $this->peg_currPos;
      if ($this->input_substr($this->peg_currPos, 4) === $this->peg_c19) {
        $s1 = $this->peg_c19;
        $this->peg_currPos += 4;
      } else {
        $s1 = $this->peg_FAILED;
    ...
    private function peg_parseComment() {
      ...
      if ($s1 !== $this->peg_FAILED) {
        ...
        if ($s2 !== $this->peg_FAILED) {
          if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c35) {
            $s3 = $this->peg_c35;
            $this->peg_currPos += 2;
          } else {
            $s3 = $this->peg_FAILED;
    ...
    private function peg_parseCommentChars() {
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s1 !== $this->peg_FAILED) {
          if (peg_char_class_test($this->peg_c39, $this->input_substr($this->peg_currPos, 1))) {
            $s2 = $this->input_substr($this->peg_currPos, 1);
            $this->peg_currPos++;
          } else {
            $s2 = $this->peg_FAILED;
    ...
    private function peg_parseAnnotation() {
      ...
      $s0 = $this->peg_currPos;
      if ($this->input_substr($this->peg_currPos, 7) === $this->peg_c41) {
        $s1 = $this->peg_c41;
        $this->peg_currPos += 7;
      } else {
        $s1 = $this->peg_FAILED;
      ...
      if ($s0 === $this->peg_FAILED) {
        $s0 = $this->peg_currPos;
        if ($this->input_substr($this->peg_currPos, 9) === $this->peg_c43) {
          $s1 = $this->peg_c43;
          $this->peg_currPos += 9;
        } else {
          $s1 = $this->peg_FAILED;
        ...
        if ($s0 === $this->peg_FAILED) {
          $s0 = $this->peg_currPos;
          if ($this->input_substr($this->peg_currPos, 7) === $this->peg_c47) {
            $s1 = $this->peg_c47;
            $this->peg_currPos += 7;
          } else {
            $s1 = $this->peg_FAILED;
    ...
    private function peg_parseIdentifierStart() {
      ...
      if (peg_char_class_test($this->peg_c50, $this->input_substr($this->peg_currPos, 1))) {
              ...
              if ($s5 !== $this->peg_FAILED) {
                ...
                if ($s6 !== $this->peg_FAILED) {
                  ...
                  if ($s7 !== $this->peg_FAILED) {
                    ...
                    if ($s10 !== $this->peg_FAILED) {
                      if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c64) {
                        $s11 = $this->peg_c64;
                        $this->peg_currPos += 6;
                      } else {
                        $s11 = $this->peg_FAILED;
                    ...
                    if ($s8 !== $this->peg_FAILED) {
                      ...
                      if ($s9 !== $this->peg_FAILED) {
                        if ($this->input_substr($this->peg_currPos, 4) === $this->peg_c66) {
                          $s10 = $this->peg_c66;
                          $this->peg_currPos += 4;
                        } else {
                          $s10 = $this->peg_FAILED;
    ...
    private function peg_parseLoopBit() {
      ...
      $s0 = $this->peg_currPos;
      if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c70) {
        $s1 = $this->peg_c70;
        $this->peg_currPos += 3;
      } else {
        $s1 = $this->peg_FAILED;
          ...
          if ($s1 === $this->peg_FAILED) {
            ...
            if ($s1 === $this->peg_FAILED) {
              ...
              if ($s1 === $this->peg_FAILED) {
                ...
                if ($s1 === $this->peg_FAILED) {
                  if ($this->input_substr($this->peg_currPos, 5) === $this->peg_c82) {
                    $s1 = $this->peg_c82;
                    $this->peg_currPos += 5;
                  } else {
                    $s1 = $this->peg_FAILED;
                  ...
                  if ($s1 === $this->peg_FAILED) {
                    if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c84) {
                      $s1 = $this->peg_c84;
                      $this->peg_currPos += 6;
                    } else {
                      $s1 = $this->peg_FAILED;
    ...
    private function peg_parsePrefixOp() {
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s0 === $this->peg_FAILED) {
          if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c94) {
            $s0 = $this->peg_c94;
            $this->peg_currPos += 2;
          } else {
            $s0 = $this->peg_FAILED;
    ...
    private function peg_parsePostfixOp() {
      ...
      if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c106) {
        $s0 = $this->peg_c106;
        $this->peg_currPos += 2;
      } else {
        $s0 = $this->peg_FAILED;
              ...
              if ($s0 === $this->peg_FAILED) {
                ...
                if ($s0 === $this->peg_FAILED) {
                  ...
                  if ($s0 === $this->peg_FAILED) {
                    ...
                    if ($s0 === $this->peg_FAILED) {
                      if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c120) {
                        $s0 = $this->peg_c120;
                        $this->peg_currPos += 3;
                      } else {
                        $s0 = $this->peg_FAILED;
                      ...
                      if ($s0 === $this->peg_FAILED) {
                        ...
                        if ($s0 === $this->peg_FAILED) {
                          if ($this->input_substr($this->peg_currPos, 7) === $this->peg_c124) {
                            $s0 = $this->peg_c124;
                            $this->peg_currPos += 7;
                          } else {
                            $s0 = $this->peg_FAILED;
                          ...
                          if ($s0 === $this->peg_FAILED) {
                            if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c126) {
                              $s0 = $this->peg_c126;
                              $this->peg_currPos += 6;
                            } else {
                              $s0 = $this->peg_FAILED;
                            ...
                            if ($s0 === $this->peg_FAILED) {
                              if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c128) {
                                $s0 = $this->peg_c128;
                                $this->peg_currPos += 3;
                              } else {
                                $s0 = $this->peg_FAILED;
    ...
    private function peg_parse_() {
      ...
      $s0 = $this->peg_currPos;
      $s1 = array();
      if (peg_char_class_test($this->peg_c155, $this->input_substr($this->peg_currPos, 1))) {
        $s2 = $this->input_substr($this->peg_currPos, 1);
        $this->peg_currPos++;
      } else {
        $s2 = $this->peg_FAILED;
  ...
  public function parse($input) {
    ...
    $this->peg_c7 = array(array(48,57));
    $this->peg_c8 = array( "type" => "class", "value" => "[0-9]", "description" => "[0-9]" );
    $this->peg_c9 = array("type" => "other", "description" => "float" );
    $this->peg_c10 = ".";
    $this->peg_c11 = array( "type" => "literal", "value" => ".", "description" => "\".\"" );
    $this->peg_c12 = "e";
    $this->peg_c13 = array( "type" => "literal", "value" => "e", "description" => "\"e\"" );
    $this->peg_c14 = "E";
    $this->peg_c15 = array( "type" => "literal", "value" => "E", "description" => "\"E\"" );
    $this->peg_c16 = array(array(43,43), array(45,45));
    $this->peg_c17 = array( "type" => "class", "value" => "[+-]", "description" => "[+-]" );
    $this->peg_c18 = array("type" => "other", "description" => "boolean" );
    $this->peg_c19 = "true";
    $this->peg_c20 = array( "type" => "literal", "value" => "true", "description" => "\"true\"" );
    $this->peg_c21 = "false";
    $this->peg_c22 = array( "type" => "literal", "value" => "false", "description" => "\"false\"" );
    $this->peg_c23 = array("type" => "other", "description" => "string" );
    $this->peg_c24 = "\"";
    ...
    $this->peg_c39 = array(array(47,47));
    $this->peg_c40 = array( "type" => "class", "value" => "[/]", "description" => "[/]" );
    $this->peg_c41 = "@ignore";
    $this->peg_c42 = array( "type" => "literal", "value" => "@ignore", "description" => "\"@ignore\"" );
    $this->peg_c43 = "@function";
    $this->peg_c44 = array( "type" => "literal", "value" => "@function", "description" => "\"@function\"" );
    $this->peg_c45 = "=>";
    $this->peg_c46 = array( "type" => "literal", "value" => "=>", "description" => "\"=>\"" );
    $this->peg_c47 = "@assume";
    $this->peg_c48 = array( "type" => "literal", "value" => "@assume", "description" => "\"@assume\"" );
    $this->peg_c49 = array("type" => "other", "description" => "identifier" );
    $this->peg_c50 = array(array(97,122), array(65,90));
    $this->peg_c51 = array( "type" => "class", "value" => "[a-zA-Z]", "description" => "[a-zA-Z]" );
    $this->peg_c52 = "_";
    $this->peg_c53 = array( "type" => "literal", "value" => "_", "description" => "\"_\"" );
    $this->peg_c54 = "%";
    ...
    $this->peg_c60 = "if";
    $this->peg_c61 = array( "type" => "literal", "value" => "if", "description" => "\"if\"" );
    $this->peg_c62 = "then";
    $this->peg_c63 = array( "type" => "literal", "value" => "then", "description" => "\"then\"" );
    $this->peg_c64 = "elseif";
    $this->peg_c65 = array( "type" => "literal", "value" => "elseif", "description" => "\"elseif\"" );
    $this->peg_c66 = "else";
    $this->peg_c67 = array( "type" => "literal", "value" => "else", "description" => "\"else\"" );
    $this->peg_c68 = "do";
    $this->peg_c69 = array( "type" => "literal", "value" => "do", "description" => "\"do\"" );
    $this->peg_c70 = "for";
    $this->peg_c71 = array( "type" => "literal", "value" => "for", "description" => "\"for\"" );
    $this->peg_c72 = "from";
    $this->peg_c73 = array( "type" => "literal", "value" => "from", "description" => "\"from\"" );
    $this->peg_c74 = "step";
    $this->peg_c75 = array( "type" => "literal", "value" => "step", "description" => "\"step\"" );
    $this->peg_c76 = "next";
    $this->peg_c77 = array( "type" => "literal", "value" => "next", "description" => "\"next\"" );
    $this->peg_c78 = "in";
    $this->peg_c79 = array( "type" => "literal", "value" => "in", "description" => "\"in\"" );
    $this->peg_c80 = "thru";
    $this->peg_c81 = array( "type" => "literal", "value" => "thru", "description" => "\"thru\"" );
    $this->peg_c82 = "while";
    $this->peg_c83 = array( "type" => "literal", "value" => "while", "description" => "\"while\"" );
    $this->peg_c84 = "unless";
    $this->peg_c85 = array( "type" => "literal", "value" => "unless", "description" => "\"unless\"" );
    $this->peg_c86 = "(";
    ...
    $this->peg_c98 = "not";
    $this->peg_c99 = array( "type" => "literal", "value" => "not", "description" => "\"not\"" );
    $this->peg_c100 = "?? ";
    ...
    $this->peg_c120 = "and";
    $this->peg_c121 = array( "type" => "literal", "value" => "and", "description" => "\"and\"" );
    $this->peg_c122 = "or";
    $this->peg_c123 = array( "type" => "literal", "value" => "or", "description" => "\"or\"" );
    $this->peg_c124 = "nounand";
    $this->peg_c125 = array( "type" => "literal", "value" => "nounand", "description" => "\"nounand\"" );
    $this->peg_c126 = "nounor";
    $this->peg_c127 = array( "type" => "literal", "value" => "nounor", "description" => "\"nounor\"" );
    $this->peg_c128 = "::=";
