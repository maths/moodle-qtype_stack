...
class MP_Parser {
              ...
              if ($s0 === $this->peg_FAILED) {
                ...
                if ($s0 === $this->peg_FAILED) {
                  ...
                  if ($s0 === $this->peg_FAILED) {
                    ...
                    if ($s0 === $this->peg_FAILED) {
                      if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c110) {
                        $s0 = $this->peg_c110;
                        $this->peg_currPos += 3;
                      } else {
                        $s0 = $this->peg_FAILED;
                      ...
                      if ($s0 === $this->peg_FAILED) {
                        ...
                        if ($s0 === $this->peg_FAILED) {
                          if ($this->input_substr($this->peg_currPos, 7) === $this->peg_c114) {
                            $s0 = $this->peg_c114;
                            $this->peg_currPos += 7;
                          } else {
                            $s0 = $this->peg_FAILED;
                          ...
                          if ($s0 === $this->peg_FAILED) {
                            if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c116) {
                              $s0 = $this->peg_c116;
                              $this->peg_currPos += 6;
                            } else {
                              $s0 = $this->peg_FAILED;
                            ...
                            if ($s0 === $this->peg_FAILED) {
                              ...
                              if ($s0 === $this->peg_FAILED) {
                                ...
                                if ($s0 === $this->peg_FAILED) {
                                  if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c122) {
                                    $s0 = $this->peg_c122;
                                    $this->peg_currPos += 2;
                                  } else {
                                    $s0 = $this->peg_FAILED;
                                  ...
                                  if ($s0 === $this->peg_FAILED) {
                                    ...
                                    if ($s0 === $this->peg_FAILED) {
                                      ...
                                      if ($s0 === $this->peg_FAILED) {
                                        if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c126) {
                                          $s0 = $this->peg_c126;
                                          $this->peg_currPos++;
                                        } else {
                                          $s0 = $this->peg_FAILED;
                                        ...
                                        if ($s0 === $this->peg_FAILED) {
                                          ...
                                          if ($s0 === $this->peg_FAILED) {
                                            if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c130) {
                                              $s0 = $this->peg_c130;
                                              $this->peg_currPos++;
                                            } else {
                                              $s0 = $this->peg_FAILED;
    ...
    private function peg_parseULetter() {
      ...
      $this->peg_silentFails++;
      if (peg_regex_test($this->peg_c148, $this->input_substr($this->peg_currPos, 1))) {
        $s0 = $this->input_substr($this->peg_currPos, 1);
        $this->peg_currPos++;
      } else {
        $s0 = $this->peg_FAILED;
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s0 === $this->peg_FAILED) {
          if (peg_regex_test($this->peg_c152, $this->input_substr($this->peg_currPos, 1))) {
            $s0 = $this->input_substr($this->peg_currPos, 1);
            $this->peg_currPos++;
          } else {
            $s0 = $this->peg_FAILED;
  ...
  public function parse($input) {
    ...
    $this->peg_c110 = "and";
    $this->peg_c111 = array( "type" => "literal", "value" => "and", "description" => "\"and\"" );
    $this->peg_c112 = "or";
    $this->peg_c113 = array( "type" => "literal", "value" => "or", "description" => "\"or\"" );
    $this->peg_c114 = "nounand";
    $this->peg_c115 = array( "type" => "literal", "value" => "nounand", "description" => "\"nounand\"" );
    $this->peg_c116 = "nounor";
    $this->peg_c117 = array( "type" => "literal", "value" => "nounor", "description" => "\"nounor\"" );
    $this->peg_c118 = "::=";
