...
class MP_Parser {
    ...
    private function peg_f33($trg, $indices) {
      $v = array();
      foreach ($indices as $ind)
       $v[] = $ind[1];
    ...
    private function peg_f34($exp, $tail) {
      $items = array($exp);
      foreach ($tail as $el)
       $items[] = $el[3];
      $r = new MP_List($items);
                ...
                if ($s6 !== $this->peg_FAILED) {
                  ...
                  if ($s7 !== $this->peg_FAILED) {
                    ...
                    if ($s8 !== $this->peg_FAILED) {
                      ...
                      if ($s9 !== $this->peg_FAILED) {
                        if ($this->input_substr($this->peg_currPos, 4) === $this->peg_c63) {
                          $s10 = $this->peg_c63;
                          $this->peg_currPos += 4;
                        } else {
                          $s10 = $this->peg_FAILED;
    ...
    private function peg_parseLoop() {
      ...
      if ($s1 !== $this->peg_FAILED) {
        if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c65) {
          $s2 = $this->peg_c65;
          $this->peg_currPos += 2;
        } else {
          $s2 = $this->peg_FAILED;
    ...
    private function peg_parseLoopBit() {
      ...
      $s0 = $this->peg_currPos;
      if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c67) {
        $s1 = $this->peg_c67;
        $this->peg_currPos += 3;
      } else {
        $s1 = $this->peg_FAILED;
      ...
      if ($s1 === $this->peg_FAILED) {
        if ($this->input_substr($this->peg_currPos, 4) === $this->peg_c69) {
          $s1 = $this->peg_c69;
          $this->peg_currPos += 4;
        } else {
          $s1 = $this->peg_FAILED;
          ...
          if ($s1 === $this->peg_FAILED) {
            ...
            if ($s1 === $this->peg_FAILED) {
              ...
              if ($s1 === $this->peg_FAILED) {
                ...
                if ($s1 === $this->peg_FAILED) {
                  if ($this->input_substr($this->peg_currPos, 5) === $this->peg_c79) {
                    $s1 = $this->peg_c79;
                    $this->peg_currPos += 5;
                  } else {
                    $s1 = $this->peg_FAILED;
                  ...
                  if ($s1 === $this->peg_FAILED) {
                    if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c81) {
                      $s1 = $this->peg_c81;
                      $this->peg_currPos += 6;
                    } else {
                      $s1 = $this->peg_FAILED;
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s1 !== $this->peg_FAILED) {
          if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c83) {
            $s2 = $this->peg_c83;
            $this->peg_currPos++;
          } else {
            $s2 = $this->peg_FAILED;
          ...
          if ($s2 !== $this->peg_FAILED) {
            ...
            if ($s3 !== $this->peg_FAILED) {
              ...
              if ($s4 !== $this->peg_FAILED) {
                ...
                if ($s5 !== $this->peg_FAILED) {
                  if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c85) {
                    $s6 = $this->peg_c85;
                    $this->peg_currPos++;
                  } else {
                    $s6 = $this->peg_FAILED;
    ...
    private function peg_parsePrefixOp() {
      ...
      if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c87) {
        $s0 = $this->peg_c87;
        $this->peg_currPos++;
      } else {
        $s0 = $this->peg_FAILED;
      ...
      if ($s0 === $this->peg_FAILED) {
        if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c89) {
          $s0 = $this->peg_c89;
          $this->peg_currPos++;
        } else {
          $s0 = $this->peg_FAILED;
        ...
        if ($s0 === $this->peg_FAILED) {
          ...
          if ($s0 === $this->peg_FAILED) {
            if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c93) {
              $s0 = $this->peg_c93;
              $this->peg_currPos++;
            } else {
              $s0 = $this->peg_FAILED;
            ...
            if ($s0 === $this->peg_FAILED) {
              if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c95) {
                $s0 = $this->peg_c95;
                $this->peg_currPos += 3;
              } else {
                $s0 = $this->peg_FAILED;
    ...
    private function peg_parseInfixOp() {
      ...
      if ($this->input_substr($this->peg_currPos, 1) === $this->peg_c101) {
        $s0 = $this->peg_c101;
        $this->peg_currPos++;
      } else {
        $s0 = $this->peg_FAILED;
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s0 === $this->peg_FAILED) {
          if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c105) {
            $s0 = $this->peg_c105;
            $this->peg_currPos += 2;
          } else {
            $s0 = $this->peg_FAILED;
              ...
              if ($s0 === $this->peg_FAILED) {
                ...
                if ($s0 === $this->peg_FAILED) {
                  ...
                  if ($s0 === $this->peg_FAILED) {
                    ...
                    if ($s0 === $this->peg_FAILED) {
                      if ($this->input_substr($this->peg_currPos, 3) === $this->peg_c111) {
                        $s0 = $this->peg_c111;
                        $this->peg_currPos += 3;
                      } else {
                        $s0 = $this->peg_FAILED;
                      ...
                      if ($s0 === $this->peg_FAILED) {
                        if ($this->input_substr($this->peg_currPos, 2) === $this->peg_c113) {
                          $s0 = $this->peg_c113;
                          $this->peg_currPos += 2;
                        } else {
                          $s0 = $this->peg_FAILED;
                        ...
                        if ($s0 === $this->peg_FAILED) {
                          if ($this->input_substr($this->peg_currPos, 7) === $this->peg_c115) {
                            $s0 = $this->peg_c115;
                            $this->peg_currPos += 7;
                          } else {
                            $s0 = $this->peg_FAILED;
                          ...
                          if ($s0 === $this->peg_FAILED) {
                            if ($this->input_substr($this->peg_currPos, 6) === $this->peg_c117) {
                              $s0 = $this->peg_c117;
                              $this->peg_currPos += 6;
                            } else {
                              $s0 = $this->peg_FAILED;
    ...
    private function peg_parse_() {
      ...
      $this->peg_silentFails++;
      $s0 = array();
      if (peg_regex_test($this->peg_c150, $this->input_substr($this->peg_currPos, 1))) {
    ...
    private function peg_parseULetter() {
      ...
      if ($s0 === $this->peg_FAILED) {
        if (peg_regex_test($this->peg_c155, $this->input_substr($this->peg_currPos, 1))) {
          $s0 = $this->input_substr($this->peg_currPos, 1);
          $this->peg_currPos++;
        } else {
          $s0 = $this->peg_FAILED;
        ...
        if ($s0 === $this->peg_FAILED) {
          ...
          if ($s0 === $this->peg_FAILED) {
            if (peg_regex_test($this->peg_c159, $this->input_substr($this->peg_currPos, 1))) {
              $s0 = $this->input_substr($this->peg_currPos, 1);
              $this->peg_currPos++;
            } else {
              $s0 = $this->peg_FAILED;
            ...
            if ($s0 === $this->peg_FAILED) {
              if (peg_regex_test($this->peg_c161, $this->input_substr($this->peg_currPos, 1))) {
                $s0 = $this->input_substr($this->peg_currPos, 1);
                $this->peg_currPos++;
              } else {
                $s0 = $this->peg_FAILED;
  ...
  public function parse($input) {
    ...
    $this->peg_c56 = array("type" => "other", "description" => "program flow" );
    $this->peg_c57 = "if";
    $this->peg_c58 = array( "type" => "literal", "value" => "if", "description" => "\"if\"" );
    $this->peg_c59 = "then";
    $this->peg_c60 = array( "type" => "literal", "value" => "then", "description" => "\"then\"" );
    $this->peg_c61 = "elseif";
    $this->peg_c62 = array( "type" => "literal", "value" => "elseif", "description" => "\"elseif\"" );
    $this->peg_c63 = "else";
    $this->peg_c64 = array( "type" => "literal", "value" => "else", "description" => "\"else\"" );
    $this->peg_c65 = "do";
    $this->peg_c66 = array( "type" => "literal", "value" => "do", "description" => "\"do\"" );
    $this->peg_c67 = "for";
    $this->peg_c68 = array( "type" => "literal", "value" => "for", "description" => "\"for\"" );
    $this->peg_c69 = "from";
    $this->peg_c70 = array( "type" => "literal", "value" => "from", "description" => "\"from\"" );
    $this->peg_c71 = "step";
    $this->peg_c72 = array( "type" => "literal", "value" => "step", "description" => "\"step\"" );
    $this->peg_c73 = "next";
    $this->peg_c74 = array( "type" => "literal", "value" => "next", "description" => "\"next\"" );
    $this->peg_c75 = "in";
    $this->peg_c76 = array( "type" => "literal", "value" => "in", "description" => "\"in\"" );
    $this->peg_c77 = "thru";
    $this->peg_c78 = array( "type" => "literal", "value" => "thru", "description" => "\"thru\"" );
    $this->peg_c79 = "while";
    $this->peg_c80 = array( "type" => "literal", "value" => "while", "description" => "\"while\"" );
    $this->peg_c81 = "unless";
    $this->peg_c82 = array( "type" => "literal", "value" => "unless", "description" => "\"unless\"" );
    $this->peg_c83 = "(";
    $this->peg_c84 = array( "type" => "literal", "value" => "(", "description" => "\"(\"" );
    $this->peg_c85 = ")";
    $this->peg_c86 = array( "type" => "literal", "value" => ")", "description" => "\")\"" );
    $this->peg_c87 = "-";
    $this->peg_c88 = array( "type" => "literal", "value" => "-", "description" => "\"-\"" );
    $this->peg_c89 = "+";
    $this->peg_c90 = array( "type" => "literal", "value" => "+", "description" => "\"+\"" );
    $this->peg_c91 = "''";
    $this->peg_c92 = array( "type" => "literal", "value" => "''", "description" => "\"''\"" );
    $this->peg_c93 = "'";
    $this->peg_c94 = array( "type" => "literal", "value" => "'", "description" => "\"'\"" );
    $this->peg_c95 = "not";
    $this->peg_c96 = array( "type" => "literal", "value" => "not", "description" => "\"not\"" );
    $this->peg_c97 = "!!";
    ...
    $this->peg_c111 = "and";
    $this->peg_c112 = array( "type" => "literal", "value" => "and", "description" => "\"and\"" );
    $this->peg_c113 = "or";
    $this->peg_c114 = array( "type" => "literal", "value" => "or", "description" => "\"or\"" );
    $this->peg_c115 = "nounand";
    $this->peg_c116 = array( "type" => "literal", "value" => "nounand", "description" => "\"nounand\"" );
    $this->peg_c117 = "nounor";
    $this->peg_c118 = array( "type" => "literal", "value" => "nounor", "description" => "\"nounor\"" );
    $this->peg_c119 = "::=";
