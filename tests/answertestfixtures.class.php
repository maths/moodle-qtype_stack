...
class stack_answertest_test_data {
    ...
    protected static $rawdata = array(
        ...
        array('SingleFrac', 'a+1/2', '(2*a+1)/2', 0, '', ''),
        array('SingleFrac', '4/(x^2+2*x-24)+2/(x^2+4*x-12)', '(6*x-16)/(x^3-28*x+48)', 0, '', ''),
        ...
        array('Int', 'x^3/3', 'x^3/3', 1, '[x,NOCONST]', 'The teacher condones lack of constant, or numerical constant'),
        array('Int', 'x^3/3+c', 'x^3/3', 1, '[x,NOCONST]', ''),
        array('Int', 'x^2/2-2*x+2', '(x-2)^2/2+k', 1, '[x,NOCONST]', ''),
        array('Int', 'x^3/3+1', 'x^3/3', 1, '[x,NOCONST]', ''),
        array('Int', 'x^3/3+c^2', 'x^3/3', 0, '[x,NOCONST]', ''),
        array('Int', 'exp(x)+c', 'exp(x)', 1, 'x', 'Special case'),
        array('Int', 'exp(x)', 'exp(x)', 0, 'x', ''),
        array('Int', 'exp(x)', 'exp(x)', 1, '[x,NOCONST]', ''),
        ...
        array('Int', 'ln(x)', 'ln(x)', 1, '[x,NOCONST]', ''),
        ...
        array('Int', 'ln(x)', 'ln(abs(x))+c', 0, '[x, NOCONST]', ''),
        ...
        array('Int', '((5*%e^7*x-%e^7)*%e^(5*x))', '((5*%e^7*x-%e^7)*%e^(5*x))/25+c', 0, 'x',
        ...
        array('Int', 'log(x-3)/6-log(x+3)/6+c', 'log(x-3)/6-log(x+3)/6', 1, 'x', 'Inverse hyperbolic integrals'),
        array('Int', '-acoth(x/3)/3', 'log(x-3)/6-log(x+3)/6', 0, 'x', ''),
        array('Int', '-acoth(x/3)/3', 'log(x-3)/6-log(x+3)/6', 1, '[x, NOCONST]', ''),
        array('Int', '-acoth(x/3)/3+c', 'log(x-3)/6-log(x+3)/6', 1, 'x', ''),
        array('Int', '-acoth(x/3)/3+c', 'log(abs(x-3))/6-log(abs(x+3))/6', 1, 'x', ''),
        array('Int', 'log(x-a)/(2*a)-log(x+a)/(2*a)+c', 'log(x-a)/(2*a)-log(x+a)/(2*a)', 1, 'x', ''),
        array('Int', '-acoth(x/a)/a+c', 'log(x-a)/(2*a)-log(x+a)/(2*a)', 1, 'x', ''),
        array('Int', '-acoth(x/a)/a+c', 'log(abs(x-a))/(2*a)-log(abs(x+a))/(2*a)', 1, 'x', ''),
        array('Int', 'log(x-a)/(2*a)-log(x+a)/(2*a)+c', 'log(abs(x-a))/(2*a)-log(abs(x+a))/(2*a)', 0, 'x', ''),
        array('Int', 'log(x-3)/6-log(x+3)/6+c', '-acoth(x/3)/3', 1, 'x', ''),
        array('Int', 'log(abs(x-3))/6-log(abs(x+3))/6+c', '-acoth(x/3)/3', 1, 'x', ''),
        array('Int', 'log(x-3)/6-log(x+3)/6', '-acoth(x/3)/3', 0, 'x', ''),
        ...
        array('NumSigFigs', '-3.141', '-3.1415927', 0, '4', 'Negative numbers'),
        array('NumSigFigs', '-3.141', '-3.1415927', 0, '3', ''),
        array('NumSigFigs', '-3.141', '-3.1415927', 0, '4', ''),
        array('NumSigFigs', '-3.142', '-3.1415927', 1, '4', ''),
        ...
        array('Units', '1/0', '1', -1, '0', ''),
        array('Units', '1', '1/0', -1, '0', ''),
        array('Units', '1', '1', -1, '1/0', ''),
        array('Units', 'x-1)^2', '(x-1)^2', -1, '0', ''),
        array('Units', '12.3*m*s^(-1)', '3*m', -1, '[3,x]', ''),
        array('Units', '12.3*m*s^(-1)', '3*m', -1, '[1,2,3]', ''),
        array('Units', '12.3*m*s^(-1)', '{12.3*m*s^(-1)}', -1, '3', ''),
        array('Units', 'x=12.3*m*s^(-1)', '12.3*m*s^(-1)', 0, '3', ''),
        array('Units', '12.3', '12.3*m', 0, '3', 'Missing units'),
        array('Units', '12', '12.3*m', 0, '3', ''),
        array('Units', '1/2', '12.3*m', 0, '3', ''),
        array('Units', 'e^(1/2)', '12.3*m', 0, '3', ''),
        array('Units', '9.81*m', '12.3', -1, '3', ''),
        array('Units', 'm/s', '12.3*m/s', 0, '3', 'Only units'),
        array('Units', 'm', '12.3*m/s', 0, '3', ''),
        array('Units', '9.81+m/s', '9.81*m/s', 0, '3', 'Bad units'),
        array('Units', '12.3*m/s', '12.3*m/s', 1, '3', 'Basic tests'),
        ...
        array('Units', '-9.81*m*s^(-2)', '-9.81*m/s^2', 1, '3', ''),
        array('Units', '-9.81*m/s/s', '-9.81*m/s^2', 1, '3', ''),
        array('Units', '-9.81*m/s', '-9.81*m/s^2', 0, '3', ''),
        array('Units', '-9.81*m/s', '-9.81*m/s^2', 0, '3', ''),
        array('Units', '9.81*m/s', '-9.81*m/s^2', 0, '3', ''),
        array('Units', '8.81*m/s', '-9.81*m/s^2', 0, '3', ''),
        array('Units', '8.1*m/s', '-9.81*m/s^2', 0, '3', ''),
        array('Units', 'm/4', '0.25*m', 1, '3', ''),
        array('Units', 'pi*s', '3.14*s', 0, '3', 'Student is too exact'),
        array('Units', 'sqrt(2)*m', '1.41*m', 0, '3', ''),
        array('Units', '25*g', '0.025*kg', 1, '2', 'Different units'),
        array('Units', '26*g', '0.025*kg', 0, '2', ''),
        array('Units', '100*g', '10*kg', 0, '2', ''),
        array('Units', '0.025*g', '0.025*kg', 0, '2', ''),
        array('Units', '1*Mg/10^6', '1*N*s^2/(km)', 1, '1', ''),
        array('Units', '1*Mg/10^6', '1*kN*ns/(mm*Hz)', 1, '1', ''),
        ...
        array('UnitsStrict', '-9.81*m/s/s', '-9.81*m/s^2', 1, '3', 'We are not *that* strict!'),
