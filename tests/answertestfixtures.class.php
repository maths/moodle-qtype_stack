...
class stack_answertest_test_data {
    ...
    protected static $rawdata = array(
        ...
        array('AlgEquiv', 'rho*z*V/(4*pi*epsilon[0]*(R^2+z^2)^(3/2))', 'rho*z*V/(4*pi*epsilon[0]*(R^2+z^2)^(3/2))', 1, '', 'Expressions with subscripts'),
        ...
        array('AlgEquiv', 'y=(x-a)^59', 'y=(x-a)^60', 0, '', ''),
        array('AlgEquiv', 'y=(a-x)^59', 'y=(x-a)^59', 0, '', ''),
        ...
        array('CasEqual', 'rho*z*V/(4*pi*epsilon[0]*(R^2+z^2)^(3/2))', 'rho*z*V/(4*pi*epsilon[0]*(R^2+z^2)^(3/2))', 1, '', 'Expressions with subscripts'),
