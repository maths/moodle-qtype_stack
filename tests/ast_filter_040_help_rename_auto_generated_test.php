 ...
 * @covers \ast_filter_040_help_rename
 */

class ast_filter_040_help_rename_auto_generated_test extends qtype_stack_ast_testcase {

    public function test_affected_no_units() {
        $this->security = new stack_cas_security(false);
        $this->filter = stack_parsing_rule_factory::get_by_common_name('040_help_rename');
