...
class stack_ast_filter_auto_gen_110_protect_strings_testcase extends qtype_stack_ast_testcase {

    public function test_affected_no_units() {
        $this->security = new stack_cas_security(false);
        $this->filter = stack_parsing_rule_factory::get_by_common_name('110_protect_strings');
