 ...
 * @covers \ast_filter_115_lexer_post_process_stackbasen
 */
final class ast_filter_115_lexer_post_process_stackbasen_auto_generated_test extends qtype_stack_ast_testcase {
    public function test_affected_no_units(): void {
        $this->security = new stack_cas_security(false);
        $this->filter = stack_parsing_rule_factory::get_by_common_name('115_lexer_post_process_stackbasen');
    }
