...
class stack_ast_filter_auto_gen_420_consolidate_subscripts_testcase extends qtype_stack_ast_testcase {
    ...
    public function test_affected_no_units() {
        ...
        $this->expect('M_2*x^2+M_1*x+M_0',
                      'M2*x^2+M1*x+M0',
                      array('consolidate_subscripts', 'consolidate_subscripts', 'consolidate_subscripts'),
                      true, false);
