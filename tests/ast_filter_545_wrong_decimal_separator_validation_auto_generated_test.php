 ...
 * @covers \ast_filter_545_wrong_decimal_separator_validation
 */
final class ast_filter_545_wrong_decimal_separator_validation_auto_generated_test extends qtype_stack_ast_testcase {
    public function test_affected_no_units(): void {
        $this->security = new stack_cas_security(false);
        $this->filter = stack_parsing_rule_factory::get_by_common_name('545_wrong_decimal_separator_validation');

        $this->expect(
            '0..1',
            '0. . 1',
            ['forbiddenCharDecimal'],
            false,
            true
        );
