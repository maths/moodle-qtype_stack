...
// Auto-generated unit tests for AST-filter 998_security
// DO NOT EDIT, THIS IS AUTO-GENERATED

class stack_ast_filter_auto_gen_998_security extends qtype_stack_ast_testcase {
    public function test_affected_no_units() {
        ...
        $this->expect("In(x)",
                      "In(x)",
                      array("stackCas_badLogIn"),
                      false, true);

        $this->expect("Sin(x)",
                      "Sin(x)",
                      array("unknownFunctionCase"),
                      false, true);

        $this->expect("a,b,c",
                      "a,b=true,c=true",
                      array("unencapsulated_comma"),
                      false, true);
    ...
    public function test_affected_units() {
        ...
        $this->expect("a,b,c",
                      "a,b=true,c=true",
                      array("unencapsulated_comma", "unknownUnitsCase"),
                      false, true);
