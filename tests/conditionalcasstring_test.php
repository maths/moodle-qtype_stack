...
/**
 * Unit tests for stack_cas_conditionalcasstring.
 *
...
/**
 * Unit tests for {@link stack_cas_conditionalcasstring}. 
 * Mainly to ensure that the inherited features work.
 * @group qtype_stack
 */
class conditionalcasstring_test extends basic_testcase {

    public function get_valid($s, $st, $te, $cs = array()) {

        $at1 = new stack_cas_conditionalcasstring($s, $cs);
        $this->assertEquals($st, $at1->get_valid('s'));

        $at2 = new stack_cas_conditionalcasstring($s, $cs);
        $this->assertEquals($te, $at2->get_valid('t'));
    }

    // Just clone normal casstrings
    ...
    public function test_validation_error() {
        $casstring = new stack_cas_conditionalcasstring('π', array());
    ...
    public function test_validation_error_global_forbid() {
        $casstring = new stack_cas_conditionalcasstring('system(rm)', array());
    ...
    public function test_spurious_operators() {
        $casstring = new stack_cas_conditionalcasstring('2/*x', array());
        $casstring->validate('s');
    ...
    public function get_key($s, $key, $val) {
        $at1 = new stack_cas_conditionalcasstring($s, array());
    ...
    public function test_global_forbidden_words() {
        ...
        $at2 = new stack_cas_conditionalcasstring($s, array());
    ...
    public function test_check_external_forbidden_words() {
        ...
        foreach ($cases as $case) {
            $cs = new stack_cas_conditionalcasstring($case[0], array());
