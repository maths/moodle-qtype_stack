...
class stack_answertest_test_data {
    ...
    protected static $rawdata = array(
        ...
        array('AlgEquiv', '', 'abs(x)<2', '-2<x and x<2', 1, '', ''),
        array('AlgEquiv', '', '-2<x and x<2', 'abs(x)<2', 1, '', ''),
        array('AlgEquiv', '', 'abs(x)<2', '-1<x and x<1', 0, '', ''),
        array('AlgEquiv', '', 'x^2<=9', 'abs(x)<3', 0, '', ''),
        array('AlgEquiv', '', 'x^2<=9', 'abs(x)<=3', 1, '', ''),
        array('AlgEquiv', '', 'x^6<1', 'abs(x)<1', 1, '', ''),
        array('AlgEquiv', '', 'abs(x)>1', 'x<-1 or x>1', 1, '', ''),
