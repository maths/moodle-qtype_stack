...
class stack_answertest_test_data {
    ...
    protected static $rawdata = array(
        ...
        array('AlgEquiv', '', 'integerp(3.1)', 'true', 0, 'ATLogic: [false | true]', ''),
        array('AlgEquiv', '', 'integerp(3)', 'false', 0, 'ATLogic: [true | false]', ''),
        array('AlgEquiv', '', 'integerp(3)', 'true', 1, 'ATLogic_True', ''),
        array('AlgEquiv', '', 'lowesttermsp(x^2/x)', 'true', 0, 'ATLogic: [false | true]', ''),
        array('AlgEquiv', '', 'lowesttermsp(-y/-x)', 'true', 0, 'ATLogic: [false | true]', ''),
        array('AlgEquiv', '', 'lowesttermsp((x^2-1)/(x-1))', 'true', 0, 'ATLogic: [false | true]', ''),
        ...
        array('AlgEquiv', '', 'all', 'x=x', 1, 'ATEquation_zero', 'Equations: edge cases. Teacher must enter an equation here.'),
        ...
        array('NumSigFigs', '2', '0', '0', 1, '', 'Edge cases'),
        ...
        array('Units', '2', '2*hh', '720000*s', 1, 'ATUnits_compatible_units: s.', ''),
        array('Units', '2', '0*m/s', '0*m/s', 1, 'ATUnits_units_match.', 'Edge case'),
        array('Units', '2', '0.0*m/s', '0*m/s', 1, 'ATUnits_units_match.', ''),
        array('Units', '2', '0*m/s', '0.0*m/s', 1, 'ATUnits_units_match.', ''),
        array('Units', '2', '0.0*m/s', '0.0*m/s', 1, 'ATUnits_units_match.', ''),
        array('Units', '2', '0.0*km/s', '0.0*m/s', 1, 'ATUnits_compatible_units: m/s.', ''),
        array('Units', '2', '0.0*m', '0.0*m/s', 0, 'ATUnits_incompatible_units. ATUnits_correct_numerical.', ''),
        array('Units', '2', '0.0', '0.0*m/s', 0, 'ATUnits_SA_no_units.', ''),
        ...
        array('UnitsStrict', '2', '0*m/s', '0*m/s', 1, 'ATUnits_units_match.', 'Edge case'),
        array('UnitsStrict', '2', '0.0*m/s', '0*m/s', 1, 'ATUnits_units_match.', ''),
        array('UnitsStrict', '2', '0*m/s', '0.0*m/s', 1, 'ATUnits_units_match.', ''),
        array('UnitsStrict', '2', '0.0*m/s', '0.0*m/s', 1, 'ATUnits_units_match.', ''),
        array('UnitsStrict', '2', '0.0*km/s', '0.0*m/s', 0, 'ATUnits_compatible_units: m/s.', ''),
        array('UnitsStrict', '2', '0.0*m', '0.0*m/s', 0, 'ATUnits_incompatible_units. ATUnits_correct_numerical.', ''),
        array('UnitsStrict', '2', '0.0', '0.0*m/s', 0, 'ATUnits_SA_no_units.', ''),
