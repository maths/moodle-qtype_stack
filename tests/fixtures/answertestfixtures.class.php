...
class stack_answertest_test_data {
    ...
    protected static $rawdata = array(
        ...
        array('AlgEquiv', '', 'co(1,2)', '1 <= x nounand x<2', 0, 'ATAlgEquiv_SA_not_logic.', ''),
        array('AlgEquiv', '', '1 <= x nounand x<2', 'co(1,2)', 0, 'ATAlgEquiv_SA_not_realset.', ''),
        array('AlgEquiv', '', 'minf <= x', 'co(minf,inf)', 0, 'ATAlgEquiv_SA_not_realset.', ''),
        array('AlgEquiv', '', '-inf <= x', 'co(minf,inf)', 0, 'ATAlgEquiv_SA_not_realset.', ''),
        ...
        array('AlgEquiv', '', 'x^4>=16', 'x^2>=4', 1, '', ''),
        array('AlgEquiv', '', '-3<=x', '-3<=x nounand x<=3', 0, '', ''),
        ...
        array('AlgEquiv', '', 'minf < x', 'minf <= x', 0, 'ATInequality_strict.', ''),
        array('AlgEquiv', '', 'x>minf', 'minf < x', 1, '', ''),
        array('AlgEquiv', '', 'x>-inf', 'minf < x', 1, '', ''),
        // Because Maxima does not simplify expressions like 2*inf->inf!
        array('AlgEquiv', '', 'x<2*inf', 'x<inf', 0, '', ''),
        ...
        array('AlgEquiv', '', '2*inf', 'inf', 0, '', 'Maxima and infinity'),
        array('AlgEquiv', '', '-inf', 'minf', 0, '', ''),
        ...
        array('AlgEquiv', '', 'binomial(58,[9,15,20,14])', 'binomial(58,[15,9,20,14])', 1, '', ''),
        array('AlgEquiv', '', 'binomial(x,[a,b,c])', 'binomial(x,[b,c,a])', 1, '', ''),
        ...
        array('SubstEquiv', '[x]', 'C1*%e^x*sin(4*x)+C2*%e^x*cos(4*x)+C4*x*%e^-x+C3*%e^-x',
        ...
        array('EqualComAss', '', '1/(R-r)', '1', 0, 'ATEqualComAss (AlgEquiv-false).', ''),
        ...
        array('Units', '3', '723*kVA', '0.723*MVA', 1, 'ATUnits_compatible_units VA.', ''),
        ...
        array('Levenshtein', '0.9', 'x^2', '"Hello"', 0, 'ATLevenshtein_SA_not_string.', ''),
        array('Levenshtein', '0.9', '"Hello"', '"Hello"', 0, 'ATLevenshtein_SB_malformed.', ''),
        array('Levenshtein', '0.9', '"Hello"', '["Hello"]', 0, 'ATLevenshtein_SB_malformed.', ''),
        array('Levenshtein', '0.9', '"Hello"', '[["Hello"]]', 0, 'ATLevenshtein_SB_malformed.', ''),
        array('Levenshtein', '0.9', '"Hello"', '[["Hello"], x^2]', 0, 'ATLevenshtein_SB_malformed.', ''),
        array('Levenshtein', '0.9', '"Hello"', '[["Hello"], [x^2]]', 0, 'ATLevenshtein_SB_malformed.', ''),
        array('Levenshtein', '0.9', '"Hello"', '[["Hello"], ["Goodbye"], ["Excess"]]', 0,
            'ATLevenshtein_SB_malformed.', ''),
        array('Levenshtein', '0.9', '"Hello"', '[[], ["Goodbye"]]', 0, 'ATLevenshtein_SB_malformed.', ''),
        array('Levenshtein', 'z', '"Hello"', '[["Hello"], ["Goodbye"]]', 0, 'ATLevenshtein_tol_not_number.', ''),
        array('Levenshtein', '[z]', '"Hello"', '[["Hello"], ["Goodbye"]]', 0, 'ATLevenshtein_tol_not_number.', ''),
        // Functionality test.
        array('Levenshtein', '0.9', '"Hello"', '[["Hello"], ["Goodbye"]]', 1,
        ...
        array('Levenshtein', '[0.8, CASE]', '"hello"', '[["Hello", "Good day", "Hi"], ["Goodbye", "Bye", "Fairwell"]]', 1,
            'ATLevenshtein_match: [[0.8,"Hello"],[0.25,"Fairwell"]].', ''),
        array('Levenshtein', '0.8', '"goodday"', '[["Hello", "Good day", "Hi"], ["Goodbye", "Bye", "Fairwell"]]', 1,
            'ATLevenshtein_match: [[0.875,"Good day"],[0.57143,"Goodbye"]].', ''),
        array('Levenshtein', '[0.8, CASE]', '"goodday"', '[["Hello", "Good day", "Hi"], ["Goodbye", "Bye", "Fairwell"]]', 0,
            'ATLevenshtein_far: [[0.75,"Good day"],[0.42857,"Goodbye"]].', ''),
        array('Levenshtein', '0.9', '"Jello"', '[["Hello", "Good day", "Hi"], ["Goodbye", "Bye", "Fairwell"]]', 0,
            'ATLevenshtein_far: [[0.8,"Hello"],[0.25,"Fairwell"]].', ''),
        array('Levenshtein', '0.75', '"Jello"', '[["Hello", "Good day", "Hi"], ["Goodbye", "Bye", "Fairwell"]]',
            1, 'ATLevenshtein_match: [[0.8,"Hello"],[0.25,"Fairwell"]].', ''),
        array('Levenshtein', '0.75', '"Jello"', '[["Hello", "Good day", "Hi"], []]',
            1, 'ATLevenshtein_match: [[0.8,"Hello"],[0,[]]].', ''),
        array('Levenshtein', '0.75', '"Good bye"', '[["Hello", "Good day", "Hi"], ["Goodbye", "Bye", "Fairwell"]]',
            0, 'ATLevenshtein_deny: [[0.625,"Good day"],[0.875,"Goodbye"]].', ''),
        array('Levenshtein', '0.75', '"Good, day!"', '[["Hello", "Good day", "Hi"], ["Goodbye", "Bye", "Fairwell"]]',
            1, 'ATLevenshtein_match: [[0.8,"Good day"],[0.5,"Goodbye"]].', ''),
        array('Levenshtein', '0.75', 'sremove_chars(".,!?", "Good, day!")',
            '[["Hello", "Good day", "Hi"], ["Goodbye", "Bye", "Fairwell"]]',
            1, 'ATLevenshtein_true: [[1.0,"Good day"],[0.5,"Goodbye"]].', ''),
        array('Levenshtein', '0.75', '"   good     day  "',
            '[["Hello", "Good day", "Hi"], ["Goodbye", "Bye", "Fairwell"]]',
            1, 'ATLevenshtein_true: [[1.0,"Good day"],[0.5,"Goodbye"]].', ''),
        array('Levenshtein', '[0.75, WHITESPACE]', '"   good     day  "',
            '[["Hello", "Good day", "Hi"], ["Goodbye", "Bye", "Fairwell"]]',
