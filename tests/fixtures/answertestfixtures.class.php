...
class stack_answertest_test_data {
    ...
    protected static $rawdata = array(
        ...
        array('EqualComAssRules', '[zeroAdd]', '1*a', 'a', 0, 'ATEqualComAssRules: [1 noun* a,a].', ''),
        ...
        array('EqualComAssRules', 'NEG_TRANS', '(x-y)*(y-x)', '-(x-y)^2', 0,
        ...
        array('EqualComAssRules', 'ID_TRANS', '(-a)/(-x)', '-(-a/x)', 0,
        ...
        array('EqualComAssRules', '[negDiv]', '(-a)/(-x)', 'a/x', 0,
        ...
        array('EqualComAssRules', '[negDiv]', '-2/(1-x)', '2/(x-1)', 0,
        ...
        array('EqualComAssRules', 'ID_TRANS', '1/2*3/x', '3/(2*x)', 0,
        ...
        array('EqualComAssRules', '[ID_TRANS,recipMul]', '5/2*3/x', '15/(2*x)', 0,
        ...
        array('EqualComAssRules', '[ID_TRANS,intMul]', '(-7*x)*(-3*x)', '21*x*x', 0,
        ...
        array('EqualComAssRules', '[ID_TRANS]', 'a/b/c', 'a/(b*c)', 0,
        ...
        array('EqualComAssRules', '[ID_TRANS,divDiv]', 'A*a/(B*b/c)*1/d', 'A*(a*c)/(B*b*d)', 0,
        ...
        array('EqualComAssRules', '[ID_TRANS,divDiv]', 'A/(B/(C/D))', 'A*C/(B*D)', 0,
