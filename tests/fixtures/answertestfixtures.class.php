...
class stack_answertest_test_data {
    ...
    protected static $rawdata = [
        ...
        ['Antidiff', 'x', 'ln(x)', 'ln(abs(x))+c', 1, 'ATAntidiff_true. ATInt_logabs.', 'Fussy logs (teacher uses abs(x) )'],
        ['Antidiff', 'x', 'ln(x)+c', 'ln(abs(x))+c', 1, 'ATAntidiff_true. ATInt_logabs.', ''],
        ...
        ['Antidiff', 'x', 'ln(k*x)', 'ln(abs(x))+c', 1, 'ATAntidiff_true. ATInt_logabs.', ''],
        ['Antidiff', 'x', 'ln(k*abs(x))', 'ln(abs(x))+c', 1, 'ATAntidiff_true.', ''],
        ['Antidiff', 'x', 'ln(abs(k*x))', 'ln(abs(x))+c', 1, 'ATAntidiff_true.', ''],
        ['Antidiff', 'x', 'ln(x)', 'ln(k*abs(x))', 1, 'ATAntidiff_true. ATInt_logabs.', 'Teacher uses ln(k*abs(x))'],
        ['Antidiff', 'x', 'ln(x)+c', 'ln(k*abs(x))', 1, 'ATAntidiff_true. ATInt_logabs.', ''],
        ['Antidiff', 'x', 'ln(abs(x))', 'ln(k*abs(x))', 1, 'ATAntidiff_true.', ''],
        ['Antidiff', 'x', 'ln(abs(x))+c', 'ln(k*abs(x))', 1, 'ATAntidiff_true.', ''],
        ['Antidiff', 'x', 'ln(k*x)', 'ln(k*abs(x))', 1, 'ATAntidiff_true. ATInt_logabs.', ''],
        ['Antidiff', 'x', 'ln(k*abs(x))', 'ln(k*abs(x))', 1, 'ATAntidiff_true.', ''],
        ['Antidiff', 'x', 'ln(x)+ln(a)', 'ln(k*abs(x+a))', 0, 'ATAntidiff_generic. ATInt_logabs.', 'Other logs'],
        ['Antidiff', 'x', 'log(x)^2-2*log(c)*log(x)+k', 'ln(c/x)^2', 1, 'ATAntidiff_true.', ''],
        ['Antidiff', 'x', 'log(x)^2-2*log(c)*log(x)+k', 'ln(abs(c/x))^2', 1, 'ATAntidiff_true.', ''],
        ...
        ['Antidiff', '[x,NOCONST]', 'ln(x^2+7*x+7)', 'ln(abs(x^2+7*x+7))', -1, 'ATAntidiff_STACKERROR_Opt. ATInt_logabs.', ''],
        ['Antidiff', 'x', 'ln(x^2+7*x+7)+c', 'ln(x^2+7*x+7)+c', 1, 'ATAntidiff_true.', ''],
        ['Antidiff', 'x', 'ln(k*(x^2+7*x+7))', 'ln(x^2+7*x+7)+c', 1, 'ATAntidiff_true.', ''],
        ['Antidiff', 'x', 'ln(x^2+7*x+7)', 'ln(abs(x^2+7*x+7))+c', 1, 'ATAntidiff_true. ATInt_logabs.', ''],
        ['Antidiff', 'x', 'ln(x^2+7*x+7)+c', 'ln(abs(x^2+7*x+7))+c', 1, 'ATAntidiff_true. ATInt_logabs.', ''],
        [
            'Antidiff', 'x', '-2*log(x)-(10*x^6)/3+x^3/3+5*log(x^4)+c',
            '-2*log(abs(x))+(10*x^6)/3-x^3/3-5/x^3+c', 0, 'ATAntidiff_generic. ATInt_logabs.', '',
        ],
        ...
        ['Antidiff', 'x', 'log(x-3)+log(x+3)', 'log(abs(x-3))+log(abs(x+3))', 1, 'ATAntidiff_true. ATInt_logabs.', ''],
        ['Antidiff', 'x', 'log(x-3)+log(x+3)+c', 'log(abs(x-3))+log(abs(x+3))', 1, 'ATAntidiff_true. ATInt_logabs.', ''],
        ...
        [
            ...
            'ATAntidiff_true. ATInt_logabs_inconsistent.', 'Inconsistent log(abs())',
        ],
        [
            'Antidiff', 'v', 'log((v-3))+log(abs(v+3))+c', 'log(v-3)+log(v+3)', 1,
            'ATAntidiff_true. ATInt_logabs_inconsistent.', '',
        ],
        [
        ...
        [
            ...
            '-log(abs(x+2))+2*log(abs(x-2))+(x^2+4*x)/2', 1, 'ATAntidiff_true. ATInt_logabs. ATInt_logabs_inconsistent.', '',
        ],
        [
        ...
        [
            'Antidiff', 't', '2*(sqrt(t)-5)-10*log((sqrt(t)-5))+c',
            '2*(sqrt(t)-5)-10*log(abs(sqrt(t)-5))+c', 1, 'ATAntidiff_true. ATInt_logabs.', '',
        ],
        [
        ...
        ['Antidiff', '[x,x*%e^(5*x+7)]', '((5*%e^7*x-%e^7)*%e^(5*x))', '((5*%e^7*x-%e^7)*%e^(5*x))/25+c', -1, 'ATAntidiff_STACKERROR_Opt.', ''],
        // Various forms of inverse hyperbolic forms of the integrals.  Consider int(1/(x^2-a^2),x).
        [
        ...
        [
            ...
            '2*atan(sin(x)/(sqrt(3)*(cos(x)+1)))/sqrt(3)', 1, 'ATAntidiff_true.', 'Stoutemyer (currently fails in ATInt, but works in ATAntidiff)',
        ],
