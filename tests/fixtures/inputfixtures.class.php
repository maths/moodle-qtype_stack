...
class stack_inputvalidation_test_data {
    ...
    protected static $rawdata = array(
        ...
        array('x xor y', 'php_false', '', '', '', 'spaces | forbiddenVariable', ""),
        array('x isa "number"', 'php_false', '', '', '', 'spaces | ParseError', ""),
        ...
        array('x.', 'php_flase', 'x.', '', '', 'finalChar', ""),
        array('x and', 'php_false', '', '', '', 'spaces | operatorPlacement', ""),
        ...
        array('((x))', 'php_true', '((x))', 'cas_true', 'x', '', ""),
        array('(()x)', 'php_false', '(()*x)', 'cas_false', '', 'missing_stars | forbiddenWord', ""),
        array('()x', 'php_false', '()*x', 'cas_false', '', 'missing_stars | forbiddenWord', ""),
        array('x()', 'php_false', 'x*()', 'cas_false', '', 'missing_stars | forbiddenWord', ""),
        ...
        array('gcf(x,y)', 'php_false', '', '', '', 'forbiddenFunction', ""),
