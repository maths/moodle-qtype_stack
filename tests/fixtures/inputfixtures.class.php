...
class stack_inputvalidation_test_data {
    ...
    protected static $rawdata = array(
        ...
        array('+-1', 'php_true', '#pm#1', 'cas_true', '\pm 1', '', "Plus and minus"),
        array('x=+-sqrt(2)', 'php_true', 'x = #pm#sqrt(2)', 'cas_true', 'x= \pm \sqrt{2}', '', ""),
        array('(-b+-sqrt(b^2))/(2*a)', 'php_true', '(-b#pm#sqrt(b^2))/(2*a)', 'cas_true',
                '\frac{{-b \pm \sqrt{b^2}}}{2\cdot a}', '', ""),
        array('a+-b', 'php_true', 'a#pm#b', 'cas_true', '{a \pm b}', '', ""),
