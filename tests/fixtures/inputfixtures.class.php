...
class stack_inputvalidation_test_data {
    ...
    protected static $rawdata = array(
        ...
        array('x and y', 'php_true', 'x nounand y', 'cas_true', '', ""),
        array('x or y', 'php_true', 'x nounor y', 'cas_true', '', ""),
        ...
        array('x<1 and x>1', 'php_true', 'x<1 nounand x>1', 'cas_true', '', ""),
        ...
        array('log_10(x)', 'php_true', 'lg(x, 10)', 'cas_true', 'logsubs', ""),
