...
class stack_inputvalidation_test_data {
    ...
    protected static $rawdata = array(
        ...
        array('.1', 'php_true', 'dispdp(.1,1)', 'cas_true', '0.1', '', ""),
        array('0.2000', 'php_true', 'dispdp(0.2000,4)', 'cas_true', '0.2000', '', ""),
        array('0.2000/0.030', 'php_true', 'dispdp(0.2000,4)/dispdp(0.030,3)', 'cas_true', '\frac{0.2000}{0.030}', '', ""),
        ...
        array('1E+3', 'php_true', 'displaysci(1,0,3)', 'cas_true', '1 \times 10^{3}', '', "Scientific notation"),
        array('3E2', 'php_true', 'displaysci(3,0,2)', 'cas_true', '3 \times 10^{2}', '', ""),
        array('3e2', 'php_true', 'displaysci(3,0,2)', 'cas_true', '3 \times 10^{2}', '', ""),
        array('3e-2', 'php_true', 'displaysci(3,0,-2)', 'cas_true', '3 \times 10^{-2}', '', ""),
        array('3.67x10^2', 'php_true', 'dispdp(3.67,2)*x*10^2', 'cas_true', '3.67\cdot x\cdot 10^2', 'missing_stars', ""),
        ...
        array('"1+1"', 'php_true', '"1+1"', 'cas_true', '\text{1+1}', '',
        "Strings - generally discouraged.  Note, this is a string within a mathematical expression, not literally 1+1."),
        array('"Hello world"', 'php_true', '"Hello world"', 'cas_true', '\text{Hello world}', '', ''),
        ...
        array('[1,2,3.4]', 'php_true', '[1,2,dispdp(3.4,1)]', 'cas_true', '\left[ 1 , 2 , 3.4 \right]', '', ""),
        array('[1.000,2,3.40]', 'php_true', '[dispdp(1.000,3),2,dispdp(3.40,2)]', 'cas_true',
            '\left[ 1.000 , 2 , 3.40 \right]', '', ""),
        array('[x, y, z ]', 'php_true', '[x,y,z]', 'cas_true', '\left[ x , y , z \right]', '', ""),
        array('["a"]', 'php_true', '["a"]', 'cas_true', '\left[ \text{a} \right]', '', ""),
        array('[1,true,"a"]', 'php_true', '[1,true,"a"]', 'cas_true', '\left[ 1 , \mathbf{True} , \text{a} \right]', '', ""),
        ...
        array('x and y', 'php_true', 'x and y', 'cas_true', 'x\,{\text{ and }}\, y', '', ""),
        array('true and false', 'php_true', 'true and false', 'cas_true', '\mathbf{True}\,{\text{ and }}\, \mathbf{False}', '', ""),
        array('x or y', 'php_true', 'x or y', 'cas_true', 'x\,{\text{ or }}\, y', '', ""),
        array('x xor y', 'php_true', 'x xor y', 'cas_true', 'x\,{\text{ xor }}\, y', '', ""),
        array('x nor y', 'php_true', 'x nor y', 'cas_true', 'x\,{\text{ nor }}\, y', '', ""),
        array('x nand y', 'php_true', 'x nand y', 'cas_true', 'x\,{\text{ nand }}\, y', '', ""),
        array('x implies y', 'php_true', 'x implies y', 'cas_true', 'x\,{\text{ implies }}\, y', '', ""),
        ...
        array('x<1 and x>1', 'php_true', 'x < 1 and x > 1', 'cas_true', 'x < 1\,{\text{ and }}\, x > 1', '', ""),
        ...
        array('x=1 or 2', 'php_true', 'x = 1 or 2', 'cas_true', 'x=1\,{\text{ or }}\, 2', 'Bad_assignment', ""),
        array('x=1 or x=2', 'php_true', 'x = 1 or x = 2', 'cas_true', 'x=1\,{\text{ or }}\, x=2', '', ""),
        ...
        array('y^2-2*y-0.50', 'php_true', 'y^2-2*y-dispdp(0.50,2)', 'cas_true', 'y^2-2\cdot y-0.50', '', ""),
        ...
        array('"WA?@AAA@AA"', 'php_true', '"WA?@AAA@AA"', 'cas_true', '\text{WA?@AAA@AA}', '', ""),
        ...
        array('+0.200', 'php_true', '+dispdp(0.200,3)', 'cas_true', '0.200', '', ""),
        ...
        array('signum(x)', 'php_true', 'signum(x)', 'cas_true', '\mathrm{sgn}\left(x\right)', '', ""),
        array('sgn(x)', 'php_true', 'sgn(x)', 'cas_true', '\mathrm{sgn}\left(x\right)', '', ""),
        ...
        array('diff(x(t),t)', 'php_true', 'diff(x(t),t)', 'cas_true',
            '\frac{\mathrm{d}}{\mathrm{d} t} x\left(t\right)', '', ""),
        array('diff(x,t,2)', 'php_true', 'diff(x,t,2)', 'cas_true',
            '\frac{\mathrm{d}^2 x}{\mathrm{d} t^2}', '', ""),
        array('diff(x(t),t,2)', 'php_true', 'diff(x(t),t,2)', 'cas_true',
            '\frac{\mathrm{d}^2}{\mathrm{d} t^2} x\left(t\right)', '', ""),
        // I think the chances of a student typing this in are low...
        array('diff(f,x,1,y,2)', 'php_true', 'diff(f,x,1,y,2)', 'cas_true',
        ...
        array('arcsin(x)', 'php_true', 'asin(x)', 'cas_true', '\sin^{-1}\left( x \right)', 'triginv', "Not the arcsin"),
    ...
    protected static $rawdataunits = array(
        ...
        array('9.81*m/s^2', 'php_true', 'dispdp(9.81,2)*m/s^2', 'cas_true', '9.81\, {\mathrm{m}}/{\mathrm{s}^2}', '', ""),
        array('9.81*m*s^-2', 'php_true', 'dispdp(9.81,2)*m*s^-2', 'cas_true', '9.81\, {\mathrm{m}}/{\mathrm{s}^2}', '', ""),
    ...
    protected static $rawdatadecimals = array(
        ...
        array(0 => '1.23',
            '.' => array(null, 'php_true', 'dispdp(1.23,2)', 'cas_true', '1.23', '', ""),
            ',' => array(null, 'php_false', '', '', '', 'forbiddenCharDecimal', "")
        ),
        array(0 => '-1.27',
            '.' => array(null, 'php_true', '-dispdp(1.27,2)', 'cas_true', '-1.27', '', ""),
            ',' => array(null, 'php_false', '', '', '', 'forbiddenCharDecimal', "")
        ),
        array(0 => '2.78e-3',
            '.' => array(null, 'php_true', 'displaysci(2.78,2,-3)', 'cas_true', '2.78 \times 10^{-3}', '', ""),
            ',' => array(null, 'php_false', '', '', '', 'forbiddenCharDecimal', "")
        ),
        array(0 => '1,23',
        ...
        array(0 => '-1,29',
            '.' => array(null, 'php_false', '', '', '', 'unencapsulated_comma', ""),
            ',' => array(null, 'php_true', '-dispdp(1.29,2)', 'cas_true', '-1.29', '', "")
        ),
        array(0 => '2,79e-5',
            '.' => array(null, 'php_false', '', '', '', 'unencapsulated_comma', ""),
            ',' => array(null, 'php_true', 'displaysci(2.79,2,-5)', 'cas_true', '2.79 \times 10^{-5}', '', "")
        ),
        ...
        array(0 => '{1,23}',
            ...
            ',' => array(null, 'php_true', '{dispdp(1.23,2)}', 'cas_true', '\left \{1.23 \right \}', '', "")
        ),
        array(0 => '{1.23}',
            '.' => array(null, 'php_true', '{dispdp(1.23,2)}', 'cas_true', '\left \{1.23 \right \}', '', ""),
            ',' => array(null, 'php_false', '', '', '', 'forbiddenCharDecimal', "")
        ...
        array(0 => '{1.2,3}',
            '.' => array(null, 'php_true', '{dispdp(1.2,1),3}', 'cas_true', '\left \{1.2 , 3 \right \}', '', ""),
            ',' => array(null, 'php_false', '', '', '', 'forbiddenCharDecimal', "")
        ),
        array(0 => '{1,2;3}',
            '.' => array(null, 'php_false', '', '', '', 'forbiddenChar_parserError', ""),
