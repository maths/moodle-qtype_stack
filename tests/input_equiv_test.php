...
final class input_equiv_test extends qtype_stack_testcase {
    ...
    public function test_render_blank(): void {
        ...
        $this->assertEquals(
            '<textarea class="equivinput" name="stack1__ans1" id="stack1__ans1" rows="3" cols="25" ' .
    ...
    public function test_render_syntaxhint(): void {
        ...
        $this->assertEquals(
            "<textarea class=\"equivinput\" name=\"stack1__ans1\" id=\"stack1__ans1\" " .
    ...
    public function test_render_syntaxhint_placeholder(): void {
    ...
    public function test_render_firstline(): void {
    ...
    public function test_render_hint(): void {
    ...
    public function test_validate_student_response_invalid_1(): void {
    ...
    public function test_validate_student_response_invalid_2(): void {
    ...
    public function test_validate_student_response_invalid_3(): void {
        ...
        $this->assertEquals(stack_input::INVALID, $state->status);
        $this->assertEquals(
            '\'^\' is an invalid final character in <span class="stacksyntaxexample">=(x-2)*x^</span>',
            $state->errors
        );
        $this->assertEquals('finalChar', $state->note);
    }

    public function test_validate_student_response_invalid_4(): void {
        ...
        $this->assertEquals(
            '\(\displaystyle x^2-5\cdot x+6=0 \)<br/>' .
    ...
    public function test_validate_student_response_invalid_mixed(): void {
        ...
        $this->assertEquals(
            '\[ \begin{array}{lll} &x^2-5\cdot x+6=0& \cr &\left(x-2\right)\cdot ' .
    ...
    public function test_validate_student_response_with_equiv(): void {
        ...
        $this->assertEquals('', $state->note);
        $this->assertEquals(
            '<textarea class="equivinput" name="q140:1_ans1" id="q140:1_ans1" rows="3" cols="25" ' .
                'autocapitalize="none" spellcheck="false" data-stack-input-type="equiv" ' .
        ...
        $this->assertEquals(
            '<span class="filter_mathjaxloader_equation">' .
                ...
                ' \color{green}{\Leftrightarrow}&x=2\,{\text{ or }}\, x=3& \cr \end{array} \]</span></span>' .
    ...
    public function test_validate_student_response_without_equiv(): void {
        ...
        $this->assertEquals('[x^2-5*x+6 = 0,x = 2 nounor x = 3]', $state->contentsmodified);
        $this->assertEquals('\[ \begin{array}{lll}x^2-5\cdot x+6=0& \cr' .
                ' x=2\,{\text{ or }}\, x=3& \cr \end{array} \]', $state->contentsdisplayed);
        $this->assertEquals('', $state->note);
    }

    public function test_validate_student_response_without_domain(): void {
    ...
    public function test_validate_student_response_without_assume_pos(): void {
        ...
        $state = $el->validate_student_response(
            ['sans1' => "x^2=4\nx=2 or x=-2"],
            $options,
            '[x^2=4,x=2 nounor x=-2]',
            new stack_cas_security()
        );
        $this->assertEquals(stack_input::VALID, $state->status);
        $this->assertEquals('[x^2 = 4,x = 2 nounor x = -2]', $state->contentsmodified);
        $this->assertEquals('\[ \begin{array}{lll} &x^2=4& \cr \color{green}{\Leftrightarrow}&x=2\,{\text{ or }}\, x=-2& \cr' .
                ' \end{array} \]', $state->contentsdisplayed);
        $this->assertEquals('', $state->note);
    }

    public function test_validate_student_response_without_assume_pos_wrong(): void {
    ...
    public function test_validate_student_response_with_assume_pos(): void {
        ...
        $this->assertEquals(
            '\[ \begin{array}{lll}\color{blue}{\text{Assume +ve vars}}&x^2=4& \cr ' .
    ...
    public function test_validate_student_response_with_firstline(): void {
    ...
    public function test_validate_student_response_with_firstline_neg(): void {
        ...
        $this->assertEquals(
            '\[ \begin{array}{lll} &2\cdot x-2+4=-6& \cr \end{array} \]',
            $state->contentsdisplayed
        );
        $this->assertEquals('missing_stars', $state->note);
    }

    public function test_validate_student_response_with_firstline_false(): void {
    ...
    public function test_validate_student_response_insert_stars_0_true(): void {
        ...
        $state = $el->validate_student_response(
            ['sans1' => "(x-1)(x+4)\n=x^2-x+4x-4\n=x^2+3x-4"],
            $options,
            '[(x-1)*(x+4), stackeq(x^2-x+4*x-4),stackeq(x^2+3*x-4)]',
            new stack_cas_security()
        );
        ...
        $this->assertEquals(
            '\[ \begin{array}{lll} &\left(x-1\right)\cdot \left(x+4\right)& \cr \color{green}{\checkmark}' .
    ...
    public function test_validate_student_response_insert_stars_0_false(): void {
    ...
    public function test_validate_student_response_equational_1(): void {
    ...
    public function test_validate_student_response_equational_insert_stars_true(): void {
    ...
    public function test_validate_student_response_without_assume_real(): void {
        ...
        $state = $el->validate_student_response(
            ['sans1' => "x^4=16\nx=2 or x=-2"],
            $options,
            '[x^4=16,x=2 nounor x=-2]',
            new stack_cas_security()
        );
        $this->assertEquals(stack_input::VALID, $state->status);
        $this->assertEquals('[x^4 = 16,x = 2 nounor x = -2]', $state->contentsmodified);
        $this->assertEquals(
            '\[ \begin{array}{lll} &x^4=16& \cr \color{red}{\Leftarrow}&x=2\,{\text{ or }}\, ' .
                'x=-2& \cr \end{array} \]',
            $state->contentsdisplayed
        );
        $this->assertEquals('', $state->note);
    ...
    public function test_validate_student_response_with_assume_real(): void {
        ...
        $this->assertEquals('\[ \begin{array}{lll}\color{blue}{(\mathbb{R})}&x^4=16& \cr \color{green}{\Leftrightarrow}\, ' .
                '\color{blue}{(\mathbb{R})}&x=2\,{\text{ or }}\, x=-2& \cr \end{array} \]', $state->contentsdisplayed);
        $this->assertEquals('', $state->note);
    }

    public function test_validate_student_response_with_assume_wrong(): void {
        ...
        $this->assertEquals('\[ \begin{array}{lll}\color{blue}{(\mathbb{R})}&x^4=16& \cr ' .
                '\color{red}{?}&x=1\,{\text{ or }}\, x=-1& \cr \end{array} \]', $state->contentsdisplayed);
        $this->assertEquals('', $state->note);
    }

    public function test_validate_student_response_with_assume_real_complex(): void {

        $options = new stack_options();
        $el = stack_input_factory::make('equiv', 'sans1', '[x^4=16,x=2 nounor x=-2]');
        $el->set_parameter('options', 'assume_real');
        $state = $el->validate_student_response(
            ['sans1' => "x^4=16\nx=2 or x=-2 or x=2*i or x=-2*i"],
            $options,
            '[x^4=16,x=2 nounor x=-2]',
            new stack_cas_security()
        );
        ...
        $this->assertEquals(
            '\[ \begin{array}{lll}\color{blue}{(\mathbb{R})}&x^4=16& \cr ' .
                '\color{green}{\Leftrightarrow}\, \color{blue}{(\mathbb{R})}&x=2\,{\text{ or }}\, ' .
                'x=-2\,{\text{ or }}\, x=2\cdot \mathrm{i}\,{\text{ or }}\, x=-2\cdot \mathrm{i}& \cr \end{array} \]',
            $state->contentsdisplayed
        );
        $this->assertEquals('', $state->note);
    }

    public function test_validate_student_response_with_hideequiv(): void {
        ...
        $this->assertEquals('[x^4 = 16,x = 1 nounor x = -1]', $state->contentsmodified);
        $this->assertEquals(
            '\[ \begin{array}{lll}x^4=16& \cr x=1\,{\text{ or }}\, x=-1& \cr \end{array} \]',
            $state->contentsdisplayed
        );
        $this->assertEquals('', $state->note);
    }
    ...
    public function test_validate_student_response_with_natural_domain_sqrt(): void {
        ...
        $this->assertEquals('\[ \begin{array}{lll} &\sqrt{3\,x+4}=2+\sqrt{x+2}&' .
            ...
            '&x=7\,{\text{ or }}\, x=-1& \cr \end{array} \]', $state->contentsdisplayed);
        $this->assertEquals('', $state->note);
    }
    ...
    public function test_validate_student_response_with_natural_domain_rational(): void {
        ...
        $this->assertEquals(stack_input::VALID, $state->status);
        $this->assertEquals(
            '[5*x/(2*x+1)-3/(x+1) = 1,5*x*(x+1)-3*(2*x+1) = (x+1)*(2*x+1),(x-2)*(3*x+2) = 0,x = 2 nounor x = -2/3]',
            $state->contentsmodified
        );
        $this->assertEquals(
            '\[ \begin{array}{lll} &\frac{5\,x}{2\,x+1}-\frac{3}{x+1}=1' .
                ...
                '&x=2\,{\text{ or }}\, x=\frac{-2}{3}& \cr \end{array} \]',
            $state->contentsdisplayed
        );
        $this->assertEquals('', $state->note);
    }
    ...
    public function test_validate_student_response_with_natural_domain_logs(): void {
        ...
        $this->assertEquals(stack_input::VALID, $state->status);
        $this->assertEquals(
            '[lg(x+17,3)-2 = lg(2*x,3),lg(x+17,3)-lg(2*x,3) = 2,lg((x+17)/(2*x),3) = 2,' .
                '(x+17)/(2*x) = 3^2,(x+17) = 18*x,17*x = 17,x = 1]',
            $state->contentsmodified
        );
        $this->assertEquals(
            '\[ \begin{array}{lll} &\log_{3}\left(x+17\right)-2=\log_{3}\left(2\,x\right)&' .
                ...
                '\cr \color{green}{\Leftrightarrow}&\log_{3}\left(\frac{x+17}{2\,x}\right)=2& \cr \color{green}{\Leftrightarrow}' .
    ...
    public function test_validate_student_response_with_equational_reasoning(): void {
        ...
        $this->assertEquals(stack_input::VALID, $state->status);
        $this->assertEquals(
            '[x^2+2*a*x,stackeq(x^2+2*a*x+a^2-a^2),stackeq((x+a)^2-a^2)]',
            $state->contentsmodified
        );
        $this->assertEquals(
            '\[ \begin{array}{lll} &x^2+2\,a\,x& \cr \color{green}{\checkmark}&=x^2+2\,a\,x+a^2-a^2& ' .
    ...
    public function test_validate_student_response_with_equational_nontrivial_difference(): void {
        ...
        $this->assertEquals(stack_input::VALID, $state->status);
        $this->assertEquals(
            '[abs(x-1/2)+abs(x+1/2)-2,stackeq(abs(x)-1)]',
            $state->contentsmodified
        );
        $this->assertEquals(
            '\[ \begin{array}{lll} &\left| x-\frac{1}{2}\right| +\left| x+\frac{1}{2}\right| -2& \cr ' .
    ...
    public function test_validate_student_response_with_equation_then_equational(): void {
        ...
        $this->assertEquals(stack_input::VALID, $state->status);
        $this->assertEquals(
            '[(x-1)^2 = (x-1)*(x-1),stackeq(x^2-2*x+1)]',
            $state->contentsmodified
        );
        $this->assertEquals(
            '\[ \begin{array}{lll}\color{green}{\checkmark}&' .
    ...
    public function test_validate_student_response_with_equation_then_equational_1(): void {
        ...
        $this->assertEquals(stack_input::VALID, $state->status);
        $this->assertEquals(
            '[(x-1)^2 = (x-1)*(x-1),stackeq(x^2-2*x+2)]',
            $state->contentsmodified
        );
        $this->assertEquals(
            '\[ \begin{array}{lll}\color{green}{\checkmark}&' .
    ...
    public function test_validate_student_response_with_equation_then_equational_2(): void {
        ...
        $this->assertEquals(stack_input::VALID, $state->status);
        $this->assertEquals(
            '[(x-2)^2 = (x-1)*(x-1),stackeq(x^2-2*x+1)]',
            $state->contentsmodified
        );
        $this->assertEquals(
            '\[ \begin{array}{lll}\color{red}{?}&{\left(x-2\right)}^2=\left(x-1\right)\,\left(x-1\right)& \cr ' .
    ...
    public function test_validate_student_response_invalid_comments(): void {
    ...
    public function test_validate_student_response_valid_comments(): void {
    ...
    public function test_validate_student_response_forbid_comments(): void {
        ...
        $this->assertEquals(stack_input::INVALID, $state->status);
        $this->assertEquals(
            '[x^2-1,stackeq((x-1)*(x+1)),"Comments are forbidden normally",x^2-1 = 0,(x-1)*(x+1) = 0]',
            $state->contentsmodified
        );
        $this->assertEquals(
            '\(\displaystyle x^2-1 \)<br/>\(\displaystyle =\left(x-1\right)\,\left(x+1\right) \)<br/>' .
    ...
    public function test_validate_student_response_with_comments(): void {
        ...
        $this->assertEquals(
            '\[ \begin{array}{lll} &x^2-1& \cr \color{green}{\checkmark}&=\left(x-1\right)\,\left(x+1\right)&' .
    ...
    public function test_validate_student_response_valid_empty(): void {
    ...
    public function test_validate_student_response_surds(): void {
        ...
        $this->assertEquals(
            '\[ \begin{array}{lll} &\sqrt{\left(x-3\right)\,\left(x-5\right)}=0&' .
    ...
    public function test_validate_student_stacklet(): void {

        $options = new stack_options();
        $val = '[x^2=a,stacklet(a,4),x^2=4,x=2 nounor x=-2]';
        $el = stack_input_factory::make('equiv', 'sans1', $val);
        // TO-DO reinstate "let" in parser2.
        $state = $el->validate_student_response(
            ['sans1' => "x^2=a\nlet a=4\nx^2=4\nx=2 or x=-2"],
            $options,
            $val,
        ...
        $this->assertEquals('', $state->note);
        $this->assertEquals(
            '[x^2 = a,stacklet(a,4),x^2 = 4,x = 2 nounor x = -2]',
            $state->contentsmodified
        );
        $this->assertEquals(
            '\[ \begin{array}{lll} &x^2=a& \cr &\text{Let }a = 4& \cr ' .
            '\color{green}{\Leftrightarrow}&x^2=4& \cr ' .
            '\color{green}{\Leftrightarrow}&x=2\,{\text{ or }}\, x=-2& \cr \end{array} \]',
            $state->contentsdisplayed
        );
    ...
    public function test_validate_student_pm(): void {
        ...
        $this->assertEquals('', $state->note);
        $this->assertEquals(
            '[(x-a)^2 = 4,x-a = #pm#2,x = a#pm#2]',
            $state->contentsmodified
        );
        $this->assertEquals(
            '\[ \begin{array}{lll} &{\left(x-a\right)}^2=4& \cr ' .
    ...
    public function test_validate_student_response_forbidwords_lists(): void {
        ...
        $this->assertEquals(
            '[x^2 = -4,x^2+4 = 0,EMPTYCHAR]',
            $state->contentsmodified
        );
        $this->assertEquals(
            '\(\displaystyle x^2=-4 \)<br/>\(\displaystyle x^2+4=0 \)<br/>' .
    ...
    public function test_validate_student_response_floats(): void {
        ...
        $this->assertEquals('', $state->note);
        $this->assertEquals(
            '[4*x = 2,x = dispdp(0.5000,4)]',
            $state->contentsmodified
        );
        $this->assertEquals(
            '\[ \begin{array}{lll} &4\cdot x=2& \cr \color{green}{\Leftrightarrow}' .
    ...
    public function test_validate_student_response_disp_parens(): void {
        ...
        $this->assertEquals(
            '\[ \begin{array}{lll} &a+\left(b+c\right)& \cr \color{green}{\checkmark}' .
            '&a+b+c& \cr \end{array} \]',
            $state->contentsdisplayed
        );
