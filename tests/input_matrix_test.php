...
final class input_matrix_test extends qtype_stack_testcase {
    ...
    public function test_render_no_errors_if_garbled(): void {
        ...
        $this->assertEquals($errmsg, $el->render(
    ...
    public function test_validate_student_response_valid(): void {
        ...
        $this->assertEquals(
            '\[ \left[\begin{array}{ccc} 1 & 2 & 3 \\\\ 4 & a & a+b \end{array}\right] \]',
    ...
    public function test_column_vector_model_answer(): void {
        ...
        $this->assertEquals(1, $api['width']);
        $this->assertEquals(3, $api['height']);
        ...
        $this->assertStringContainsString('data-stack-input-type="matrix"', $html);
        ...
        $state = $el->validate_student_response($inputvals, $options, 'c(1,2,3)', new stack_cas_security());
        $this->assertEquals(stack_input::VALID, $state->status);
    ...
    public function test_row_vector_model_answer(): void {
        ...
        $this->assertEquals(3, $api['width']);
        $this->assertEquals(1, $api['height']);
        ...
        $state = $el->validate_student_response($inputvals, $options, 'r(1,2,3)', new stack_cas_security());
        $this->assertEquals(stack_input::VALID, $state->status);
    ...
    public function test_generated_vector_constructor_can_be_forbidden(): void {
        ...
        $state = $el->validate_student_response([
            'ans1_sub_0_0' => '1',
            'ans1_sub_1_0' => '2',
        ], $options, 'c(1,2)', new stack_cas_security());
        $this->assertEquals(stack_input::VALID, $state->status);
    ...
    public function test_validate_student_response_decimals(): void {
        ...
        $this->assertEquals(
            '\[ \left[\begin{array}{cc} 3{,}14 & 2{,}71 \\\\ 4 & 5 \end{array}\right] \]',
            $state->contentsdisplayed
        );
    }
    ...
    public function test_validate_student_response_invalid_one_blank(): void {
        ...
        $this->assertEquals(
            '\[ \left[\begin{array}{ccc} 1 & 2 & 3 \\\\ \color{red}{?} & 5 & 6 \end{array}\right] \]',
            $state->contentsdisplayed
        );
    ...
    public function test_validate_student_response_invalid(): void {
        ...
        $this->assertEquals(
            '<span class="stacksyntaxexample">matrix([1,2x,3],[4,5,6])</span>',
            $state->contentsdisplayed
        );
        $this->assertEquals('', $state->lvars);
    }
    ...
    public function test_validate_student_response_invalid_multiple(): void {
        ...
        $this->assertEquals(
            '<span class="stacksyntaxexample">matrix([1,2x),3],[4,5,6a])</span>',
            $state->contentsdisplayed
        );
        $this->assertEquals('You have a missing left bracket <span class="stacksyntaxexample">(</span> in the expression: ' .
    ...
    public function test_validate_student_response_blank_part(): void {
        ...
        $this->assertEquals(
            '\[ \left[\begin{array}{cc} 1 & 2 \\\\ x & \color{red}{?} \end{array}\right] \]',
            $state->contentsdisplayed
        );
    ...
    public function test_validate_consolidatesubscripts(): void {
        ...
        $this->assertEquals(
            '\[ \left[\begin{array}{cc} a_{1} & a_{2} \\\\ ' .
            '{\it abc}_{123} & {\it abc}_{45} \end{array}\right] \]',
            $state->contentsdisplayed
        );
        $this->assertEquals(
            '\( \left[ a_{1} , a_{2} , {\it abc}_{123} , {\it abc}_{45} \right]\) ',
            $state->lvars
        );
    }
    ...
    public function test_validate_forbid_sin(): void {
        ...
        $this->assertEquals(
            '<span class="stacksyntaxexample">matrix([a1,a_2],[1+sin(x),abc_45])</span>',
            $state->contentsdisplayed
        );
    ...
    public function test_validate_forbid_matrix(): void {
        ...
        $this->assertEquals(
            '\[ \left[\begin{array}{cc} a_{1} & {a}_{2} \\\\ 1+x^2 & {{\it abc}}_{45} \end{array}\right] \]',
            $state->contentsdisplayed
        );
