...
class input_notes_test extends qtype_stack_testcase {
    ...
    public function test_validate_student_response_1() {
        ...
        $vr = '<div class="stackinputfeedback standard" id="sans1_val" aria-live="assertive"><span class="filter_mathjaxloader_equation">' .
    ...
    public function test_validate_student_response_xss() {
        ...
        $ta = '<div class="stackinputfeedback standard" id="sans1_val" aria-live="assertive"><span class="filter_mathjaxloader_' .
