...
class stack_string_input_test extends qtype_stack_testcase {
    ...
    public function test_validate_string_broken_string() {
        ...
        $el = stack_input_factory::make('string', 'sans1', '"A random string"');
        $el->set_parameter('sameType', true);
        $state = $el->validate_student_response(array('sans1' => '".'), $options, '"A random string"', new stack_cas_security());
        $this->assertEquals(stack_input::VALID, $state->status);
    ...
    public function test_validate_string_whitespace() {
        ...
        $el = stack_input_factory::make('string', 'sans1', '"A random string"');
        $el->set_parameter('sameType', true);
        $state = $el->validate_student_response(array('sans1' => ' Some whitespace  '), $options, '"A random string"', new stack_cas_security());
        $this->assertEquals(stack_input::VALID, $state->status);
    ...
    public function test_validate_string_hideanswer() {
        ...
        $state = $el->validate_student_response(array('state' => '[SOME MORE JSON]'), $options, '"[SOME JSON]"', new stack_cas_security());
        $this->assertEquals(stack_input::VALID, $state->status);
