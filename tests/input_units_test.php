...
final class input_units_test extends qtype_stack_testcase {
    public function test_render_blank(): void {
        ...
        $this->assertEquals(
            '<input type="text" name="stack1__ans1" id="stack1__ans1" size="16.5" style="width: 13.6em" '
    ...
    public function test_render_zero(): void {
        ...
        $this->assertEquals(
            '<input type="text" name="stack1__ans1" id="stack1__ans1" size="16.5" style="width: 13.6em" '
                ...
                . 'data-stack-input-type="units" data-stack-input-decimal-separator="." data-stack-input-list-separator="," />',
            $el->render(
                new stack_input_state(stack_input::INVALID, ['0'], '', '', '', '', ''),
                'stack1__ans1',
                false,
                null
            )
    ...
    public function test_render_pre_filled(): void {
        ...
        $this->assertEquals(
            '<input type="text" name="stack1__test" id="stack1__test" size="16.5" style="width: 13.6em" '
                . 'autocapitalize="none" spellcheck="false" class="algebraic-units" value="m/s" '
                . 'data-stack-input-type="units" data-stack-input-decimal-separator="." data-stack-input-list-separator="," />',
            $el->render(
                new stack_input_state(stack_input::VALID, ['m/s'], '', '', '', '', ''),
                'stack1__test',
                false,
                null
            )
    ...
    public function test_render_basic(): void {
        ...
        $this->assertEquals(
            ...
            $el->render(
                new stack_input_state(stack_input::VALID, ['9.81*m/s^2'], '', '', '', '', ''),
                'stack1__input',
                true,
                null
            )
    ...
    public function test_render_different_size(): void {
        ...
        $this->assertEquals(
            '<input type="text" name="stack1__input" id="stack1__input" size="33" style="width: 27.1em" '
                . 'autocapitalize="none" spellcheck="false" class="algebraic-units" value="-9.81*m/s^2" '
                . 'data-stack-input-type="units" data-stack-input-decimal-separator="." data-stack-input-list-separator="," />',
            $el->render(
                new stack_input_state(stack_input::VALID, ['-9.81*m/s^2'], '', '', '', '', ''),
    ...
    public function test_render_syntaxhint(): void {
        ...
        $this->assertEquals(
            '<input type="text" name="stack1__sans1" id="stack1__sans1" size="16.5" style="width: 13.6em" '
    ...
    public function test_validate_student_response_3(): void {
        ...
        $state = $el->validate_student_response(
            ['sans1' => '9.81m/s^2', 'sans1_val' => '9.81m/s^2'],
            $options,
            '9.81*m/s^2',
            new stack_cas_security(true)
        );
    ...
    public function test_validate_student_response_sqrt2(): void {
        ...
        $el->set_parameter('insertStars', 1);
        $state = $el->validate_student_response(
            ['sans1' => 'sqrt(2)*m', 'sans1_val' => 'sqrt(2)*m'],
            $options,
            '1.41*m',
            new stack_cas_security(true)
        );
    ...
    public function test_validate_student_response_option_mul_1(): void {
        ...
        $state = $el->validate_student_response(
            ['sans1' => '3.2*m/s', 'sans1_val' => '3.2*m/s'],
            $options,
            '3.2*m/s',
            new stack_cas_security(true)
        );
    ...
    public function test_validate_student_response_display_recip(): void {
        ...
        $this->assert_equals_ignore_spaces_and_e(
            '\[ 3.88 \times 10^{-4}\times {1}/{\mathrm{s}} \]',
    ...
    public function test_validate_student_response_display_recip_multi(): void {
        ...
        if ($this->adapt_to_new_maxima('5.34.2')) {
            $this->assert_equals_ignore_spaces_and_e(
                '\[ 3.88 \times 10^{-4}\times {1}/{\left(\mathrm{M}\,\mathrm{s}\right)} \]',
                qtype_stack_testcase::prepare_actual_maths($state->contentsdisplayed)
            );
            $this->assertEquals('\( \left[ \mathrm{M} , \mathrm{s} \right]\) ', $state->lvars);
        } else {
            $this->assert_equals_ignore_spaces_and_e(
                '\[ 3.88 \times 10^{-4}\times {1}/{\left(\mathrm{s}\,\mathrm{M}\right)} \]',
                qtype_stack_testcase::prepare_actual_maths($state->contentsdisplayed)
            );
    ...
    public function test_validate_student_response_display_errors1(): void {
        ...
        $this->assertEquals(
            '\[ 9.81\pm 0.01\, {\mathrm{m}}/{\mathrm{s}^2} \]',
            qtype_stack_testcase::prepare_actual_maths($state->contentsdisplayed)
        );
        $this->assertEquals('\( \left[ \mathrm{m} , \mathrm{s} \right]\) ', $state->lvars);
    }
    ...
    public function test_validate_student_response_10x(): void {
        ...
        $this->assertEquals(
            'Your answer appears to use the character "x" as a multiplication sign.  ' .
    ...
    public function test_teacher_answer_zero(): void {
        ...
        $this->assertEquals(
            'The answer <span class="filter_mathjaxloader_equation"><span class="nolink">' .
    ...
    public function test_validate_student_response_complex_1(): void {
        ...
        $this->assertEquals(
            '\[ \left( 72.00\,\mathrm{i}-570.37298\right)\, \Omega \]',
        ...
        $this->assertEquals(
            '\[ \left( 72.00+\left(-\mathrm{i}\right)\,570.37298\right)\, \Omega \]',
            $state->contentsdisplayed
        );
        $this->assertEquals('', $state->errors);
    }
