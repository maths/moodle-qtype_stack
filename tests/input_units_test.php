...
class stack_units_input_test extends qtype_stack_testcase {
    ...
    public function test_render_pre_filled() {
        ...
        $this->assertEquals('<input type="text" name="stack1__test" id="stack1__test" size="16.5" style="width: 13.6em" value="m/s" />',
    ...
    public function test_render_basic() {
        ...
        $this->assertEquals(
                '<input type="text" name="stack1__input" id="stack1__input" size="16.5" style="width: 13.6em" value="9.81*m/s^2" readonly="readonly" />',
    ...
    public function test_render_different_size() {
        ...
        $this->assertEquals('<input type="text" name="stack1__input" id="stack1__input" size="33" style="width: 27.1em" value="-9.81*m/s^2" />',
                $el->render(new stack_input_state(stack_input::VALID, array('-9.81*m/s^2'), '', '', '', '', ''),
                        'stack1__input', false));
    }
    ...
    public function test_render_syntaxhint() {
        ...
        $this->assertEquals('<input type="text" name="stack1__sans1" id="stack1__sans1" size="16.5" style="width: 13.6em" value="?*m/s^2" />',
    ...
    public function test_validate_student_response_3() {
        ...
        $state = $el->validate_student_response(array('sans1' => '9.81m/s^2', 'sans1_val' => '9.81m/s^2'), $options, '9.81*m/s^2', array());
    ...
    public function test_validate_student_response_student_only_units_1() {
        ...
        $this->assertEquals('\[ \frac{m}{s^2} \]', $state->contentsdisplayed);
    }
    ...
    public function test_validate_student_response_student_only_units_2() {
        ...
        $this->assertEquals('\[ m \]', $state->contentsdisplayed);
    }
    ...
    public function test_validate_student_response_student_bad_units() {
        ...
        $this->assertEquals('\[ 9.81+\frac{m}{s^2} \]', $state->contentsdisplayed);
    }
    ...
    public function test_validate_student_response_student_excess_units() {
        ...
        $this->assertEquals('\[ 9.81\cdot m\cdot s^ {- 1 } \]', $state->contentsdisplayed);
    }
    ...
    public function test_validate_student_response_student_excess_units_2() {
        ...
        $this->assertEquals('\[ 9.81\cdot s \]', $state->contentsdisplayed);
    }
    ...
    public function test_validate_student_response_insertstars_true_1() {
        ...
        $this->assertEquals(stack_input::VALID, $state->status);
        $this->assertEquals('9.81*m*s^-2', $state->contentsmodified);
        $this->assertEquals('\[ 9.81\cdot m\cdot s^ {- 2 } \]', $state->contentsdisplayed);
    }
    ...
    public function test_validate_student_response_rational_number_1() {
        ...
        $this->assertEquals('\[ 1\cdot 3^ {- 1 }\cdot m\cdot s^ {- 2 } \]', $state->contentsdisplayed);
    }
    ...
    public function test_validate_student_response_rational_number_2() {
        ...
        $this->assertEquals('\[ 2\cdot 6^ {- 1 }\cdot m\cdot s^ {- 2 } \]', $state->contentsdisplayed);
    }
    ...
    public function test_validate_student_response_display_2() {
        ...
        $this->assertEquals('\[ 2^ {- 1 }\cdot m \]', $state->contentsdisplayed);
    }
    ...
    public function test_validate_student_response_display_qmchar() {
        ...
        $this->assertEquals(stack_input::INVALID, $state->status);
        $this->assertEquals('?*m*s^-2', $state->contentsmodified);
        $this->assertEquals('\[ \color{red}{?}\cdot m\cdot s^ {- 2 } \]', $state->contentsdisplayed);
    }
}
