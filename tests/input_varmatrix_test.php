...
final class input_varmatrix_test extends qtype_stack_testcase {
    ...
    public function test_validate_student_response_valid_zeros(): void {
    ...
    public function test_validate_student_response_invalid_one_blank(): void {
        ...
        $this->assertEquals(
            '\[ \left[\begin{array}{ccc} 1 & 2 & 3 \\\\ 4 & 6 & \color{red}{?} \end{array}\right] \]',
            $state->contentsdisplayed
        );
        $this->assertEquals('', $state->lvars);
    }

    public function test_validate_student_response_invalid_two_blank(): void {
        ...
        $this->assertEquals(
            '\[ \left[\begin{array}{ccc} 1 & 2 & 3 \\\\ 4 & \color{red}{?} & \color{red}{?} \end{array}\right] \]',
            $state->contentsdisplayed
        );
        $this->assertEquals('', $state->lvars);
    }
    ...
    public function test_validate_student_response_valid_logs(): void {
        ...
        $this->assertEquals(
            '\[ \left[\begin{array}{cc} \ln ^2\left(9\right)\cdot y^2\cdot 9^{x\cdot y} & ' .
    ...
    public function test_validate_student_response_decimals_dot(): void {
        ...
        $this->assertEquals(
            '\[ \left[\begin{array}{cc} x & 2.7 \\\\ \sqrt{2} & 3.14 \end{array}\right] \]',
            $state->contentsdisplayed
        );
        $this->assertEquals('\( \left[ x \right]\) ', $state->lvars);
    }
    ...
    public function test_validate_student_response_decimals_dot_unencapsulated_comma(): void {
        ...
        $this->assertEquals(
            '<span class="stacksyntaxexample">matrix([x,2.7],[sqrt(2),3.14])</span>',
            $state->contentsdisplayed
        );
        $this->assertEquals('', $state->lvars);
    }
