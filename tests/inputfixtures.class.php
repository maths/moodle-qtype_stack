...
class stack_inputvalidation_test_data {
    ...
    protected static $rawdata = array(
        ...
        array('3e2', 'php_true', '3*e*2', 'cas_true', ""),
        array('3e-2', 'php_true', '3*e-2', 'cas_true', ""),
        ...
        array('aXy1', 'php_false', 'aXy1', 'cas_true', ""),
        array('f(x)', 'php_true', 'f*(x)', 'cas_true', "Functions"),
        array('a(x)', 'php_true', 'a*(x)', 'cas_true', ""),
        array('b/a(x)', 'php_true', 'b/a*(x)', 'cas_true', ""),
        array('3b+5/a(x)', 'php_true', '3*b+5/a*(x)', 'cas_true', ""),
        ...
        array('x => and x<1', 'php_false', 'x => and x<1', '', ""),
        ...
        array('sin*2*x', 'php_false', 'sin*2*x', 'cas_false', ""),
        array('sin[2*x]', 'php_false', 'sin[2*x]', 'cas_false', ""),
        ...
        array('cosech(x)', 'php_false', 'cosech(x)', 'cas_true', ""),
        ...
        array('ln*x', 'php_false', '', '', ""),
        array('In(x)', 'php_false', '', '', ""),
