...
final class mathsoutputtex_test extends qtype_stack_testcase {
    public function test_tex_rendering(): void {
        ...
        $this->assertEquals(
            '<p>Latex for <code>\[x^2 + y^2\]</code>.</p>' . "\n",
            stack_docs_render_markdown($md)
        );
        ...
        $this->assertEquals(
            'What is <span class="displayequation">\[\displaystyle x^2\]</span>?',
        ...
        stack_utils::clear_config_cache();
        $this->assertEquals(
            'What is \[x^2\] or <span class="displayequation">\[\displaystyle x^2\]</span>?',
