...
final class prt_test extends qtype_stack_testcase {
    ...
    public function test_single_node_prt(): void {
        ...
        $this->assertEquals(['[ 1-0-1 ]'], $prtev->get_answernotes_testcase());
        $expected = [
        ...
        $this->assertEquals(['[ 1-0-0 ]'], $prtev->get_answernotes_testcase());
        $expected = [
            'ATInt(sans,(x+1)^3/3+c,ev(x,simp));', '/* ------------------- */',
            'prt_testprt(sans);',
        ];
    ...
    public function test_multi_node_prt(): void {
        ...
        $this->assertEquals(['[ 1-0-0 | 1-1-1 ]'], $prtev->get_answernotes_testcase());
        $expected = [
