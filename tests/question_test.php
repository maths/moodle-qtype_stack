...
class question_test extends qtype_stack_testcase {
    ...
    public function test_get_expected_data() {
        ...
        $this->assertEquals(array('ans1' => PARAM_RAW, 'ans1_val' => PARAM_RAW, 'step_lang' => PARAM_RAW), $q->get_expected_data());
    }
    ...
    public function test_get_expected_data_test3() {
        ...
        $this->assertEquals(array('ans1' => PARAM_RAW, 'ans1_val' => PARAM_RAW,
                ...
                'ans4' => PARAM_RAW, 'step_lang' => PARAM_RAW), $q->get_expected_data());
    }
